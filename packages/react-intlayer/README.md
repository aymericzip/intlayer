...
To see all available parameters, refer to the [configuration documentation here](https://github.com/intlayer-org/intlayer/blob/main/docs/docs/configuration_en.md).
...
Note: react-intlayer scripts are based on craco. You can also implement your own setup based on the intlayer craco plugin. [See example here](https://github.com/intlayer-org/intlayer/blob/main/examples/react-app/craco.config.js).
...
[See how to declare your Intlayer declaration files](https://github.com/intlayer-org/intlayer/blob/main/docs/docs/content_declaration/get_started_en.md).
...
For integration with Vite + React, refer to the [setup guide](https://github.com/intlayer-org/intlayer/blob/main/docs/docs/intlayer_with_vite_react_en.md).
