...
const getTailwindConfig = () => {
  ...
  return {
    ...
    content: [
      `${relativePath}/pages/**/*.{ts,tsx}`,
      `${relativePath}/components/**/*.{ts,tsx}`,
      `${relativePath}/app/**/*.{ts,tsx}`,
      `${relativePath}/src/**/*.{ts,tsx}`,
    ],
    prefix: '',
    theme: {
      screens: {
      ...
      extend: {
        ...
        colors: {
          ...
          success: {
            DEFAULT: 'rgba(0, 204, 102, <alpha-value>)',
...
/** @type {string[]} */
const intlayerTailwindContent = tailwindConfig.content;

export { intlayerTailwindContent };
