...
export const navigationViewContent = {
  ...
  content: {
    ...
    addNewSelectCase: {
      label: t({
        en: 'Click to add a select case',
        'en-GB': 'Click to add a select case',
        fr: 'Cliquez pour ajouter un cas de sélection',
        es: 'Haga clic para agregar un caso de selección',
        de: 'Klicken Sie, um einen Auswahlfall hinzuzufügen',
        ja: '選択ケースを追加するにはクリック',
        ko: '선택 케이스를 추가하려면 클릭하세요',
        zh: '点击添加选择分支',
        it: 'Clicca per aggiungere un caso di selezione',
        pt: 'Clique para adicionar um caso de seleção',
        hi: 'चयन केस जोड़ने के लिए क्लिक करें',
        ar: 'انقر لإضافة حالة تحديد',
        ru: 'Нажмите, чтобы добавить вариант выбора',
        tr: 'Seçim durumu eklemek için tıklayın',
        pl: 'Kliknij, aby dodać przypadek wyboru',
        id: 'Klik untuk menambah kasus pilihan',
        vi: 'Nhấp để thêm trường hợp lựa chọn',
        uk: 'Натисніть, щоб додати варіант вибору',
      }),
      text: t({
        en: 'Add new case',
        'en-GB': 'Add new case',
        fr: 'Ajouter un nouveau cas',
        es: 'Agregar nuevo caso',
        de: 'Neuen Fall hinzufügen',
        ja: '新しいケースを追加',
        ko: '새 케이스 추가',
        zh: '添加新分支',
        it: 'Aggiungi nuovo caso',
        pt: 'Adicionar novo caso',
        hi: 'नया केस जोड़ें',
        ar: 'أضف حالة جديدة',
        ru: 'Добавить новый вариант',
        tr: 'Yeni durum ekle',
        pl: 'Dodaj nowy przypadek',
        id: 'Tambahkan kasus baru',
        vi: 'Thêm trường hợp mới',
        uk: 'Додати новий варіант',
      }),
    },
    removeSelectCase: {
      label: t({
        en: 'Click to remove the select case',
        'en-GB': 'Click to remove the select case',
        fr: 'Cliquez pour supprimer le cas de sélection',
        es: 'Haga clic para eliminar el caso de selección',
        de: 'Klicken Sie, um den Auswahlfall zu entfernen',
        ja: '選択ケースを削除するにはクリック',
        ko: '선택 케이스를 제거하려면 클릭하세요',
        zh: '点击删除选择分支',
        it: 'Clicca per rimuovere il caso di selezione',
        pt: 'Clique para remover o caso de seleção',
        hi: 'चयन केस निकालने के लिए क्लिक करें',
        ar: 'انقر لإزالة حالة التحديد',
        ru: 'Нажмите, чтобы удалить вариант выбора',
        tr: 'Seçim durumunu kaldırmak için tıklayın',
        pl: 'Kliknij, aby usunąć przypadek wyboru',
        id: 'Klik untuk menghapus kasus pilihan',
        vi: 'Nhấp để xóa trường hợp lựa chọn',
        uk: 'Натисніть, щоб видалити варіант вибору',
      }),
      text: t({
        en: 'Remove case',
        'en-GB': 'Remove case',
