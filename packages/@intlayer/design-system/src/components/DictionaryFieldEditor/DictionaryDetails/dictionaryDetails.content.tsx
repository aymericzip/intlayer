...
export const dictionaryDetailsContent = {
  ...
  content: {
    ...
    locationSelect: {
      ...
      description: t({
        en: 'The location of your dictionary defines where it is stored.',
        'en-GB': 'The location of your dictionary defines where it is stored.',
        fr: "L'emplacement de votre dictionnaire définit où il est stocké.",
        es: 'La ubicación de su diccionario define dónde se almacena.',
        de: 'Der Speicherort Ihres Wörterbuchs definiert, wo es gespeichert wird.',
        ja: '辞書の場所は、それが保存される場所を定義します。',
        ko: '사전의 위치는 저장되는 위치를 정의합니다.',
        zh: '字典的位置定义了它的存储位置。',
        it: 'La posizione del tuo dizionario definisce dove è memorizzato.',
        pt: 'A localização do seu dicionário define onde ele é armazenado.',
        hi: 'आपके शब्दकोश का स्थान परिभाषित करता है कि यह कहाँ संग्रहीत है।',
        ar: 'موقع القاموس الخاص بك يحدد مكان تخزينه.',
        ru: 'Расположение вашего словаря определяет, где он хранится.',
        tr: 'Sözlüğünüzün konumu, nerede saklandığını tanımlar.',
        pl: 'Lokalizacja słownika definiuje, gdzie jest przechowywany.',
        id: 'Lokasi dictionary Anda menentukan di mana dictionary disimpan.',
        vi: 'Vị trí của dictionary xác định nơi nó được lưu trữ.',
        uk: 'Розташування словника визначає, де він зберігається.',
      }),
      local: t({
        en: 'Local',
        'en-GB': 'Local',
