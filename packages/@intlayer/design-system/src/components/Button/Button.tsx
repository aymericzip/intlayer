  ...
  'relative inline-flex cursor-pointer items-center justify-center font-medium ring-0 transition-all duration-300 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      ...
      variant: {
        ...
        'invisible-link':
          'h-auto justify-start border-inherit bg-transparent underline-offset-4 *:text-current! hover:bg-transparent',

        hoverable:
          'rounded-lg border-none bg-current/0 transition *:text-current! hover:bg-current/5 aria-[current]:bg-current/3',

        fade: [
          'rounded-lg border-none bg-current/10 ring-current/5 transition *:text-current! hover:bg-current/10 aria-[current]:bg-current/3',
          'hover:ring-5 focus-visible:ring-5',
          'aria-selected:ring-5',
        ],
        input: [
