...
const StyledTabBar = tw.div`flex items-center justify-start w-full bg-neutral-200 dark:bg-neutral-950 rounded-t-3xl text-xs text-neutral dark:text-neutral-dark overflow-scroll`;
...
const StyledTab = styled.div<{ $isActive: boolean }>(({ $isActive }) => [
  tw`flex items-center justify-center min-w-20 h-8 py-1 px-3 transition`,
  $isActive
