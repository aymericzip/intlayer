...
const StyledFooter = tw.footer`flex flex-auto flex-row justify-around p-6 items-center flex-wrap gap-4`;
...
const StyledFooterContent = tw.div`w-full flex flex-row justify-around m-auto flex-wrap gap-4 md:w-2/3`;
