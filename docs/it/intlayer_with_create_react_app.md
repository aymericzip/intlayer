...
import { Locales, getConfiguration, removeLocaleFromUrl } from "intlayer"; // Funzioni e tipi di utilità da 'intlayer'
...
const {
  ...
  removeLocaleFromUrl,
} = require("intlayer"); // Funzioni e tipi di utilità da 'intlayer'
