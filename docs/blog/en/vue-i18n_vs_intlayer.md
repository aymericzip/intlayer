...
- **Bridge during migration**: Keep vue-i18n catalogs in parallel; gradually replace lookups.
- **Enable strict checks**: Let build-time detection surface missing keys/locales early.
- **Adopt router/SEO helpers**: Standardize locale detection and `hreflang` tags.
