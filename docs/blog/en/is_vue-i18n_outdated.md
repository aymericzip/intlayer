...
| ------------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **VS Code Extension**     | Third-party (i18n Ally) | ✅ [First-party extension](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/vs_code_extension.md)       |
| **Language Server (LSP)** | ❌ None                 | ✅ [Integrated LSP](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/lsp.md)                            |
| **MCP Server for AI**     | ❌ None                 | ✅ [Built-in MCP Server](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/mcp_server.md)                |
| **Agent Skills**          | ❌ None                 | ✅ [Autonomous agent skills](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/agent_skills.md)          |
| **Visual In-Context CMS** | ❌ None                 | ✅ [Free & Open Source CMS](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_visual_editor.md) |
...
- **Drop-in Compatibility:** Keep existing templates using the [`vue-i18n` compatibility layer](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/compat/vue-i18n.md) or [`@nuxtjs/i18n` compatibility layer](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/compat/nuxtjs-i18n.md).
- **Automated Migration Guides:** Convert legacy JSON files into structured dictionaries with our guides: [from vue-i18n](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/migration_from_vue-i18n_to_intlayer.md) or [from @nuxtjs/i18n](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/migration_from_nuxtjs_i18n_to_intlayer.md).
- **Hybrid Setup:** Keep `vue-i18n` at runtime while [using Intlayer alongside vue-i18n](https://github.com/aymericzip/intlayer/blob/main/docs/blog/en/intlayer_with_vue-i18n.md) for local type safety and AI translation.
...
- [Vue & Vite i18n Benchmark: Complete Performance Analysis](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/benchmark/vue.md)
- [vue-i18n vs Intlayer: Feature-by-Feature Comparison](https://github.com/aymericzip/intlayer/blob/main/docs/blog/en/vue-i18n_vs_intlayer.md)
