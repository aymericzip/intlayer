...
<Step number={3} title="Определение динамических маршрутов локалей">
...
<Step number={5} title="Используйте переводы на своих страницах">
...
<Step number={6} title="Использование переводов в клиентских компонентах">
...
<Step number={7} title="Использование переводов в серверных компонентах">
...
<Step number={9} title="Использование локализованного компонента Link" isOptional={true}>
...
<Step number={10} title="Доступ к активной локали внутри Server Actions" isOptional={true}>
...
<Step number={11} title="Интернационализация ваших метаданных" isOptional={true}>
...
<Step number={12} title="Интернационализация вашей карты сайта" isOptional={true}>
...
<Step number={13} title="Интернационализация вашего файла robots.txt" isOptional={true}>
...
<Step number={14} title="Настройка прокси для маршрутизации по локали" isOptional={true}>
...
<Step number={15} title="Настройка типов TypeScript для локали" isOptional={true}>
...
<Step number={16} title="Автоматизация переводов с помощью Intlayer" isOptional={true}>
