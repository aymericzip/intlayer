...
> Tested in real browser environments using production gzip compression. Details in the [Next.js benchmark report](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/benchmark/nextjs.md).
...
Intlayer solves this via static analysis: the [Intlayer compiler](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/compiler.md) bundles only the copy actually referenced on that route, driving other-page leakage to **0.0%**.
...
Turbopack and Webpack cannot verify which keys inside `UserProfile` are actually called at runtime. To prevent missing-key errors, **the bundler must include the entire namespace in the client chunk**. Intlayer's destructured properties allow the compiler to track references directly and strip unused fields during compilation. See [bundle optimisation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/bundle_optimization.md) for details.
...
Intlayer infers types from all content declarations. Enabling [`strictMode`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/configuration.md) turns missing translations in any locale into hard compile errors.

### Tooling & AI Agent Workflows

| Feature                        | `next-intl` | Intlayer                                                                                                            |
| ------------------------------ | ----------- | ------------------------------------------------------------------------------------------------------------------- |
| **VS Code Extension**          | ❌ None     | ✅ [First-party extension](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/vs_code_extension.md)   |
| **Language Server (LSP)**      | ❌ None     | ✅ [Integrated LSP](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/lsp.md)                        |
| **MCP Server (for AI Agents)** | ❌ None     | ✅ [Built-in MCP Server](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/mcp_server.md)            |
| **Agent Skills**               | ❌ None     | ✅ [Ready-to-use skills](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/agent_skills.md)          |
| **Visual In-Context CMS**      | ❌ None     | ✅ [Free & Open Source](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/intlayer_visual_editor.md) |
...
Use the [Intlayer CMS](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/intlayer_CMS.md) to give non-technical contributors visual editing that commits back to Git.
...
- **Drop-in Compatibility:** Keep your existing code using the [`next-intl` compatibility layer](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/compat/next-intl.md).
- **Automated Migration:** Convert legacy JSON files into structured dictionaries with our [next-intl migration guide](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/migration_from_next-intl_to_intlayer.md).
- **Hybrid Setup:** Keep `next-intl` for runtime rendering while [using Intlayer alongside next-intl](https://github.com/aymericzip/intlayer/blob/main/docs/blog/en-GB/intlayer_with_next-intl.md) for local AI translation.
...
- [Next.js i18n Benchmark: Complete Performance Analysis](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/benchmark/nextjs.md)
- [next-i18next vs next-intl vs Intlayer: Full Comparison](https://github.com/aymericzip/intlayer/blob/main/docs/blog/en-GB/next-i18next_vs_next-intl_vs_intlayer.md)
- [Is i18next Outdated in 2026?](https://github.com/aymericzip/intlayer/blob/main/docs/blog/en-GB/is_i18next_outdated.md)
