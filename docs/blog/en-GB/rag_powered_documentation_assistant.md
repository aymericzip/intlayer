...
👉 [Live demo](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/interest_of_intlayer.md) 👉 [Code boilerplate](https://github.com/aymericzip/smart_doc_RAG)
...
👉 [Try the demo here](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/interest_of_intlayer.md) 👉 [Check the code template on GitHub](https://github.com/aymericzip/smart_doc_RAG)
