...
| लाइब्रेरी      | कंटेंट मॉडल                                               | कीज़ पर टाइप्स                      | मैसेज फॉर्मेट          | प्रति-रूट स्प्लिटिंग     | लाइब्रेरी साइज़ |
| :------------- | :-------------------------------------------------------- | :---------------------------------- | :--------------------- | :----------------------- | :-------------- |
| `vue-i18n`     | प्रति लोकेल सेंट्रल कैटलॉग, वैकल्पिक SFC `<i18n>` ब्लॉक्स | स्कीमा जेनेरिक के माध्यम से ऑप्ट-इन | स्वयं का (पाइप प्लूरल) | नहीं                     | ~24.3 kB        |
| `@nuxtjs/i18n` | `vue-i18n` के समान, साथ ही रूटिंग और SEO टैग्स            | समान                                | समान                   | नहीं, केवल प्रति लोकेल   | अतिरिक्त        |
| `fluent-vue`   | `.ftl` फ़ाइलें (Mozilla Fluent)                           | कोई नहीं                            | Fluent                 | नहीं                     | ~29.7 kB        |
| Paraglide      | inlang प्रोजेक्ट, जेनरेटेड फंक्शन्स                       | जेनरेटेड                            | स्वयं का               | ट्री-शेकिंग के माध्यम से | लगभग शून्य      |
| Intlayer       | प्रति कंपोनेंट एक `.content.ts`                           | जेनरेटेड, डिफ़ॉल्ट रूप से चालू      | हेल्पर्स (`plural`)    | हाँ, प्रति कंपोनेंट      | बेसलाइन         |
