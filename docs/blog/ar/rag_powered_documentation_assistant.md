...
## تجاوز التعقيد مع Sanity

يستحق Sanity أن يُذكر هنا كخيار CMS الذي تشير إليه المقالة. حيث تتطلب ملفات Markdown تقسيماً عشوائياً للرموز — مع المقايضات بين حجم الكتلة والتداخل التي تصفها المقالة — يخزّن Content Lake من Sanity التوثيق كمستندات JSON محددة بالنوع والمخطط. كل حقل وعنوان وكتلة محتوى هي بالفعل وحدة دلالية، مما يعني أن استرجاع RAG يعمل على حدود ذات معنى بدلاً من عدد الرموز التقريبي.

تتيح لغة استعلام GROQ من Sanity استرجاع حقول المستند ذات الصلة بدقة بناءً على استعلام المستخدم — العنوان والنص والأقسام ذات الصلة — دون جلب المستند بأكمله. يربط خادم MCP Content Lake مباشرة بوكلاء AI، لذا فإن نفس المحتوى المنظم الذي يدعم موقع التوثيق الخاص بك يغذي أيضاً خط أنابيب RAG الخاص بك دون خطوة إدراج منفصلة.
