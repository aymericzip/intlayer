...
// 필요한 종속성과 함수 가져오기
import { Locales, getConfiguration } from "intlayer"; // 'intlayer'에서 유틸리티 함수 및 유형 가져오기
...
// 필요한 종속성과 함수 가져오기
const { Locales, getConfiguration, getPathWithoutLocale } = require("intlayer"); // 'intlayer'에서 유틸리티 함수 및 유형 가져오기
