...
import { Locales, getConfiguration } from "intlayer"; // 'intlayer' से उपयोगिता फ़ंक्शन और प्रकार
...
// आवश्यक निर्भरताएँ और फ़ंक्शन आयात करना
const { Locales, getConfiguration, getPathWithoutLocale } = require("intlayer"); // 'intlayer' से उपयोगिता फ़ंक्शन और प्रकार
