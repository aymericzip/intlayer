...
पृष्ठ के शीर्षक और विवरण जैसे मेटाडेटा को अंतर्राष्ट्रीयकरण करने के लिए, `getStaticProps` फ़ंक्शन का उपयोग Intlayer के `getTranslation` फ़ंक्शन के साथ करें।
