...
डिफ़ॉल्ट रूप से, जब एक शब्दकोश लोड होता है, तो यह सभी भाषाओं के लिए सामग्री आयात करता है।
यदि यह विकल्प true पर सेट है, तो केवल वर्तमान भाषा की शब्दकोश सामग्री
डायनामिक आयात के माध्यम से प्राप्त की जाएगी। इस मामले में, Intlayer सभी
`useIntlayer` कॉल को `useDynamicDictionary` से बदल देगा।
