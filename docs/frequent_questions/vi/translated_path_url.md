...
Để biết thêm thông tin về cách triển khai tính năng này, hãy xem [tài liệu Viết lại URL tùy chỉnh](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/custom_url_rewrites.md).
