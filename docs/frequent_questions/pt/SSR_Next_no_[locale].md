...
Se você quiser fazer isso, siga os mesmos passos descritos no guia [Intlayer com Next.js](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/intlayer_with_nextjs_16.md),
