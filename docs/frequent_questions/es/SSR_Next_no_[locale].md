...
Si quieres hacerlo, sigue los mismos pasos descritos en la guía [Intlayer con Next.js](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/intlayer_with_nextjs_16.md),
