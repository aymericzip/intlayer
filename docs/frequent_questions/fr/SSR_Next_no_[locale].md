...
Si vous souhaitez le faire, suivez les mêmes étapes que celles décrites dans le guide [Intlayer avec Next.js](https://github.com/aymericzip/intlayer/blob/main/docs/docs/fr/intlayer_with_nextjs_16.md),
