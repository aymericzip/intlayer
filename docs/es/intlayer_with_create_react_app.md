...
import { Locales, getConfiguration, removeLocaleFromUrl } from "intlayer"; // Funciones y tipos de utilidad de 'intlayer'
...
const {
  ...
  removeLocaleFromUrl,
} = require("intlayer"); // Funciones y tipos de utilidad de 'intlayer'
