...
export const blogEntry = {
  ...
  './blog/en/i18n_using_with_next-intl.md': {
    en: readLocale('i18n_using_with_next-intl.md', 'en'),
    ru: readLocale('i18n_using_with_next-intl.md', 'ru'),
    ja: readLocale('i18n_using_with_next-intl.md', 'ja'),
    fr: readLocale('i18n_using_with_next-intl.md', 'fr'),
    ko: readLocale('i18n_using_with_next-intl.md', 'ko'),
    zh: readLocale('i18n_using_with_next-intl.md', 'zh'),
    es: readLocale('i18n_using_with_next-intl.md', 'es'),
    de: readLocale('i18n_using_with_next-intl.md', 'de'),
    ar: readLocale('i18n_using_with_next-intl.md', 'ar'),
    it: readLocale('i18n_using_with_next-intl.md', 'it'),
    'en-GB': readLocale('i18n_using_with_next-intl.md', 'en-GB'),
    pt: readLocale('i18n_using_with_next-intl.md', 'pt'),
    hi: readLocale('i18n_using_with_next-intl.md', 'hi'),
    tr: readLocale('i18n_using_with_next-intl.md', 'tr'),
    pl: readLocale('i18n_using_with_next-intl.md', 'pl'),
    id: readLocale('i18n_using_with_next-intl.md', 'id'),
    vi: readLocale('i18n_using_with_next-intl.md', 'vi'),
  } as unknown as Record<LocalesValues, Promise<string>>,
  './blog/en/index.md': {
