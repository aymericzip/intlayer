...
export const docsEntry = {
  ...
  './docs/en/dictionary/plural.md': {
    en: readLocale('dictionary/plural.md', 'en'),
    ru: readLocale('dictionary/plural.md', 'ru'),
    ja: readLocale('dictionary/plural.md', 'ja'),
    fr: readLocale('dictionary/plural.md', 'fr'),
    ko: readLocale('dictionary/plural.md', 'ko'),
    zh: readLocale('dictionary/plural.md', 'zh'),
    es: readLocale('dictionary/plural.md', 'es'),
    de: readLocale('dictionary/plural.md', 'de'),
    ar: readLocale('dictionary/plural.md', 'ar'),
    it: readLocale('dictionary/plural.md', 'it'),
    'en-GB': readLocale('dictionary/plural.md', 'en-GB'),
    pt: readLocale('dictionary/plural.md', 'pt'),
    hi: readLocale('dictionary/plural.md', 'hi'),
    tr: readLocale('dictionary/plural.md', 'tr'),
    pl: readLocale('dictionary/plural.md', 'pl'),
    id: readLocale('dictionary/plural.md', 'id'),
    vi: readLocale('dictionary/plural.md', 'vi'),
    uk: readLocale('dictionary/plural.md', 'uk'),
  } as unknown as Record<LocalesValues, Promise<string>>,
