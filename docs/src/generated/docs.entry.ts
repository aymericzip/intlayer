...
export const docsEntry = {
  ...
  './docs/en/intlayer_astro.md': {
    en: readLocale('intlayer_astro.md', 'en'),
    fr: readLocale('intlayer_astro.md', 'fr'),
    ru: readLocale('intlayer_astro.md', 'ru'),
    ja: readLocale('intlayer_astro.md', 'ja'),
    ko: readLocale('intlayer_astro.md', 'ko'),
    zh: readLocale('intlayer_astro.md', 'zh'),
    es: readLocale('intlayer_astro.md', 'es'),
    de: readLocale('intlayer_astro.md', 'de'),
    ar: readLocale('intlayer_astro.md', 'ar'),
    pt: readLocale('intlayer_astro.md', 'pt'),
    'en-GB': readLocale('intlayer_astro.md', 'en-GB'),
    it: readLocale('intlayer_astro.md', 'it'),
    hi: readLocale('intlayer_astro.md', 'hi'),
    tr: readLocale('intlayer_astro.md', 'tr'),
  } as unknown as Record<LocalesValues, Promise<string>>,
