...
- **Интернационализация метаданных**: Intlayer предоставляет способ интернационализации ваших метаданных, таких как заголовок вашей страницы, используя функцию `generateMetadata`, предоставляемую Next.js. Вы можете использовать функцию `getTranslation` для перевода ваших метаданных.
