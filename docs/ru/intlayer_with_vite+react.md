...
import { Locales, getConfiguration } from "intlayer"; // Утилиты и типы из 'intlayer'
...
// Импорт необходимых зависимостей и функций
const { Locales, getConfiguration, getPathWithoutLocale } = require("intlayer"); // Утилиты и типы из 'intlayer'
