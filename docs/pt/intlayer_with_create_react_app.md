...
import { Locales, getConfiguration, removeLocaleFromUrl } from "intlayer"; // Funções e tipos utilitários do 'intlayer'
...
const {
  ...
  removeLocaleFromUrl,
} = require("intlayer"); // Funções e tipos utilitários do 'intlayer'
