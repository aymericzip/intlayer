...
title: Next.js Page Router i18n - 完整翻译指南： Next.js
description: 最佳的包体积、SEO、性能和可维护性解决方案。让您的 Next.js Page Router 网站在 2026 年实现多语言化，LLM 翻译，Agent Skills & MCP。
keywords:
  - 国际化
  - 文档
  - Intlayer
