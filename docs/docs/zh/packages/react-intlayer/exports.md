...
| 钩子 | 描述 | 相关文档 |
| ---------------------- | 客户端 Hook，按键选择一个字典并返回其内容。如果未提供 locale，则使用来自上下文的 locale。 | [useIntlayer](https://github.com/aymericzip/intlayer/blob/main/docs/docs/zh/packages/react-intlayer/useIntlayer.md) |
