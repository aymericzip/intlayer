...
| `usePathname`          | 返回当前路径名（pathname）作为 `ComputedRef<string>`，并已移除 locale 片段。对 `popstate` 具有响应式。 | [usePathname](https://github.com/aymericzip/intlayer/blob/main/docs/docs/zh/packages/vue-intlayer/usePathname.md)     |
