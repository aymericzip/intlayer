...
La reactividad al cambiar de idioma es muy rápida (0.5ms), beneficiándose de los stores reactivos de Svelte, aunque la sobrecarga de hidratación es ligeramente mayor (~6.2ms frente a ~5.5ms para Intlayer).
