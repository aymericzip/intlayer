...
En esta arquitectura, el núcleo de `intlayer` proporciona APIs de JavaScript para declarar y consumir diccionarios en entornos estándar de JavaScript o TypeScript sin un framework frontend.
