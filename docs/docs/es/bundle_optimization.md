...
| **`minify`**          | `boolean`                        | `true`                          | Indica si se deben minificar los diccionarios para reducir el tamaño del bundle.                                                                                                                                                                             |
| **`purge`**           | `boolean`                        | `true`                          | Indica si se deben purgar las claves no utilizadas en los diccionarios.                                                                                                                                                                                      |
