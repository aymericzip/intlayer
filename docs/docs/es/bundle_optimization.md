...
| **`importMode`**      | **Deprecated**: Use `dictionary.importMode` instead. | `'static' , 'dynamic' , 'fetch'` | `'static'`                                                                                                                                                                                                                                                   | Determina cómo se cargan los diccionarios (ver detalles a continuación). |
