...
En esta arquitectura, `solid-intlayer` proporciona el `IntlayerProvider` montado en `index.tsx` para envolver el árbol de Solid. Las declaraciones de contenido se ubican en `src/` junto a los componentes.
