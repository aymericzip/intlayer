...
En esta arquitectura, todas las rutas localizadas están anidadas bajo el segmento de ruta `{-$locale}`. Este enfoque garantiza que cada idioma tenga una URL dedicada, al tiempo que permite el prefijo automático de locale, la validación y la optimización para SEO.
