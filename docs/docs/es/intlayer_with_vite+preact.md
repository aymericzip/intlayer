...
En esta arquitectura, `preact-intlayer` proporciona el `IntlayerProvider` montado en `main.tsx` para envolver el árbol de Preact. Las declaraciones de contenido se ubican en `src/` junto a los componentes.
