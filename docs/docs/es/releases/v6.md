...
Consulta más opciones en la documentación de la CLI: [Referencia CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/cli/index.md) → "Test missing translations". Así como la guía de [Testing](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/testing.md).
...
Aún puedes ajustar por diccionario usando el campo `autoFill` en archivos de contenido. Intlayer primero considerará la configuración por diccionario y luego recurrirá a la configuración global. Consulta la referencia completa en [Auto-fill](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/autoFill.md) y [Referencia de archivo de contenido](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/dictionary/content_file.md).
...
Consulta los detalles en la documentación de la [Extensión Oficial de VS Code](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/vs_code_extension.md).

---

Se actualizó el servidor MCP para admitir las nuevas funciones.
...
El sistema de registro se ha mejorado para proporcionar información más detallada sobre lo que sucede durante las transformaciones en tiempo de compilación (build time) y ejecución.

> Habilite los registros detallados para comprender mejor lo que sucede durante las transformaciones en tiempo de compilación (build time) y ejecución.
...
## Proceso paralelo para monitorear archivos en turbopack

Al usar Turbopack en Next.js 14 y superior como tu servidor de desarrollo con el comando `next dev --turbopack`, los cambios en el diccionario no se detectarán automáticamente de forma predeterminada.

Esta limitación ocurre porque Turbopack no puede ejecutar plugins de webpack en paralelo para monitorear cambios en tus archivos de contenido.

Para solucionar esto, utilizamos el comando `intlayer watch`, usando la opción `--with` para ejecutar tanto el servidor de desarrollo como el observador de compilación de Intlayer simultáneamente.
...
## Notas de migración de v6 a v7

Consulta las [notas de migración de v6 a v7](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/releases/v7.md) para más información.

---

## Enlaces útiles

- [Referencia CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/cli/index.md)
