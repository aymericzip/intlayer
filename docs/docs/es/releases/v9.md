...
Un nuevo paquete opcional, [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/analytics.md), te indica qué contenido ven realmente tus visitantes — y cierra el círculo con **Collections & Variants**, permitiéndote hacer pruebas A/B de contenido y medir conversiones por variante.
...
Disponible hoy para React, Next.js y React Native (a través de `react-intlayer`); otras integraciones de frameworks (Vue, Svelte, Angular, …) están planificadas, siguiendo el mismo patrón de despliegue que `@intlayer/editor`. Consulta la [documentación de Analytics](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/analytics.md) para la guía completa.
...
- [Analytics - Seguimiento de exposición de contenido y pruebas A/B](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/analytics.md)
