...
Para más detalles, consulte la [Documentación de Archivos de Contenido YAML](https://intlayer.org/doc/concept/content#yaml-content-file) y la [Documentación de Archivos de Contenido Markdown](https://intlayer.org/doc/concept/content/markdown).
...
Para más información, consulte la [Documentación de Pluralización](https://intlayer.org/doc/concept/content/plural).
...
Para más detalles, consulte la [Documentación de LSP](https://intlayer.org/doc/lsp).
...
Para detalles sobre la configuración, consulte la [Documentación del Entorno de Angular](https://intlayer.org/doc/environment/angular).
