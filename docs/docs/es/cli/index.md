...
- **[Escanear sitio web](https://github.com/aymericzip/intlayer/blob/main/docs/docs/es/cli/scan.md)** - Mida el tamaño de la página y audite la salud de i18n/SEO de cualquier URL pública
