...
Hono की अपनी कोई i18n परत नहीं है, इसलिए विकल्प एक जेनेरिक लाइब्रेरी जैसे कि `i18next` को मैन्युअल रूप से मिडलवेयर में जोड़ना है, या `hono-intlayer` के माध्यम से `Intlayer` का उपयोग करना है, जो आपके लिए मिडलवेयर पंजीकृत करता है, प्रति अनुरोध लोकेल का समाधान करता है, और आपके फ्रंटएंड के समान घोषित सामग्री साझा करता है।
