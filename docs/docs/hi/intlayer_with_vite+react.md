...
<AccordionGroup>
<Accordion header="पूर्ण वाइट और रिएक्ट कवरेज">

इंटलेयर को **घटक-स्तरीय सामग्री स्कोपिंग**, **आलसी-लोड किए गए अनुवाद**, और स्केलिंग अंतर्राष्ट्रीयकरण (i18n) के लिए आवश्यक सभी सुविधाओं की पेशकश करके वाइट और रिएक्ट के साथ पूरी तरह से काम करने के लिए अनुकूलित किया गया है।
...
> Intlayer v9 के बाद से, `intlayerProxy()` सीधे `intlayer()` प्लगइन में बंडल किया गया है और `routing.enableProxy` विकल्प के माध्यम से डिफ़ॉल्ट रूप से सक्षम है (`true` डिफ़ॉल्ट है)। इसे नीचे दिए गए अनुसार अलग से रजिस्टर करना अब वैकल्पिक है — इसे पिछड़ी संगतता के लिए और उन सेटअप के लिए रखा गया है जिन्हें प्लगइन ऑर्डर को नियंत्रित करने की आवश्यकता है। ऑप्ट आउट करने के लिए `routing.enableProxy: false` सेट करें। [v9 रिलीज़ नोट्स](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/releases/v9.md) देखें।
...
<Step number={8} title="जब लोकल बदलता है तो URL बदलें" isOptional={true}>
...
<Step number={9} title="HTML भाषा और दिशा एट्रिब्यूट्स को स्विच करें" isOptional={true}>
...
<Step number={10} title="एक स्थानीयकृत लिंक कंपोनेंट बनाना" isOptional={true}>
...
Intlayer मॉड्यूल augmentation का उपयोग करता है ताकि आप TypeScript के लाभ प्राप्त कर सकें और अपने codebase को मजबूत बना सकें।
...
Intlayer द्वारा जेनरेट की गई फ़ाइलों को ignore करने की सिफारिश की जाती है। यह आपको उन्हें अपने Git रिपॉजिटरी में commit करने से बचाता है।

इसके लिए, आप अपनी `.gitignore` फ़ाइल में निम्नलिखित निर्देश जोड़ सकते हैं:

```plaintext fileName=".gitignore"
# Intlayer द्वारा जेनरेट की गई फ़ाइलों को ignore करें
.intlayer
```

### VS Code Extension

अपने Intlayer के साथ विकास अनुभव को बेहतर बनाने के लिए, आप आधिकारिक **Intlayer VS Code Extension** को install कर सकते हैं।
...
Vite का i18n पर कोई विशेष दृष्टिकोण नहीं है, इसलिए विकल्प React पारिस्थितिकी तंत्र वाले ही हैं:

- **`react-i18next`**: रनटाइम JSON लोडिंग।
- **`react-intl`**: ICU प्रारूप।
- **`Intlayer`**: घटक के बगल में घोषणा, Vite प्लगइन संकलन, HMR समर्थन, AI अनुवाद और विज़ुअल एडिटर।
...
अप्रयुक्त कुंजियों को हटाने और गतिशील शब्दकोशों के कारण बहुत कम, बंडल आकार 50% तक कम हो जाता है। [बंडल अनुकूलन](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/bundle_optimization.md) देखें।

</Question>

<Question title="क्या मैं अपने घटकों को फिर से लिखे बिना react-i18next या react-intl से माइग्रेट कर सकता हूँ?">

हाँ, संगतता एडेप्टर या चरण-दर-चरण माइग्रेशन गाइड के माध्यम से।
...
नहीं। `npx intlayer extract` चलाएं और Intlayer आपके घटकों को पढ़ता है, उपयोगकर्ता के अनुकूल स्ट्रिंग्स निकालता है, और प्रत्येक के बगल में एक `.content` फ़ाइल लिखता है, जिससे आप कैटलॉग में मैन्युअल रूप से कॉपी करने के बजाय एक diff की समीक्षा करते हैं। इस गाइड का चरण 11 इसे समझाता है।
...
हाँ। Vite प्लगइन `.content.ts` फ़ाइलों की निगरानी करता है और सहेजते ही शब्दकोशों और TypeScript प्रकारों को तुरंत अपडेट करता है।

</Question>

<Question title="Vite React SPA में लोकेल रूटिंग कैसे सेट करें?">

React Router के लिए, [React Router v7 गाइड](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/intlayer_with_react_router_v7.md) देखें। बिना राउटर वाले SPA के लिए, आप `routing.mode` को `"no-prefix"` या `"search-params"` पर सेट कर सकते हैं।

</Question>

<Question title="क्लाइंट-रेंडर किए गए Vite ऐप में SEO मेटाडेटा कैसे प्रबंधित करें?">

`html` टैग पर `lang` और `dir` विशेषताएँ सेट करें और `getMultilingualUrls` का उपयोग करके `hreflang` टैग जोड़ें।
