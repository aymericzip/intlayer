...
रूट के `head` फ़ंक्शन React ट्री के **बाहर** चलते हैं, इसलिए वहाँ `useIntlayer` उपलब्ध नहीं है। `head` से डिक्शनरी पढ़ने के तीन तरीके हैं, और हर एक बंडल आकार तथा डॉक्यूमेंट `head` कितनी जल्दी तैयार होता है, इनके बीच संतुलन बनाता है।
