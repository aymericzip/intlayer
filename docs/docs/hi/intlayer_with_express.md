...
ऐतिहासिक विकल्प `i18next-http-middleware` के साथ `i18next` है, जो प्रति नेमस्पेस JSON कैटलॉग लोड करता है और अनुरोध पर लोकेल संग्रहीत करता है। विकल्प `express-intlayer` के माध्यम से `Intlayer` है, जो आपके फ्रंटएंड के साथ साझा की गई टाइप की गई फ़ाइलों में सामग्री घोषित करता है, प्रति अनुरोध लोकेल का समाधान करता है, और AI अनुवाद और CMS जोड़ता है।

बैकएंड को अंतरराष्ट्रीयकृत करने का मुख्य कारण यह है कि उपयोगकर्ता द्वारा पढ़े जाने वाले टेक्स्ट का एक बड़ा हिस्सा कभी भी फ्रंटएंड से होकर नहीं गुजरता है: API त्रुटि संदेश, ट्रांजेक्शनल ईमेल, पुश नोटिफिकेशन, SMS और PDF निर्यात। इन्हें प्राप्तकर्ता की भाषा की आवश्यकता होती है, जो प्रति सत्र के बजाय प्रति अनुरोध हल की जाती है।
