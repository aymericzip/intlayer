...
priority: 9
title: "Angular 22 i18n - अपने ऐप को अनुवाद करने का पूर्ण गाइड"
description: "अब i18next की जरूरत नहीं। 2026 में Angular 22 ऐप को बहुभाषी (i18n) बनाने का गाइड। AI एजेंट्स से अनुवाद करें और बंडल साइज़, SEO और परफॉर्मेंस ऑप्टिमाइज़ करें।"
keywords:
  - अंतर्राष्ट्रीयकरण
  - दस्तावेज़ीकरण
  - Intlayer
...
# Intlayer का उपयोग करके अपनी Angular 22 (Vite) वेबसाइट का अनुवाद करें | अंतर्राष्ट्रीयकरण (i18n)
...
<AccordionGroup>
<Accordion header="पूर्ण Angular कवरेज">
...
<Accordion header="रखरखाव योग्यता">
...
GitHub पर [एप्लिकेशन टेम्पलेट](https://github.com/aymericzip/intlayer-angular-22-template) देखें।
...
इस आर्किटेक्चर में, `angular-intlayer` `provideIntlayer()` प्रदान करता है, जो `src/app/app.config.ts` में पंजीकृत होता है ताकि प्रत्येक कंपोनेंट `useIntlayer` सिग्नल के माध्यम से अपनी कंटेंट पढ़ सके। Angular CLI को कस्टम esbuild बिल्डर पर स्विच किया जाता है, और `esbuild.plugins.ts` आपकी कंटेंट घोषणाओं को देखने और फिर से बनाने के लिए Intlayer प्लगइन को बिल्ड में पंजीकृत करता है। कंटेंट घोषणाएं `src/app/` में कंपोनेंट्स के साथ रखी जाती हैं।
...
Intlayer को Angular CLI के साथ एकीकृत करने के लिए, आपको एक कस्टम बिल्डर का उपयोग करने की आवश्यकता है। यह मार्गदर्शिका मानती है कि आप Vite/esbuild का उपयोग कर रहे हैं (Angular 22 परियोजनाओं के लिए डिफ़ॉल्ट)।
...
एक्सटेंशन का उपयोग करने के तरीके के बारे में अधिक जानकारी के लिए, [Intlayer VS Code Extension दस्तावेज़](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/vs_code_extension.md) देखें।
...
<Question title="Angular अनुप्रयोगों के अंतर्राष्ट्रीयकरण के लिए कौन से विभिन्न समाधान उपलब्ध हैं?">

- **अंतर्निहित `@angular/localize`**: प्रति भाषा अलग संकलन।
- **`ngx-translate`** और **`Transloco`**: रनटाइम कैटलॉग।
- **`Intlayer`**: Standalone components, Signal inputs, और Vite पर आधारित नया बिल्ड पाइपलाइन।

[Intlayer क्यों चुनें](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/interest_of_intlayer.md) देखें।

</Question>
<Question title="i18n मेरे Angular बंडल आकार को कितना बढ़ाता है?">
...
<Question title="क्या Intlayer Angular Signals के साथ काम करता है?">

हाँ। `useIntlayer` एक Angular सिग्नल लौटाता है जो Angular के Zoneless आर्किटेक्चर में निर्बाध रूप से काम करता है।

</Question>
<Question title="क्या भाषा बदलने के लिए पृष्ठ को पुनः लोड करने की आवश्यकता होती है?">

नहीं। सिग्नल पर आधारित होने के कारण, भाषा स्विच डिस्प्ले पर तुरंत दिखाई देता है।

</Question>
<Question title="Angular में लोकेल रूटिंग कैसे सेट करें?">

रूट्स में `:locale` पैरामीटर घोषित करें और इसे Intlayer प्रदाता के साथ सिंक्रनाइज़ करें।

</Question>
<Question title="Angular में दाएं से बाएं लिखी जाने वाली भाषाओं को कैसे संभालें?">

एप्लिकेशन के रूट तत्व पर `lang` और `dir` सेट करने के लिए `getHTMLTextDir` का उपयोग करें।
