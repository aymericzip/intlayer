...
# Angular i18n - Intlayer का उपयोग करके अपनी Angular वेबसाइट का अनुवाद करें | अंतर्राष्ट्रीयकरण (i18n)

> यह पैकेज विकास के अधीन है। अधिक जानकारी के लिए [समस्या](https://github.com/aymericzip/intlayer/issues/116) देखें। समस्या को लाइक करके Angular के लिए Intlayer में अपनी रुचि दिखाएं
