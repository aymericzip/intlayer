...
## Vite प्लगइन: बंडल किया गया Compiler और Proxy

`intlayer()` Vite प्लगइन अब सीधे **compiler** और **locale-routing proxy** को बंडल करता है, इसलिए अधिकांश प्रोजेक्ट्स को `vite.config.ts` में केवल एक प्लगइन की आवश्यकता होती है:
...
- **Compiler**: यह स्वचालित रूप से तब सक्रिय होता है जब `compiler.enabled` सेट होता है और एक `compiler.output` पथ कॉन्फ़िगर किया जाता है। अब आपको `intlayerCompiler()` को अलग से पंजीकृत करने की आवश्यकता नहीं है।
- **Proxy**: यह नए `routing.enableProxy` विकल्प (डिफ़ॉल्ट रूप से `true`) के आधार पर स्वचालित रूप से सक्रिय हो जाता है। यह Development, Preview और Production SSR में लोकेल डिटेक्शन / रिडायरेक्ट / रीराइट मिडलवेयर को वायर करता है। अब आपको `intlayerProxy()` को अलग से पंजीकृत करने की आवश्यकता नहीं है।

### `routing.enableProxy` विकल्प

एक नया `routing.enableProxy` विकल्प नियंत्रित करता है कि क्या लोकेल-रूटिंग प्रॉक्सी प्लग-इन है। इसका डिफ़ॉल्ट मान `true` है। यदि आप लोकेल रूटिंग को स्वयं संभालना चाहते हैं तो इसे अक्षम करें:
...
स्वतंत्र `intlayerCompiler()` और `intlayerProxy()` प्लगइन उन्नत सेटअप के लिए निर्यात किए जाते रहेंगे। उन्हें `intlayer()` के साथ पंजीकृत करना सुरक्षित है — प्रत्येक प्लगइन स्वयं को डीडुप्लीकेट करता है और केवल एक बार चलता है।
