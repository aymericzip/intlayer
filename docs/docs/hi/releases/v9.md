...
एक नया वैकल्पिक पैकेज, [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/analytics.md), आपको बताता है कि आपके विज़िटर्स को वास्तव में कौन-सी सामग्री दिखाई जा रही है — और **Collections & Variants** के साथ यह चक्र पूरा करता है, जिससे आप कंटेंट पर A/B टेस्ट कर सकते हैं और प्रत्येक वेरिएंट के लिए कन्वर्ज़न माप सकते हैं।
...
आज React, Next.js, और React Native (`react-intlayer` के माध्यम से) के लिए उपलब्ध है; अन्य फ्रेमवर्क बाइंडिंग्स (Vue, Svelte, Angular, …) की योजना बनाई गई है, जो `@intlayer/editor` के समान रोलआउट पैटर्न का पालन करेंगी। पूर्ण गाइड के लिए [Analytics दस्तावेज़](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/analytics.md) देखें।
...
- [Analytics - कंटेंट एक्सपोज़र ट्रैकिंग और A/B टेस्टिंग](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/analytics.md)
