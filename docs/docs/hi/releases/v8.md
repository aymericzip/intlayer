...
- **एकीकृत रिच सामग्री API**: नई `.use()` विधि अब मार्कडाउन और HTML ओवरराइड दोनों के लिए उपयोग की जाती है, जो सभी रिच सामग्री प्रकारों में एक सुसंगत API प्रदान करती है।
