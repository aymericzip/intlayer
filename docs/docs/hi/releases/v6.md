...
अधिक विकल्प CLI दस्तावेज़ों में देखें: [CLI संदर्भ](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/cli/index.md) → "गायब अनुवादों का परीक्षण करें"। साथ ही [परीक्षण](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/testing.md) मार्गदर्शिका।
...
`npx intlayer fill` कमांड का उपयोग करके अपने गायब अनुवादों को स्वचालित रूप से भरें।
...
MCP सर्वर को नई features को support करने के लिए update किया गया है।

- स्वचालित भरण
- अनुपलब्ध अनुवाद परीक्षण करें
- लाइव अपडेट
- लॉगिंग
- सत्यापन
- माइग्रेशन नोट्स
...
> MCP server Intlayer का उपयोग करके परियोजनाओं के स्वचालन में मदद करता है। ऑटोजेनरेटेड कोड के लिए लापता अनुवादों का परीक्षण करता है। यह आपके config को समझने और अपने IDE में Intlayer के दस्तावेज़ को एम्बेड करने में मदद करता है।
...
## Turbopack पर फ़ाइलों को देखने के लिए समानांतर प्रक्रिया

जब आप अपने development server के रूप में `next dev --turbopack` कमांड के साथ Next.js 14 और उससे ऊपर पर Turbopack का उपयोग कर रहे हों, तो dictionary में होने वाले परिवर्तन डिफ़ॉल्ट रूप से स्वचालित रूप से पहचाने नहीं जाएंगे।

यह सीमा इसलिए होती है क्योंकि Turbopack आपकी content फ़ाइलों में परिवर्तनों की निगरानी करने के लिए webpack plugins को समानांतर में चलाने में सक्षम नहीं है।

इसके आस-पास काम करने के लिए, हमने `intlayer watch` कमांड को छोड़ दिया है, `--with` विकल्प का उपयोग करके development server और Intlayer build watcher दोनों को एक साथ चलाते हैं।
...
## v6 से v7 में माइग्रेशन नोट्स

अधिक जानकारी के लिए [v6 से v7 में माइग्रेशन नोट्स](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/releases/v7.md) देखें।

---

## उपयोगी लिंक

- [CLI संदर्भ](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/cli/index.md)
