...
# Intlayer का उपयोग करके अपनी Vite और Vue वेबसाइट का अनुवाद करें | Internationalization (i18n)
...
`Vue-i18n` या `i18next` जैसे मुख्य समाधानों की तुलना में, Intlayer एक ऐसा समाधान है जो एकीकृत अनुकूलन के साथ आता है जैसे:
...
> आपकी सामग्री घोषणाएँ आपके एप्लिकेशन में कहीं भी परिभाषित की जा सकती हैं जब वे `contentDir` निर्देशिका (डिफ़ॉल्ट रूप से, `./src`) में शामिल हो जाती हैं। और सामग्री घोषणा फ़ाइल एक्सटेंशन से मेल खाती हैं (डिफ़ॉल्ट रूप से, `.content.{json,ts,tsx,js,jsx,mjs,cjs,md,mdx,yaml,yml}`)।
...
<Step number={7} title="अपने एप्लिकेशन में स्थानीयकृत राउटिंग जोड़ें" isOptional={true}>
...
<Step number={8} title="जब स्थानीयता बदलती है तो URL बदलें" isOptional={true}>
...
Intlayer module augmentation का उपयोग करता है ताकि TypeScript के लाभ प्राप्त कर सकें और अपने codebase को मजबूत बना सकें।
...
```json5 fileName="tsconfig.json"
{
  ...
  "include": [
    // ... आपके मौजूदा TypeScript कॉन्फ़िगरेशन
    ".intlayer/**/*.ts", // Auto-generated types को शामिल करें
  ],
}
```
...
Intlayer द्वारा उत्पन्न फ़ाइलों को अनदेखा करने की सिफारिश की जाती है। यह आपको उन्हें अपने Git repository में commit करने से बचाता है।
...
Intlayer के साथ अपने development experience को improve करने के लिए, आप official **Intlayer VS Code Extension** install कर सकते हैं।
...
<Question title="Vue अनुप्रयोगों के अंतर्राष्ट्रीयकरण के लिए कौन से विभिन्न समाधान उपलब्ध हैं?">

- **`vue-i18n`**: वैश्विक संदेश कैटलॉग के साथ मानक लाइब्रेरी।
- **`Intlayer`**: घटक के बगल में घोषणा, बिल्ड समय संकलन के लिए Vite प्लगइन, पूर्ण TypeScript प्रकार, AI अनुवाद और विज़ुअल एडिटर।

[Intlayer क्यों चुनें](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/interest_of_intlayer.md) और [Vue के लिए बेंचमार्क](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/benchmark/vue.md) देखें।

</Question>

<Question title="i18n मेरे Vue बंडल आकार को कितना बढ़ाता है?">
...
हाँ। [vue-i18n माइग्रेशन गाइड](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/migration_from_vue-i18n_to_intlayer.md) या संगतता एडेप्टर का उपयोग करें।
...
<Question title="क्या Intlayer Vue Composition API और script setup के साथ काम करता है?">

हाँ। `useIntlayer` `<script setup>` के लिए मानक कंपोज़ेबल है, और लौटाया गया मान प्रतिक्रियाशील है, इसलिए भाषा बदलने पर पृष्ठ पुनः लोड किए बिना UI अपडेट हो जाता है।

</Question>

<Question title="Vue SPA में स्थानीयकृत रूटिंग कैसे सेट करें?">

अपने Vue Router रूट्स में लोकेल पैरामीटर कॉन्फ़िगर करें या सर्च पैरामीटर का उपयोग करें; Intlayer सक्रिय भाषा को URL के साथ सिंक करता है। [कॉन्फ़िगरेशन संदर्भ](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/configuration.md) देखें।

</Question>

<Question title="दाएं से बाएं भाषाओं के लिए html lang और dir विशेषताएँ कैसे सेट करें?">

चरण 9 इसे समझाता है। फ़ंक्शन `getHTMLTextDir` अरबी या हिब्रू के लिए `rtl` लौटाता है, जिससे आप रूट तत्व पर `lang` और `dir` बाइंड कर सकते हैं।

</Question>

<Question title="AI के साथ Vue ऐप का स्वचालित अनुवाद कैसे करें?">

`npx intlayer fill` चलाएं। टूल छूटे हुए अनुवादों का पता लगाता है और आपके चुने हुए LLM का उपयोग करके उन्हें भरता है। [fill command](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/cli/fill.md) देखें।
