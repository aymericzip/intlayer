...
3.  आवश्यक कॉन्फ़िगरेशन फ़ाइलें जनरेट करेगा (जैसे `.cursor/skills/intlayer_next_js/SKILL.md`, `.windsurf/skills/next_js/SKILL.md`, `.opencode/skills/next_js/SKILL.md`, `.vscode/mcp.json`, आदि)।
