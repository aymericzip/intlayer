...
इस आर्किटेक्चर में, `react-native-intlayer` स्क्रीन और घटकों में अनुवाद प्रबंधित करने के लिए रूट `IntlayerProvider` और React Native हुक प्रदान करता है। सामग्री घोषणाएं उनके घटकों के साथ स्थित होती हैं।
