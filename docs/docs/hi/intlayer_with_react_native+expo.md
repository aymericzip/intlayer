...
- [इंटलेयर कॉन्फ़िगरेशन डॉक्स](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/configuration.md) देखें अधिक जानकारी के लिए।
...
- **CLI कमांड्स**: अनुवाद निकालने या गायब कुंजियों की जांच जैसे कार्यों के लिए [Intlayer CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/intlayer_cli.md) का अन्वेषण करें।
