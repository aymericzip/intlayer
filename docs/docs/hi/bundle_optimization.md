...
history:
  - version: 9.2.1
    date: 2026-08-09
    changes: "`purge` और `minify` अब `@intlayer/swc` के माध्यम से Next.js पर काम करते हैं — `babel.config.js` की आवश्यकता नहीं"
  - version: 8.12.0
    date: 2026-06-24
    changes: "संदर्भ तालिकाओं में Babel प्लगइन्स को आवश्यक पाइपलाइन क्रम में सूचीबद्ध करें (extract → purge → minify → optimize)"
  - version: 8.12.0
    date: 2026-06-07
...
const nextConfig: NextConfig = {/* आपका कॉन्फ़िग */};
...
const config: IntlayerConfig = {
  build: {
    purge: true, // बंडल किए गए JSON से अप्रयुक्त कंटेंट फ़ील्ड हटाता है
    minify: true, // कंटेंट फ़ील्ड कुंजियों का नाम छोटे उपनामों में बदलता है
  },
};
...
> `withIntlayerSync` नहीं, बल्कि एसिंक्रोनस `withIntlayer` का उपयोग करें। सिंक्रोनस संस्करण विश्लेषण पाइपलाइन नहीं चलाता, इसलिए उसके साथ purge और minify का कोई प्रभाव नहीं होता।
...
> जब `optimize` `false` होता है तो मिनिफिकेशन छोड़ दिया जाता है (skipped)। जब `editor.enabled` `true` होता है तो यह फिर भी चलता है, लेकिन फ़ील्ड का नाम बदलने वाला चरण छोड़ दिया जाता है — विज़ुअल एडिटर संपादनों को `keyPath` के माध्यम से हल करता है, इसलिए मूल फ़ील्ड नामों का बने रहना ज़रूरी है।
...
> जब `optimize` `false` होता है तो पर्ज (Purge) छोड़ दिया जाता है (skipped)। जब `editor.enabled` `true` होता है तब भी यह सक्रिय रहता है — क्योंकि हटाए गए फ़ील्ड को कोई भी कंपोनेंट नहीं पढ़ता, इसलिए एडिटर उसे कभी रेंडर नहीं करता। Next.js पर यह तब भी छोड़ दिया जाता है जब `@intlayer/swc` उपलब्ध न हो, और जब कम्पैट-अडैप्टर कॉलर्स कॉन्फ़िगर किए गए हों।
