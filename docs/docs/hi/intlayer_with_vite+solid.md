...
इस आर्किटेक्चर में, `solid-intlayer` Solid ट्री को रैप करने के लिए `index.tsx` में माउंटेड `IntlayerProvider` प्रदान करता है। सामग्री घोषणाएं `src/` में घटकों के साथ रहती हैं।
