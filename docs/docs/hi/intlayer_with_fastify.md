...
title: Fastify i18n - Fastify ऐप कैसे अनुवाद करें 2026 में
...
> आपकी कंटेंट घोषणाएँ आपकी एप्लिकेशन में कहीं भी परिभाषित की जा सकती हैं बशर्ते वे `contentDir` निर्देशिका में शामिल हों (डिफ़ॉल्ट रूप से, `./src`)। और यह कंटेंट घोषणा फ़ाइल एक्सटेंशन से मेल खानी चाहिए (डिफ़ॉल्ट रूप से, `.content.{json,ts,tsx,js,jsx,mjs,cjs}`)।
