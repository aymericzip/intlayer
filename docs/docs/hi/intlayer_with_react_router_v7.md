...
<iframe title="How to translate an React Router v7 app using Intlayer" class="m-auto aspect-16/9 w-full overflow-hidden rounded-lg border-0" allow="autoplay; gyroscope;" loading="lazy" width="1080" height="auto" src="https://www.youtube.com/embed/dS9L7uJeak4?autoplay=0&amp;origin=https://intlayer.org&amp;controls=0&amp;rel=1"/>
  ...
  <Tab label="कोड (कॉन्फ़िगरेशन-आधारित)" value="code-config">
...
/>
  ...
  <Tab label="कोड (फ़ाइल-सिस्टम रूट)" value="code-fs">
...
/>
  ...
  <Tab label="डेमो (कॉन्फ़िगरेशन-आधारित)" value="demo">
...
export default [
  route("/:locale?", "routes/page.tsx"), // स्थानीयकृत होम पेज
  route("/:locale?/about", "routes/about/page.tsx"), // स्थानीयकृत अबाउट पेज
...
<Step number={12} title="अपने घटकों की सामग्री निकालें" isOptional={true}>
