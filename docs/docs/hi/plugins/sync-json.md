...
जब कई प्लगइन एक ही शब्दकोश कुंजी को लक्षित करते हैं, तो `priority` पैरामीटर यह निर्धारित करता है कि कौन सा प्लगइन प्राथमिकता लेता है:

- उच्च प्राथमिकता संख्या निम्न संख्याओं पर जीत जाते हैं
- `.content` फाइलों की डिफ़ॉल्ट प्राथमिकता `0` है
- प्लगइन की डिफ़ॉल्ट प्राथमिकता `0` है
- समान प्राथमिकता वाले प्लगइन को कॉन्फ़िगरेशन में दिखाई देने के क्रम में संसाधित किया जाता है
...
const config: IntlayerConfig = {
  ...
  plugins: [
    // प्राथमिक JSON स्रोत (उच्चतम प्राथमिकता)
    syncJSON({
      format: "i18next",
      source: ({ key, locale }) => `./locales/${locale}/${key}.json`,
    ...
    // फॉलबैक JSON स्रोत (निम्न प्राथमिकता)
    syncJSON({
      format: "i18next",
    ...
    // लीगेसी JSON स्रोत (सबसे कम प्राथमिकता)
    syncJSON({
      format: "i18next",
