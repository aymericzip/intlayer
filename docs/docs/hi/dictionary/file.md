...
# फाइल कंटेंट / Intlayer में फाइलों को एम्बेड करना

Intlayer में, `file` फ़ंक्शन एक शब्दकोश में बाहरी फाइल कंटेंट को एम्बेड करने की अनुमति देता है। यह दृष्टिकोण सुनिश्चित करता है कि Intlayer स्रोत फाइल को पहचानता है, जिससे Intlayer Visual Editor और CMS के साथ seamless integration संभव हो जाती है।
...
## विभिन्न प्रकार के पाथ

`file` फ़ंक्शन का उपयोग करते समय, आप एम्बेड करने के लिए फ़ाइल को निर्दिष्ट करने के लिए विभिन्न प्रकार के पाथ का उपयोग कर सकते हैं।

- `file("./path/to/file.txt")` - वर्तमान फ़ाइल के सापेक्ष पाथ
- `file("path/to/file.txt")` - प्रोजेक्ट रूट डायरेक्टरी के सापेक्ष पाथ
- `file("/users/username/path/to/file.txt")` - पूर्ण पाथ
