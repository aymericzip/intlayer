...
शब्दकोश के स्थान को इंगित करता है और नियंत्रित करता है कि यह CMS के साथ कैसे सिंक्रनाइज़ होता है:

- `'local'`: शब्दकोश केवल स्थानीय रूप से प्रबंधित किया जाता है। इसे दूरस्थ CMS पर पुश नहीं किया जाएगा। उस सामग्री के लिए उपयोग करें जो आपके कोडबेस में रहनी चाहिए।
- `'remote'`: शब्दकोश केवल दूरस्थ रूप से प्रबंधित किया जाता है। CMS पर पुश करने के बाद, यह स्थानीय फ़ाइल से अलग हो जाएगा। सामग्री लोड करने के समय, दूरस्थ शब्दकोश CMS से खींचा जाएगा। `remote` स्थान वाली `.content` फ़ाइल प्रारंभिक पुश के बाद अनदेखी की जाएगी।
- `'hybrid'`: शब्दकोश स्थानीय और दूरस्थ दोनों रूप से प्रबंधित किया जाता है। CMS पर पुश करने के बाद, यह सिंक्रनाइज़ रहेगा, स्थानीय फ़ाइल से परिवर्तन CMS पर पुश किए जाते हैं, और दूरस्थ परिवर्तन स्थानीय फ़ाइल में वापस खींचे जा सकते हैं।
- `string` (उदा. `'plugin'`): शब्दकोश एक प्लगइन या कस्टम स्रोत द्वारा प्रबंधित किया जाता है। जब आप इसे पुश करने का प्रयास करेंगे, तो सिस्टम आपसे पूछेगा कि क्या करना है।
...
{
  key: "about-page",
  location: "local", // सामग्री केवल आपके कोडबेस में रहती है
  content: {
    title: "About Us"
  }
}
...
आयात मोड निर्धारित करता है कि आपका शब्दकोश आपके एप्लिकेशन में कैसे आयात किया जाता है।

- `'static'`: शब्दकोश बिल्ड समय पर स्थिर रूप से आयात किया जाता है। यह डिफ़ॉल्ट मोड है।
- `'dynamic'`: शब्दकोश suspense API का उपयोग करके रनटाइम पर गतिशील रूप से आयात किया जाता है।
- `'fetch'`: शब्दकोश लाइव सिंक API का उपयोग करके गतिशील रूप से आयात किया जाता है।

यदि सेट किया गया है, तो यह गुण `intlayer.config.ts` में परिभाषित वैश्विक `importMode` को ओवरराइड करता है।
