...
- `'local&remote'`: शब्दकोश स्थानीय और दूरस्थ दोनों रूप से प्रबंधित किया जाता है। CMS पर पुश करने के बाद, यह सिंक्रनाइज़ रहेगा—स्थानीय फ़ाइल से परिवर्तन CMS पर पुश किए जाते हैं, और दूरस्थ परिवर्तन स्थानीय फ़ाइल में वापस खींचे जा सकते हैं।
...
- `'live'`: शब्दकोश लाइव सिंक API का उपयोग करके गतिशील रूप से आयात किया जाता है।
