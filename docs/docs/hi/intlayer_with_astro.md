...
title: Astro में Intlayer के साथ शुरुआत करना
...
# Intlayer और Astro के साथ अंतरराष्ट्रीयकरण (i18n) शुरू करना
...
| ------- | ---------- | ---------------------------------------------- |
| 6.2.0   | 2025-10-03 | एस्ट्रो एकीकरण, कॉन्फ़िग, उपयोग के लिए रिफ्रेश |
