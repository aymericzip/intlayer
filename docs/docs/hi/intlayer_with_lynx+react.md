...
<iframe
  ...
  title="Demo CodeSandbox - Intlayer का उपयोग करके अपने एप्लिकेशन को अंतरराष्ट्रीयकृत करने के तरीके"
...
<AccordionGroup>
<Accordion header="पूर्ण लिंक्स कवरेज">
...
<Step number={2} title="एक इंटलेयर कॉन्फ़िग बनाएं">
...
<Step number={3} title="लिनक्स बंडलर में इंटलेयर प्लगइन जोड़ें">
...
<Step number={4} title="इंटलेयर प्रदाता जोड़ें">
...
<Step number={7} title="ऐप का स्थानीय सेटिंग बदलें">
