...
<Step number={12} title="सर्वर एक्शन्स (Server Actions) में वर्तमान लोकेल प्राप्त करें" isOptional={true}>

यदि आपको सर्वर एक्शन (Server Action) के भीतर सक्रिय लोकेल की आवश्यकता है (उदाहरण के लिए, ईमेल को स्थानीयकृत करने या लोकेल-जागरूक लॉजिक चलाने के लिए), तो `next-intlayer/server` से `getLocale` को कॉल करें:
...
export const myServerAction = async () => {
  ...
  // लोकेल के साथ कुछ करें
};
```

> `getLocale` फ़ंक्शन उपयोगकर्ता के लोकेल को निर्धारित करने के लिए एक कैस्केडिंग रणनीति का पालन करता है:
>
> 1. सबसे पहले, यह अनुरोध हेडर में एक लोकेल मान की जांच करता है जो प्रॉक्सी द्वारा सेट किया गया हो सकता है
> 2. यदि हेडर में कोई लोकेल नहीं मिलता है, तो यह कुकीज़ में संग्रहीत लोकेल की तलाश करता है
> 3. यदि कोई कुकी नहीं मिलती है, तो यह उनके ब्राउज़र सेटिंग्स से उपयोगकर्ता की पसंदीदा भाषा का पता लगाने का प्रयास करता है
> 4. अंतिम उपाय के रूप में, यह एप्लिकेशन के कॉन्फ़िगर किए गए डिफ़ॉल्ट लोकेल पर वापस आ जाता है
>
> यह उपलब्ध संदर्भ के आधार पर सबसे उपयुक्त लोकेल का चयन सुनिश्चित करता है।

</Step>
<Step number={13} title="अपने बंडल आकार को अनुकूलित करें" isOptional={true}>
...
जब `next dev` कमांड के साथ विकास सर्वर के रूप में Turbopack का उपयोग किया जाता है, तो शब्दकोश परिवर्तन डिफ़ॉल्ट रूप से स्वचालित रूप से पता नहीं चलते हैं।
...
> यदि आप next-intlayer@<=6.x.x का उपयोग कर रहे हैं, तो आपको Next.js 16 एप्लिकेशन को Turbopack के साथ सही ढंग से काम करने के लिए `--turbopack` फ़्लैग रखना होगा। हम इस सीमा से बचने के लिए next-intlayer@>=7.x.x का उपयोग करने की अनुशंसा करते हैं।
...
<Question title="Next.js 16 अनुप्रयोगों के अंतर्राष्ट्रीयकरण के लिए कौन से विभिन्न समाधान उपलब्ध हैं?">

Next.js में कोई इन-बिल्ट संदेश परत नहीं है क्योंकि `next.config.js` का `i18n` फ़ील्ड App Router पर लागू होना बंद हो गया है, इसलिए स्थानीयकरण परत हमेशा एक लाइब्रेरी का विकल्प होती है:
...
नहीं। `npx intlayer extract` चलाएं और Intlayer आपके घटकों को पढ़ता है, उपयोगकर्ता के अनुकूल स्ट्रिंग्स निकालता है, और प्रत्येक के बगल में एक `.content` फ़ाइल लिखता है, जिससे आप कैटलॉग में मैन्युअल रूप से कॉपी करने के बजाय एक diff की समीक्षा करते हैं। इस गाइड का चरण 14 इसे समझाता है।
