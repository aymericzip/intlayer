...
> [पूर्ण बेंचमार्क डेटा देखें](https://intlayer.org/markdown?url=https%3A%2F%2Fraw.githubusercontent.com%2Fintlayer-org%2Fbenchmark-i18n%2Fmain%2Freport%2Fscripts%2Fsummarize-tanstack.md)
...
- **Intlayer**: TanStack Start के लिए सर्वश्रेष्ठ प्रदर्शन और सबसे छोटा बंडल आकार (v9.5.1) प्रदान करता है।
...
- [`@intlayer/lingui`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/compat/lingui.md) (v9.5.1)
...
- लगभग 111kb के ऐप के लिए, `gt-react` 170kb से अधिक अतिरिक्त डेटा जोड़ सकता है (इसी बेंचमार्क में Next.js कार्यान्वयन पर देखा गया परिमाण)।
...
पैकेज काफी भारी है (~11.1kb, जो `react-intlayer` से 2× अधिक है)।
...
पैकेज विशेष रूप से भारी है (~18.4kb, जो `react-intlayer` का लगभग 3.5× है)।
