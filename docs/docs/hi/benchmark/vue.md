...
description: vue-i18n, fluent-vue, Tolgee, और Intlayer जैसे Vue अंतर्राष्ट्रीयकरण (i18n) पुस्तकालयों की तुलना करें। बंडल आकार, लीकेज और प्रतिक्रियाशीलता पर विस्तृत प्रदर्शन रिपोर्ट।
keywords:
  - benchmark
  - i18n
  - intl
...
history:
  ...
  - version: 9.5.7
    date: 2026-09-23
    changes: "बेंचमार्क परिणाम अपडेट किए गए और Tolgee जोड़ा गया"
  - version: 9.5.1
    date: 2026-09-11
    changes: "बेंचमार्क परिणाम अपडेट किए गए"
  - version: 8.9.8
...
- **Intlayer**: मूल स्कोपिंग (scoping) और डायनेमिक लोडिंग के साथ सबसे हल्का समाधान (v9.5.10)।
- **Tolgee**: डायनामिक मोड में शून्य लीकेज के साथ प्रभावी डायनामिक लोडिंग, लेकिन भारी (~3.0× Intlayer) और कंपाइल-टाइम टाइप सेफ्टी का अभाव है।
...
- [`vue-intlayer`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/packages/vue-intlayer/exports.md) (v9.5.10)
- [`@intlayer/vue-i18n`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/compat/vue-i18n.md) (v9.5.10)
...
`Tolgee` पहले उल्लेखित कई मुद्दों को संबोधित करता है, डायनामिक लोडिंग की पेशकश करता है जो लोकेल और पेज लीकेज को सफलतापूर्वक समाप्त करता है (पेज JS को घटाकर लगभग 58.8kb करता है)। हालांकि, यह कीज़ के लिए कंपाइल-टाइम टाइप सेफ्टी प्रदान नहीं करता है, जिससे गायब कीज़ को पकड़ना कठिन हो जाता है। इसके अलावा, लाइब्रेरी का आकार अपेक्षाकृत भारी है (~13.8kb, जो कि `vue-intlayer` से लगभग 3.7 गुना है)।
