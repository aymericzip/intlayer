...
| `contentDir`     | उस निर्देशिका का पाथ जहाँ कंटेंट परिभाषा फ़ाइलें (`.content.*`) रखी जाती हैं।                                                       | `string[]` | `['.']`                                                                                                                                                                   | `['src', '../../ui-library', require.resolve("@my-package/content")]`                                                                                                                 | कंटेंट फ़ाइलों की ट्रैकिंग और डिक्शनरी के पुनर्जन्म के लिए उपयोग किया जाता है।                                                                                       |
