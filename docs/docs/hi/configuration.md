...
| `minify`          | इंगित करता है कि बंडल के आकार को कम करने के लिए डिक्शनरी को मिनिअफ़ाइ किया जाना चाहिए या नहीं।         | `boolean`                        | `true`                                                                                                                                                                            |                                                                               | • बंडल को मिनिअफ़ाइ किया जाना चाहिए या नहीं।<br/>• डिफ़ॉल्ट: प्रोडक्शन में `true`।<br/>• `optimize` अक्षम होने पर यह विकल्प अनदेखा किया जाएगा।<br/>• `editor.enabled` सत्य होने पर यह विकल्प अनदेखा किया जाएगा।                                                                                                                                    |
