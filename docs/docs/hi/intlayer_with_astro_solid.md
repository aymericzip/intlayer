...
priority: 9
title: "Astro + Solid i18n - अपने ऐप को अनुवाद करने का पूर्ण गाइड"
...
history:
  ...
  - version: 8.7.7
    date: 2026-04-24
    changes: "Astro + Solid के लिए प्रारंभिक दस्तावेज़ीकरण"
author: aymericzip
---
...
- **solid-intlayer**
  Solid अनुप्रयोगों में Intlayer को एकीकृत करने के लिए पैकेज। यह Solid में अंतर्राष्ट्रीयकरण के लिए `IntlayerProvider` के साथ-साथ `useIntlayer` और `useLocale` प्रिमिटिव्स (primitives) प्रदान करता है।

- **@astrojs/solid-js**
  आधिकारिक Astro एकीकरण जो Solid घटक islands के उपयोग की अनुमति देता है।
...
आपको हर पृष्ठ पर SEO मेटाडेटा (जैसे hreflang और कैनोनिकल लिंक) भी जोड़ना चाहिए और इंटरैक्टिव क्लाइंट-साइड सामग्री के लिए एक Solid island पेश करना चाहिए।
...
<html lang={locale} dir={getHTMLTextDir(locale)}>
  ...
  <body>
    <!-- Solid island भाषा स्विचर सहित सभी इंटरैक्टिव सामग्री को रेंडर करता है -->
    <SolidIsland locale={locale} client:only="solid-js" />
  </body>
</html>
```

> यदि आप अपनी content को एक `string` attribute में उपयोग करना चाहते हैं, जैसे `alt`, `title`, `href`, `aria-label`, आदि, तो आप function के मान का उपयोग कर सकते हैं, जैसे:
...
<Step number={6} title="एक Solid Island घटक बनाएँ">
...
> **Solid प्रतिक्रियात्मकता पर नोट:**
> Solid में, `locale` एक प्रतिक्रियाशील सिग्नल एक्सेसर है - वर्तमान मान प्राप्त करने के लिए इसे हमेशा `locale()` के रूप में बुलाएं।
...
यदि आप और अधिक सीखना चाहते हैं, तो आप [विजुुअल एडिटर](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/intlayer_visual_editor.md) को भी लागू कर सकते हैं या अपनी सामग्री को बाहरी बनाने के लिए [CMS](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/intlayer_CMS.md) का उपयोग कर सकते हैं।

## अक्सर पूछे जाने वाले प्रश्न

<FAQ>

<Question title="Solid आइलैंड वाली Astro साइट के अंतर्राष्ट्रीयकरण के लिए कौन से विभिन्न समाधान उपलब्ध हैं?">

Astro का अंतर्निहित `i18n` विकल्प उपसर्गों और पुनर्निर्देशों को संभालता है लेकिन सामग्री का प्रबंधन नहीं करता है। आइलैंड जोड़ने से एक अतिरिक्त चुनौती पैदा होती है: वे Astro नहीं बल्कि Solid चलाते हैं।

- **Astro `i18n` प्लस कस्टम शब्दकोश**, और आइलैंड में **`@solid-primitives/i18n`**: बिना साझा प्रकारों के दो अलग-अलग सामग्री स्रोत।
- **`Intlayer`**: दोनों के लिए एक साझा सामग्री परत। `astro-intlayer` `.astro` पृष्ठों को सेवा प्रदान करता है, और `solid-intlayer` Solid आइलैंड के लिए समान घोषणा पढ़ता है।
...
काफी हद तक हाँ। [माइग्रेशन गाइड](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/migration_from_i18next_to_intlayer.md) का पालन करें। आप धीरे-धीरे भी माइग्रेट कर सकते हैं: [sync JSON plugin](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/plugins/sync-json.md) आपके JSON कैटलॉग को सत्य का स्रोत बनाए रखता है और Intlayer शब्दकोश उत्पन्न करता है।
...
<Question title="क्या मुझे अपने Solid आइलैंड के अंदर एक अलग i18n लाइब्रेरी की आवश्यकता है?">

नहीं। `solid-intlayer` पैकेज Astro के समान शब्दकोश पढ़ता है, इसलिए आपको इसके साथ `@solid-primitives/i18n` स्थापित करने की आवश्यकता नहीं है। चरण 6 दिखाता है कि कैसे आइलैंड घटक सीधे पृष्ठ से लोकेल प्राप्त करते हैं।
