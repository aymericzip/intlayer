...
| `usePathname`          | हुक जो भाषा खंड को हटाकर वर्तमान पाथनाम लौटाता है। `popstate` के माध्यम से ब्राउज़र नेविगेशन पर प्रतिक्रियाशील है।                                                  | [usePathname](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/packages/react-intlayer/usePathname.md)     |
...
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| `renderHTML`         | घटकों के बाहर HTML रेंडर करने के लिए स्टैंडअलोन उपयोगिता।                                                                                                      | -                                                                                                 |
| `renderMarkdown`     | घटकों के बाहर Markdown रेंडर करने के लिए स्टैंडअलोन उपयोगिता।                                                                                                  | -                                                                                                 |
