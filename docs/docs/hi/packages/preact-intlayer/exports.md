...
| `usePathname`   | यह हुक (hook) locale सेगमेंट को हटाकर वर्तमान पाथनेम (pathname) लौटाता है। `popstate` के माध्यम से ब्राउज़र नेविगेशन पर प्रतिक्रिया करता है। | [usePathname](https://github.com/aymericzip/intlayer/blob/main/docs/docs/hi/packages/preact-intlayer/usePathname.md) |
