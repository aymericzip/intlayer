...
जब `editor.enabled` `true` होता है, तो प्लगइन चलता तो रहता है लेकिन **फ़ील्ड का नाम बदलना छोड़ देता है**: नाम बदलने की प्रक्रिया उन कंटेंट कीज़ को फिर से लिखती है जिनसे इंटरप्रेटर गुज़रता है, जिससे विज़ुअल एडिटर को मिलने वाला `keyPath` उन बिना-मर्ज किए डिक्शनरी से मेल नहीं खाएगा जिन्हें वह संपादित करता है। व्हाइटस्पेस कंपैक्शन और टॉप-लेवल मेटाडेटा हटाना सक्रिय बना रहता है।
