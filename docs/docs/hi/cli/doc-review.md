...
मुझे समझ आ गया। मैं **BLOCK 1 of 3** की प्रतीक्षा कर रहा हूँ।

1. **English (en) source content** - संदर्भ के लिए आधार ब्लॉक
2. **Hindi (hi) current content** - समीक्षा के लिए वर्तमान अनुवाद
3. **Action mode** - `apply`, `report`, या `synthesis` में से एक

> उदाहरण: `npx intlayer doc review --mode report`

> उदाहरण: `npx intlayer doc review --log`

चाहे कोई भी मोड हो, रन एक सारांश के साथ समाप्त होता है जो उन दस्तावेज़ों को सूचीबद्ध करता है जो अपने आधार दस्तावेज़ के साथ संरेखित हैं और जिनमें अभी भी संपादन के लिए ब्लॉक हैं।
