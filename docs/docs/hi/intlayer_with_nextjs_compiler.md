...
title: Next.js i18n - मौजूदा Next.js एप्लिकेशंस को बाद में बहुभाषी (i18n) कैसे बनायें (2026 i18n गाइड)
...
# मौजूदा Next.js एप्लिकेशन को बाद में बहुभाषी (i18n) कैसे बनायें (2026 i18n गाइड)
...
बस अपने डैफ़ॉल्ट (default) लोकेल में हार्डकोड (hardcoded) की गई तारों (strings) के साथ अपने घटकों (components) को लिखें, और कंपाइलर बाकी का काम करेगा।

आपका पृष्ठ (page) कैसा दिखना चाहिए, इसका एक उदाहरण:
...
const PageContent: FC = () => {
  return (
    <>
      <p>संपादन (editing) करके शुरू करें</p>
...
### (वैकल्पिक) चरण 7: लोकेल का पता लगाने के लिए प्रॉक्सी (Proxy) कॉन्फ़िगर करें
...
### (वैकल्पिक) चरण 8: सामग्री की भाषा बदलें
...
### (वैकल्पिक) चरण 9: सर्वर एक्शन (Server Action) में वर्तमान लोकेल का उपयोग करें
...
### (वैकल्पिक) चरण 10: अपने बंडल को अनुकूलित (Optimize) करें
