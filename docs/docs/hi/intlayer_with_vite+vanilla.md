...
इस आर्किटेक्चर में, `vanilla-intlayer` या कोर `intlayer` अनुवाद प्रबंधित करने और DOM सामग्री को गतिशील रूप से अपडेट करने के लिए JavaScript API प्रदान करता है। सामग्री घोषणाएं `src/` में रहती हैं।
