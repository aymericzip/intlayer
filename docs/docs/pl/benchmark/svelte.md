...
Reaktywność podczas zmiany języka jest bardzo szybka (0.5ms) dzięki reaktywnym magazynom (stores) Svelte, chociaż narzut hydratacji jest nieco wyższy (~6.2ms w porównaniu do ~5.5ms dla Intlayer).
