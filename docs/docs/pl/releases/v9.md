...
Nowy opcjonalny pakiet, [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pl/analytics.md), pokazuje, jakie treści są faktycznie wyświetlane Twoim odwiedzającym — i domyka pętlę z **Collections & Variants**, umożliwiając testowanie treści A/B i mierzenie konwersji dla każdego wariantu.
...
Dostępne już dziś dla React, Next.js i React Native (poprzez `react-intlayer`); inne wiązania frameworków (Vue, Svelte, Angular, …) są planowane, zgodnie z tym samym wzorcem wdrażania co `@intlayer/editor`. Pełny przewodnik znajdziesz w [dokumentacji Analytics](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pl/analytics.md).
...
- [Analytics - Śledzenie ekspozycji treści i testy A/B](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pl/analytics.md)
