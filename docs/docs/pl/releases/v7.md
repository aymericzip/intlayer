...
Aby uzyskać więcej informacji o plikach deklaracji treści i sposobie zastosowania wartości konfiguracji, zobacz [Dokumentację pliku treści](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pl/dictionary/content_file.md).
