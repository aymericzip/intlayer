...
Zobacz więcej opcji w dokumentacji CLI: [Referencja CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pl/cli/index.md) → "Testuj brakujące tłumaczenia". A także przewodnik [Testowanie](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pl/testing.md).
...
- [Referencja CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pl/cli/index.md)
