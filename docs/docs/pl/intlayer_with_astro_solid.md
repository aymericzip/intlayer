...
Powinieneś również dodać metadane SEO (takie jak linki hreflang i kanoniczne) na każdej stronie oraz wprowadzić island Solid dla interaktywnej treści po stronie klienta.
