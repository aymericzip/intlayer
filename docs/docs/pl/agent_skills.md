...
3.  Wygeneruje wymagane pliki konfiguracyjne (takie jak `.cursor/skills/intlayer_next_js/SKILL.md`, `.windsurf/skills/intlayer_next_js/SKILL.md`, `.opencode/skills/next_js/SKILL.md`, `.vscode/mcp.json` itp.).
