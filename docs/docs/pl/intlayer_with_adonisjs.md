...
title: AdonisJS i18n - Jak przetłumaczyć aplikację AdonisJS w 2026
...
<iframe
  src="https://ide.intlayer.org/github/aymericzip/intlayer-adonisjs-template?file=intlayer.config.ts"
