...
| **`minify`**          | `boolean`                        | `false`                         | Wskazuje, czy należy minimalizować słowniki w celu zmniejszenia rozmiaru pakietu.                                                                                                                                                 |
| **`purge`**           | `boolean`                        | `false`                         | Wskazuje, czy należy usuwać nieużywane klucze w słownikach.                                                                                                                                                                       |
