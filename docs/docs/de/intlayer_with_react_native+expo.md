...
In dieser Architektur stellt `react-native-intlayer` den Root-`IntlayerProvider` und React Native-Hooks bereit, um Übersetzungen über Bildschirme und Komponenten hinweg zu verwalten. Inhaltsdeklarationen befinden sich neben ihren Komponenten.
