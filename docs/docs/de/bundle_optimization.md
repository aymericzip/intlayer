...
| **`minify`**          | `boolean`                        | `false`                         | Gibt an, ob die Wörterbücher minifiziert werden sollen, um die Bündelgröße zu reduzieren.                                                                                                                                       |
| **`purge`**           | `boolean`                        | `false`                         | Gibt an, ob nicht verwendete Schlüssel in den Wörterbüchern bereinigt werden sollen.                                                                                                                                            |
