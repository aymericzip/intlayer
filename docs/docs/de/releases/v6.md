...
Siehe weitere Optionen in der CLI-Dokumentation: [CLI-Referenz](https://github.com/aymericzip/intlayer/blob/main/docs/docs/de/cli/index.md) → „Test fehlender Übersetzungen“. Ebenso der [Testing](https://github.com/aymericzip/intlayer/blob/main/docs/docs/de/testing.md)-Leitfaden.
...
Sie können die Konfiguration pro Wörterbuch weiterhin mit dem Feld `autoFill` in Content-Dateien optimieren. Intlayer berücksichtigt zunächst die Pro-Wörterbuch-Konfiguration und greift dann auf die globale Konfiguration zurück. Siehe die vollständige Referenz in [Auto-fill](https://github.com/aymericzip/intlayer/blob/main/docs/docs/de/autoFill.md) und [Content-Dateien-Referenz](https://github.com/aymericzip/intlayer/blob/main/docs/docs/de/dictionary/content_file.md).
...
> MCP server hilft bei der Automatisierung von Projekten mit Intlayer. Testet fehlende Übersetzungen für autogenerierte Code. Es hilft dabei, deine Konfiguration zu verstehen und die Dokumentation von Intlayer in deiner IDE einzubetten.
...
2. Führen Sie Ihre App und den Live-Prozess nebeneinander aus:
...
However, I notice that both the reference English block and the current German block appear to be empty in your message (they only contain "Notes:" and delimiters).

Please provide:

1. The English (en) source content (reference/base)
2. The current German (de) translation that needs to be reviewed
...
## Migrationsnoten von v6 zu v7

Weitere Informationen finden Sie in den [Migrationsnoten von v6 zu v7](https://github.com/aymericzip/intlayer/blob/main/docs/docs/de/releases/v7.md).

---

## Nützliche Links

- [CLI-Referenz](https://github.com/aymericzip/intlayer/blob/main/docs/docs/de/cli/index.md)
