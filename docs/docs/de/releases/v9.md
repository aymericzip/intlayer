...
Ein neues optionales Paket, [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/de/analytics.md), zeigt Ihnen, welche Inhalte Ihren Besuchern tatsächlich angezeigt werden — und schließt damit den Kreis zu **Collections & Variants**, indem es Ihnen ermöglicht, Inhalte per A/B-Test zu testen und Conversions pro Variante zu messen.
...
- [Analytics - Content-Exposure-Tracking & A/B-Tests](https://github.com/aymericzip/intlayer/blob/main/docs/docs/de/analytics.md)
