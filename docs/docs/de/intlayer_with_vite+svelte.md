...
description: Erfahren Sie, wie Sie Ihre mit Vite und Svelte erstellte Website mehrsprachig gestalten können. Folgen Sie der Dokumentation zur Internationalisierung (i18n) und Übersetzung.
keywords:
