...
- Die [`editor`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/de/configuration.md#editor-configuration)-Konfiguration ist in Ihrer Intlayer-Konfigurationsdatei korrekt gesetzt.
