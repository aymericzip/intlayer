...
history:
  - version: 8.13.0
    date: 2026-06-12
    changes: "Veröffentlichung der Funktion für Sammlungswörterbücher"
author: aymericzip
---
...
### Einzelnes Element mit explizitem Locale

```tsx
const faq2De = useIntlayer("faq", { item: 2, locale: "de" });
```
