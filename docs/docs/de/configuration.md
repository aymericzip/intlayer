...
const config: IntlayerConfig = {
  ...
  routing: {
    ...
    /**
     * Aktiviert den Intlayer-Proxy für Locale-Routing (Middleware).
     * Übernimmt Locale-Erkennung, Weiterleitungen und Rewrites in Dev, Preview und SSR.
     * - nicht gesetzt (auto): Dev- und Preview-Server halten das Routing URL-gesteuert
     *   und ignorieren die in Cookies und Headern gespeicherte Locale. Präfixe werden
     *   weiterhin aufgelöst, die Locale wird weiterhin persistiert und die
     *   Accept-Language-Erkennung greift weiterhin. In Produktion wie `true`.
     * - true: volles Verhalten in jeder Umgebung.
     * - false: kein Locale-Routing.
     * Standard: undefined (auto)
     */
  ...
  ai: {
     ...
     * Optionen: 'openai', 'anthropic', 'mistral', 'deepseek', 'gemini', 'ollama', 'openrouter', 'alibaba', 'fireworks', 'groq', 'huggingface', 'bedrock', 'googlevertex', 'togetherai', 'lmstudio', 'moonshotai'
     * Standard: 'openai'
     */
    provider: "openai",
...
| `enableProxy` | Aktiviert den Intlayer-Proxy für Locale-Routing (Middleware).                                                                                                                                                | `boolean` &#124; <br/> `undefined`                                                                                                                                                                           | `undefined` (auto)     | `true`                                                                                                                                                                                            | • Nicht gesetzt (auto): Dev- und Preview-Server ignorieren die in Cookies/Headern gespeicherte Locale als Weiterleitungsquelle; Präfixe, Persistenz und `Accept-Language`-Erkennung greifen weiterhin. In Produktion wie `true`.<br/>• `true`: volles Verhalten überall.<br/>• `false`: kein Locale-Routing. Bei Next.js wird die `intlayerProxy`-Middleware zum Durchreicher. |
...
Diese Dictionary-Konfiguration dient zwei Hauptzwecken:

1. **Standardwerte**: Definieren Sie Standardwerte beim Erstellen von Content-Deklarationsdateien
2. **Fallback-Verhalten**: Stellen Sie Fallback-Werte bereit, wenn bestimmte Felder nicht definiert sind, sodass Sie das Verhalten des Wörterbuchbetriebs global definieren können
...
| Feld                 | Beschreibung                                                                                                                                     | Typ                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Standard    | Beispiel                                                      | Hinweis                                                                                                                                                                                                           |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `provider`           | Der für Intlayer KI-Funktionen zu verwendende Anbieter.                                                                                          | `'openai'` &#124; <br/> `'anthropic'` &#124; <br/> `'mistral'` &#124; <br/> `'deepseek'` &#124; <br/> `'gemini'` &#124; <br/> `'ollama'` &#124; <br/> `'openrouter'` &#124; <br/> `'alibaba'` &#124; <br/> `'fireworks'` &#124; <br/> `'groq'` &#124; <br/> `'huggingface'` &#124; <br/> `'bedrock'` &#124; <br/> `'googleaistudio'` &#124; <br/> `'googlevertex'` &#124; <br/> `'togetherai'` &#124; <br/> `'lmstudio'` &#124; <br/> `'moonshotai'` | `undefined` | `'anthropic'`                                                 | Verschiedene Anbieter erfordern unterschiedliche API-Schlüssel und haben unterschiedliche Preismodelle.                                                                                                           |
...
<Question title="Wo sollte die Datei intlayer.config.ts liegen?">
