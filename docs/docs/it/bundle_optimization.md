...
| **`minify`**          | `boolean`                        | `true`                          | Indica se minificare i dizionari per ridurre la dimensione del bundle.                                                                                                                                                             |
| **`purge`**           | `boolean`                        | `true`                          | Indica se purgare le chiavi non utilizzate nei dizionari.                                                                                                                                                                          |
