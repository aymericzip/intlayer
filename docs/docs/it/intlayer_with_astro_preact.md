...
title: Astro + Preact i18n - Come tradurre un'applicazione Astro + Preact nel 2026
description: Scopri come aggiungere l'internazionalizzazione (i18n) al tuo sito Astro + Preact con Intlayer. Segui questa guida per rendere il tuo sito multilingue.
keywords:
...
### Passaggio 6: Crea un componente Preact Island
