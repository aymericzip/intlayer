...
title: next-intl - Guida completa per tradurre Next.js
...
Puoi configurare argomenti e provider; vedi [Intlayer CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/cli/index.md).
