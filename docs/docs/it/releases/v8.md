...
Per maggiori dettagli, consulta la [Documentazione sui file di contenuto YAML](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/dictionary/content_file.md#yaml-content-file) e la [Documentazione sui file di contenuto Markdown](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/dictionary/markdown.md).
...
const OpeningsComponent: FC<{ count: number }> = ({ count }) => {
  ...
  return (
    <div>
      ...
      {/* In Italian:                                  */}
      {/*  count=0  → "0 offerte"    (other)           */}
      {/*  count=1  → "1 offerta"    (one)             */}
      {/*  count=2  → "2 offerte"    (other)           */}
      {/*  count=21 → "21 offerte"   (other)           */}
...
Per maggiori informazioni, consulta la [Documentazione sulla Pluralizzazione](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/dictionary/plurial.md).
...
```typescript
content.placeholder; // Restituisce IntlayerNode<string>
content.placeholder.value; // Restituisce stringa
content.placeholder.toString(); // Restituisce stringa
content.placeholder.toLowerCase(); // Restituisce stringa
String(content.placeholder); // Restituisce stringa
content.placeholder.toUpperCase(); // Restituisce stringa in maiuscolo
content.placeholder.replace("a", "b"); // Restituisce stringa modificata
```

### Esempio Array

```typescript
content.myArrayOfString             // Restituisce IntlayerNode<Array<string>>
content.myArrayOfString.find(...)   // Restituisce elemento
content.myArrayOfString.join(', ')  // Restituisce stringa unita
```
...
Per maggiori dettagli, consulta la [Documentazione LSP](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/lsp.md).
...
Per i dettagli sulla configurazione, consulta la [Documentazione dell'ambiente Angular](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/intlayer_with_angular_21.md).
