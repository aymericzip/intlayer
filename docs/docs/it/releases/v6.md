...
- Aggiornamenti live con CMS usando `build.importMode = 'fetch'` e `pnpm intlayer live`
...
Consulta più opzioni nella documentazione CLI: [Riferimento CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/cli/index.md) → "Test traduzioni mancanti". Così come la guida [Testing](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/testing.md).
...
Puoi comunque affinare per dizionario utilizzando il campo `autoFill` nei file di contenuto. Intlayer considererà prima la configurazione per dizionario e poi farà un fallback alla configurazione globale. Consulta il riferimento completo in [Auto-fill](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/autoFill.md) e [Riferimento file di contenuto](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/dictionary/content_file.md).
...
Aggiornato il server MCP per supportare le nuove funzionalità.
...
> Il server MCP aiuta nell'automazione dei progetti che utilizzano Intlayer. Verifica le traduzioni mancanti per il codice autogenerato. Aiuta a comprendere la tua configurazione e incorpora la documentazione di Intlayer nel tuo IDE.
...
Consulta le [note sulla migrazione da v6 a v7](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/releases/v7.md) per ulteriori informazioni.

---

## Link utili

- [Riferimento CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/cli/index.md)
