...
Un nuovo pacchetto opzionale, [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/analytics.md), ti mostra quali contenuti vengono effettivamente visualizzati dai tuoi visitatori — chiudendo il cerchio con **Collections & Variants** permettendoti di eseguire test A/B sui contenuti e misurare le conversioni per variante.
...
Disponibile già oggi per React, Next.js e React Native (tramite `react-intlayer`); altri binding per framework (Vue, Svelte, Angular, …) sono pianificati, seguendo lo stesso schema di rilascio di `@intlayer/editor`. Consulta la [documentazione di Analytics](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/analytics.md) per la guida completa.
...
- [Analytics - Tracciamento dell'esposizione dei contenuti e test A/B](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/analytics.md)
