...
title: Angular i18n - Come tradurre un'app Angular nel 2026
...
<iframe
  src="https://ide.intlayer.org/github/aymericzip/intlayer-angular-template?file=intlayer.config.ts"
