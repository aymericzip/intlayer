...
title: Varianti
description: Utilizza il campo dei metadati variant nei file di contenuto di Intlayer per dichiarare alternative di contenuto denominate (test A/B, banner stagionali, testi sotto feature flag) e passare da una all'altra a runtime senza modifiche al codice.
keywords:
  - Varianti
  - Test A/B
  - Feature Flag
...
history:
  - version: 8.13.0
    date: 2026-06-12
    changes: "Rilascio della funzionalità delle varianti di dizionari"
author: aymericzip
---
