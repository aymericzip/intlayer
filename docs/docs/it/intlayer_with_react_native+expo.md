...
githubUrl: https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/intlayer_with_react_native+expo.md
...
// Applichiamo il polyfill di Intlayer per garantire la compatibilità
intlayerPolyfill();
