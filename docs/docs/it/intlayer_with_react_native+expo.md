...
In questa architettura, `react-native-intlayer` fornisce l'`IntlayerProvider` radice e gli hook React Native per gestire le traduzioni tra schermate e componenti. Le dichiarazioni di contenuto risiedono accanto ai rispettivi componenti.
