...
- La configurazione dell'[`editor`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/configuration.md#editor-configuration) è correttamente impostata nel file di configurazione di Intlayer.
  - Campi obbligatori:
