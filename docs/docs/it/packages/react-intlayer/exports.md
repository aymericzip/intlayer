...
| `useLocale`            | Hook lato client per ottenere la lingua corrente, la lingua predefinita, le lingue disponibili e una funzione per aggiornare la lingua.                       | [useLocale](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/packages/react-intlayer/useLocale.md)         |
...
| `usePathname`          | Hook che restituisce il percorso corrente (pathname) con il segmento della lingua rimosso. Reattivo alla navigazione del browser tramite `popstate`.          | [usePathname](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/packages/react-intlayer/usePathname.md)     |
| `useRewriteURL`        | Hook lato client per gestire le riscritture degli URL. Se esiste una regola di riscrittura per il percorso (pathname) e la lingua correnti, aggiornerà l'URL. | [useRewriteURL](https://github.com/aymericzip/intlayer/blob/main/docs/docs/it/packages/react-intlayer/useRewriteURL.md) |
