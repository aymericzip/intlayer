...
title: Next.js Page Router i18n - Hướng dẫn đầy đủ để dịch Next.js
description: Giải pháp tốt nhất cho kích thước bundle, SEO, hiệu suất & khả năng bảo trì. Làm cho Next.js Page Router trang web của bạn đa ngôn ngữ vào năm 2026, dịch thuật LLM, Agent Skills & MCP.
keywords:
  - Quốc tế hóa
  - Tài liệu
  - Intlayer
...
<Step number={3} title="Tích hợp Intlayer với cấu hình Next.js">
...
<Step number={5} title="Định nghĩa các Route Địa phương Động">
...
<Step number={10} title="Tạo một Thành phần Link Đa ngôn ngữ" isOptional={true}>
...
<Step number={11} title="Tối ưu kích thước bundle của bạn" isOptional={true}>
