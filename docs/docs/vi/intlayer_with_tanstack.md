...
title: Tanstack Start i18n - Hướng dẫn đầy đủ để dịch TanStack Start
description: Giải pháp tốt nhất cho kích thước bundle, SEO, hiệu suất & khả năng bảo trì. Làm cho TanStack Start ứng dụng của bạn đa ngôn ngữ vào năm 2026, dịch thuật LLM, Agent Skills & MCP.
keywords:
  - Quốc tế hóa
  - Tài liệu
  - Intlayer
...
<Step number={10} title="Tạo một Thành phần Chuyển đổi Ngôn ngữ">
...
<Step number={14} title="Lấy locale trong server actions của bạn">
