...
| **`minify`**          | `boolean`                        | `false`                         | Có thu nhỏ các từ điển để giảm kích thước bundle hay không.                                                                                                                                                                                |
| **`purge`**           | `boolean`                        | `false`                         | Có xóa các khóa không sử dụng trong từ điển hay không.                                                                                                                                                                                     |
