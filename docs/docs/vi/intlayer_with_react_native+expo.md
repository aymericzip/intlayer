...
<Step number={2} title="Cài đặt các phụ thuộc">
...
<Step number={3} title="Tạo cấu hình Intlayer">
...
<Step number={4} title="Thêm plugin Metro">
...
<Step number={5} title="Thêm Intlayer provider">
...
<Step number={7} title="Sử dụng Intlayer trong các Component của bạn">
...
<Step number={8} title="Thay đổi Ngôn ngữ Ứng dụng" isOptional={true}>
