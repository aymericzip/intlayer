...
Để biết thêm chi tiết, xem [Tài liệu Tệp Nội dung YAML](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/dictionary/content_file.md#yaml-content-file) và [Tài liệu Tệp Nội dung Markdown](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/dictionary/markdown.md).
...
Để biết thêm thông tin, xem [Tài liệu Đa dạng hóa (Pluralization)](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/dictionary/plurial.md).
...
Để biết thêm chi tiết, xem [Tài liệu LSP](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/lsp.md).
...
Để biết chi tiết về cấu hình, xem [Tài liệu Môi trường Angular](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/intlayer_with_angular_21.md).
