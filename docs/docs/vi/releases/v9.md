...
Một gói tùy chọn mới, [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/analytics.md), cho bạn biết nội dung nào thực sự được hiển thị cho khách truy cập — và khép lại vòng lặp với **Collections & Variants** bằng cách cho phép bạn thử nghiệm A/B nội dung và đo lường chuyển đổi theo từng biến thể.
...
- [Analytics - Theo dõi mức độ hiển thị nội dung & thử nghiệm A/B](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/analytics.md)
