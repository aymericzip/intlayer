...
Xem thêm các tùy chọn trong tài liệu CLI: [Tham khảo CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/cli/index.md) → "Kiểm tra bản dịch còn thiếu". Cũng như hướng dẫn [Testing](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/testing.md).
...
- [Tham khảo CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/vi/cli/index.md)
