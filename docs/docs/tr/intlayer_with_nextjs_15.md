...
# Intlayer ile Next.js 15 web sitenizi çevirin | Uluslararasılaştırma (i18n)
...
next-intlayer v9.5 sürümünden itibaren, `withIntlayer` content watcher'ı kendisi başlatır, ek bir kuruluma gerek yoktur.
