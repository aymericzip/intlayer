...
- "fetch": Sözlükler, canlı senkronizasyon API'si kullanılarak dinamik olarak getirilir. `useIntlayer` fonksiyonunu `useDictionaryFetch` ile değiştirir.
