...
Bu mimaride, `svelte-intlayer`, Svelte bileşenleri içinde çevirileri yönetmek için reaktif depolar ve yardımcı programlar sağlar. İçerik bildirimleri bileşenlerin yanında `src/` altında bulunur.
