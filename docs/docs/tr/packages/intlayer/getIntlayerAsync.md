...
### TanStack Start route `head` içinde

Locale chunk ihtiyaç duyulduğunda yüklendiği için, `head` `async` hale gelir:
...
### Bir Next.js `generateMetadata` içinde
