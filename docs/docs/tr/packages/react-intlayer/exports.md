...
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| `renderHTML`         | Bileşenlerin dışında HTML oluşturmak için bağımsız yardımcı program.                                                                                     | -                                                                                                      |
| `renderMarkdown`     | Bileşenlerin dışında Markdown oluşturmak için bağımsız yardımcı program.                                                                                 | -                                                                                                      |
