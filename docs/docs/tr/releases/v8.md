...
Daha fazla ayrıntı için [YAML İçerik Dosyaları Dokümantasyonu](https://github.com/aymericzip/intlayer/blob/main/docs/docs/tr/dictionary/content_file.md#yaml-content-file) ve [Markdown İçerik Dosyaları Dokümantasyonu](https://github.com/aymericzip/intlayer/blob/main/docs/docs/tr/dictionary/markdown.md) sayfalarına bakın.
...
Daha fazla bilgi için [Çoğullaştırma Dokümantasyonu](https://github.com/aymericzip/intlayer/blob/main/docs/docs/tr/dictionary/plurial.md) sayfasına bakın.
...
```typescript
content.placeholder; // IntlayerNode<string> döner
content.placeholder.value; // string döner
content.placeholder.toString(); // string döner
content.placeholder.toLowerCase(); // string döner
String(content.placeholder); // string döner
content.placeholder.toUpperCase(); // Büyük harfe dönüştürülmüş string döner
content.placeholder.replace("a", "b"); // Değiştirilmiş string döner
```

### Array Örneği

```typescript
content.myArrayOfString             // IntlayerNode<Array<string>> döner
content.myArrayOfString.find(...)   // Eleman döner
content.myArrayOfString.join(', ')  // Birleştirilmiş string döner
```
...
Daha fazla ayrıntı için [LSP Dokümantasyonu](https://github.com/aymericzip/intlayer/blob/main/docs/docs/tr/lsp.md) sayfasına bakın.
...
const config: IntlayerConfig = {
  ...
  build: {
    ...
    /**
     * Purge the unused keys in dictionaries
     */
    purge: true,
...
Yapılandırma detayları için [Angular Ortam Dokümantasyonu](https://github.com/aymericzip/intlayer/blob/main/docs/docs/tr/intlayer_with_angular_21.md) sayfasına bakın.
