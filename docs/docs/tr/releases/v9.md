...
Yeni bir isteğe bağlı paket olan [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/tr/analytics.md), ziyaretçilerinize gerçekte hangi içeriğin gösterildiğini bildirir — ve içerik üzerinde A/B testi yapmanıza ve varyant başına dönüşümleri ölçmenize olanak tanıyarak **Collections & Variants** döngüsünü tamamlar.
...
- [Analytics - İçerik gösterim takibi ve A/B testi](https://github.com/aymericzip/intlayer/blob/main/docs/docs/tr/analytics.md)
