...
title: Astro + React i18n - 2026'da Astro + React uygulaması nasıl çevrilir?
description: Intlayer kullanarak Astro + React sitenize uluslararasılaştırma (i18n) eklemeyi öğrenin. Sitenizi çok dilli hale getirmek için bu kılavuzu izleyin.
keywords:
