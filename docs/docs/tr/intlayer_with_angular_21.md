...
title: Angular i18n - Bir Angular 21 uygulaması (Vite) 2026'da nasıl çevrilir
description: Angular web sitenizi nasıl çok dilli yapacağınızı keşfedin. Onu uluslararasılaştırmak (i18n) ve çevirmek için belgeleri takip edin.
keywords:
...
GitHub'da [Uygulama Şablonunu](https://github.com/aymericzip/intlayer-angular-template) görüntüleyin.
