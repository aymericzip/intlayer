...
Bu mimaride, tüm yerelleştirilmiş rotalar `{-$locale}` rota segmenti altında yer alır. Bu yaklaşım, her dilin özel bir URL'ye sahip olmasını sağlarken otomatik yerel ön eki, doğrulama ve SEO optimizasyonuna olanak tanır.
