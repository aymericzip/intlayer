...
| `contentDir`     | اس ڈائریکٹری کا راستہ جہاں مواد کی تعریف کی فائلیں (`.content.*`) واقع ہیں۔                                        | `string[]` | `['.']`                                                                                                                                                                   | `['src', '../../ui-library', require.resolve("@my-package/content")]`                                                                                                                 | مواد کی فائلوں کو ٹریک کرنے اور لغات کو دوبارہ بنانے کے لیے استعمال ہوتا ہے۔                                                                                |
