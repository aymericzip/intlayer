...
const config: IntlayerConfig = {
  ...
  analytics: {
     ...
     * ایٹریبیوشن کے لیے `editor.clientId` سیٹ ہونا ضروری ہے۔
     * ڈیفالٹ: false
     */
    enabled: true,
...
اینالیٹکس مکمل طور پر اختیاری (opt-in) ہے: جب تک `analytics.enabled` کو واضح طور پر `true` پر سیٹ نہ کیا جائے **اور** ایٹریبیوشن کے لیے پراجیکٹ کی (`editor.clientId`) کنفیگر نہ کی جائے، کچھ بھی اکٹھا نہیں کیا جاتا۔ غیر فعال ہونے کی صورت میں (ڈیفالٹ)، پورا اینالیٹکس انٹیگریشن آپ کے ایپلیکیشن بنڈل سے ہٹا دیا جاتا ہے (ڈیڈ کوڈ ایلیمینیشن)۔

| فیلڈ            | تفصیل                                                                              | قسم       | ڈیفالٹ  | مثال    | نوٹ                                                                                                                        |
| --------------- | ---------------------------------------------------------------------------------- | --------- | ------- | ------- | -------------------------------------------------------------------------------------------------------------------------- |
| `enabled`       | اینالیٹکس ڈیٹا اکٹھا کرنے کو فعال کرتا ہے (پیج ویوز، کنٹینٹ ایکسپوژر، A/B ایونٹس)۔ | `boolean` | `false` | `true`  | ایٹریبیوشن کے لیے `editor.clientId` سیٹ ہونا ضروری ہے؛ ورنہ `enabled` کے `true` ہونے کے باوجود اینالیٹکس غیر فعال رہتا ہے۔ |
