...
| `minify`          | بتاتا ہے کہ آیا بنڈل کے سائز کو کم کرنے کے لیے لغات کو کم (minify) کیا جانا چاہیے۔   | `boolean`                        | `true`                                                                                                                                                                            |                                                                               | • بتاتا ہے کہ آیا بنڈل کو منی فائی کرنا ہے۔<br/>• ڈیفالٹ: پروڈکشن میں `true`۔<br/>• اگر `optimize` غیر فعال ہو تو اسے نظر انداز کر دیا جائے گا۔<br/>• اگر `editor.enabled` کی ویلیو true ہو تو اسے نظر انداز کر دیا جائے گا۔                                                                                         |
