...
| `description`               | `string`                                                                                        | ایڈیٹر اور CMS میں ڈکشنری کا مقصد سمجھنے میں مدد کرتا ہے۔ AI ترجمہ جنریشن کے لیے سیاق و سباق کے طور پر بھی استعمال ہوتا ہے۔ ڈیفالٹ: `undefined`                        | `'User profile section'` |                                                                                                                                                                                                                                                                                                                                       |
| `locale`                    | `LocalesValues`                                                                                 | ڈکشنری کو فی زبان فارمیٹ میں تبدیل کرتا ہے۔ ہر اعلان کردہ فیلڈ ترجمہ نوڈ بن جاتی ہے۔ غیر موجود ہونے پر ڈکشنری کو کثیر لسانی سمجھا جاتا ہے۔ ڈیفالٹ: `undefined`         | `'en'`                   | اس وقت استعمال کریں جب ڈکشنری کسی ایک زبان کے لیے مخصوص ہو بجائے متعدد زبانوں کے ترجمے پر مشتمل ہو۔                                                                                                                                                                                                                                   |
| `contentAutoTransformation` | `boolean &#124; { markdown?: boolean; html?: boolean; insertion?: boolean }`                    | مواد کی سٹرنگز کو خودکار طور پر ٹائپ شدہ نوڈز (markdown، HTML یا insertion) میں تبدیل کرتا ہے۔ ڈیفالٹ: `false`                                                         | `true`                   | Markdown: `### Title` → `md('### Title')`. HTML: `<div>Title</div>` → `html('<div>Title</div>')`. Insertion: `Hello {{name}}` → `insert('Hello {{name}}')`.                                                                                                                                                                           |
| `location`                  | `'local' &#124; 'remote' &#124; 'hybrid' &#124; 'plugin' &#124; string`                         | ڈکشنری فائلوں کے محل وقوع اور CMS مطابقت پذیری موڈ کی نشاندہی کرتا ہے۔ ڈیفالٹ: `'local'`                                                                               | `'hybrid'`               | `'local'`: صرف مقامی طور پر مینیج کیا جاتا ہے۔ `'remote'`: صرف ریموٹ سے مینیج کیا جاتا ہے (CMS)۔ `'hybrid'`: مقامی اور ریموٹ دونوں سے مینیج کیا جاتا ہے۔ `'plugin'` یا کسٹم سٹرنگ: کسی پلگ ان یا کسٹم سورس سے مینیج کیا جاتا ہے۔                                                                                                      |
...
| `priority`                  | `number`                                                                                        | ڈکشنری کی ترجیح۔ ڈکشنریوں کے درمیان تنازعات حل کرتے وقت زیادہ اقدار کم اقدار پر فوقیت رکھتی ہیں۔ ڈیفالٹ: `undefined`                                                   | `1`                      |                                                                                                                                                                                                                                                                                                                                       |
| `live`                      | `boolean`                                                                                       | فرسودہ — اس کی جگہ `importMode: 'fetch'` استعمال کریں۔ یہ ظاہر کرتا تھا کہ آیا ڈکشنری مواد لائیو سنک API کے ذریعے ڈائنامک طور پر حاصل کیا گیا تھا۔ ڈیفالٹ: `undefined` |                          | v8.0.0 میں `importMode: 'fetch'` کے نام سے تبدیل کر دیا گیا۔                                                                                                                                                                                                                                                                          |
| `schema`                    | `'https://intlayer.org/schema.json'`                                                            | JSON اسکیما توثیق کے لیے Intlayer کی جانب سے خودکار طور پر تیار کیا جاتا ہے۔ ڈیفالٹ: خودکار تیار                                                                       |                          | دستی طور پر تبدیل نہ کریں۔                                                                                                                                                                                                                                                                                                            |
| `title`                     | `string`                                                                                        | ایڈیٹر اور CMS میں ڈکشنری کی شناخت میں مدد کرتا ہے۔ ڈیفالٹ: `undefined`                                                                                                | `'User Profile'`         |                                                                                                                                                                                                                                                                                                                                       |
| `tags`                      | `string[]`                                                                                      | ڈکشنریوں کو زمرہ بند کرتا ہے اور ایڈیٹر اور AI کے لیے سیاق و سباق یا ہدایات فراہم کرتا ہے۔ ڈیفالٹ: `undefined`                                                         | `['user', 'profile']`    |                                                                                                                                                                                                                                                                                                                                       |
| `version`                   | `string`                                                                                        | ریموٹ ڈکشنری کا ورژن؛ اس وقت استعمال ہونے والے ورژن کو ٹریک کرنے میں مدد کرتا ہے۔ ڈیفالٹ: `undefined`                                                                  | `'1.0.0'`                | CMS پر قابل انتظام ہے۔ مقامی طور پر تبدیل نہ کریں۔                                                                                                                                                                                                                                                                                    |
