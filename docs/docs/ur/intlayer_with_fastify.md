...
title: "Fastify i18n - اپنی ایپ کو ترجمہ کرنے کا مکمل گائیڈ"
description: "اب i18next کی ضرورت نہیں۔ 2026 میں Fastify ایپ کو کثیر لسانی (i18n) بنانے کا گائیڈ۔ AI ایجنٹس سے ترجمہ کریں اور بنڈل سائز، SEO اور پرفارمنس بہتر بنائیں۔"
keywords:
  - بین الاقوامی کاری
  - دستاویزات
  - Intlayer
...
> آپ کے مواد کے اعلانات ایپلی کیشن میں کہیں بھی بیان کیے جا سکتے ہیں جب تک کہ وہ `contentDir` ڈائریکٹری (بطور ڈیفالٹ `./src`) میں شامل ہوں۔ اور وہ مواد کے اعلان کی فائل کی توسیع (بطور ڈیفالٹ `.content.{json,ts,tsx,js,jsx,mjs,cjs,md,mdx,yaml,yml}`) سے مطابقت رکھنے چاہئیں۔
