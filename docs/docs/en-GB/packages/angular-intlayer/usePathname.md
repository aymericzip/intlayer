...
description: See how to use the usePathname hook for the angular-intlayer package
keywords:
  - usePathname
  - pathname
  - locale
...
- [`useLocale`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/packages/angular-intlayer/exports.md) — current locale + locale switcher
