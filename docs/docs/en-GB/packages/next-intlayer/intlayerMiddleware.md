...
description: See how to use the intlayerMiddleware function for the next-intlayer package
keywords:
  - intlayerMiddleware
  - nextjs
  - middleware
...
history:
  - version: 8.0.0
    date: 2026-01-21
    changes: Initialised doc
---

# intlayerMiddleware Documentation

The `intlayerMiddleware` function is a Next.js middleware that handles locale-based routing and redirects. It automatically detects the user's preferred locale and redirects them to the appropriate localised path if necessary.
