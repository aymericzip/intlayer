...
| `usePathname`   | Hook that returns the current pathname with the locale segment removed. Reactive to browser navigation via `popstate`. | [usePathname](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/packages/preact-intlayer/usePathname.md) |
