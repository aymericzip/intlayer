...
description: See how to use the usePathname hook for the preact-intlayer package
keywords:
  - usePathname
  - pathname
  - locale
...
- [`useLocale`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/packages/preact-intlayer/exports.md) — current locale + locale switcher
