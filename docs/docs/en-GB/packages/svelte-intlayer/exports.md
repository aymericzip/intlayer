...
| `usePathname`          | Returns the current pathname as a `Readable<string>` store with the locale segment removed. Reactive to `popstate`. | [usePathname](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/packages/svelte-intlayer/usePathname.md)     |
