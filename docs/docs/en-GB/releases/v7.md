...
v7 introduces a new dedicated `dictionary` configuration section that provides better organisation for dictionary-related settings and improved content management.
...
- **Clearer organisation**: Dictionary-specific settings are now grouped together
...
- **`fill`**: Auto-fill behaviour for content generation
...
- **`tags`**: Default tags for content organisation
