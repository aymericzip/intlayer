...
For more details, see the [YAML Content Files Documentation](https://intlayer.org/doc/concept/content#yaml-content-file) and [Markdown Content Files Documentation](https://intlayer.org/doc/concept/content/markdown).
...
For more information, see the [Pluralization Documentation](https://intlayer.org/doc/concept/content/plural).
...
For more details, see the [LSP Documentation](https://intlayer.org/doc/lsp).
...
For details on configuration, see the [Angular Environment Documentation](https://intlayer.org/doc/environment/angular).
