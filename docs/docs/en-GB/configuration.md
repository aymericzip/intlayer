...
| `location`                  | `'local' &#124; 'remote' &#124; 'hybrid' &#124; 'plugin' &#124; string`                         | Indicates where dictionary files are stored and their CMS synchronisation mode. Default: `'local'`                                                                             | `'hybrid'`               | `'local'`: managed locally only. `'remote'`: managed remotely only (CMS). `'hybrid'`: managed both locally and remotely. `'plugin'` or custom string: managed by a plugin or custom source.                                                                                                                                                                       |
...
| `tags`                      | `string[]`                                                                                      | Categorises dictionaries and provides context or instructions for the editor and AI. Default: `undefined`                                                                      | `['user', 'profile']`    |                                                                                                                                                                                                                                                                                                                                                                   |
