...
| `minify`          | Defines if the dictionaries should be minified to reduce the bundle size. | `boolean`                        | `true`                                                                                                                                                                            |                                                                               | • Defines if the bundle should be minified.<br/>• Default: `true` in production.<br/>• This option will be ignored if `optimize` is disabled.<br/>• This option will be ignored if `editor.enabled` is true.                                                                                                                                                              |
