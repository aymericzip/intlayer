...
description: "No more i18next. The 2026 guide to building a multilingual (i18n) Angular 19 app. Translate with AI agents and optimise bundle size, SEO and performances."
keywords:
...
# Translate your Angular 19 (Webpack) website using Intlayer | Internationalisation (i18n)
...
This guide covers Angular 19. For Angular 21 and later, follow the [Angular guide](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/intlayer_with_angular_21.md). See [why Intlayer](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/interest_of_intlayer.md).
