...
title: Tanstack Start i18n - Complete guide to translate TanStack Start
description: Best solution for bundle size, SEO, performances & maintainability. Make your TanStack Start app multilingual in 2026, LLM translation, Agent Skills & MCP.
keywords:
...
### Step 9: Utilize Intlayer in Your Pages
...
import { LocalisedLink } from "@/components/localized-link";
  ...
  return (
    <div>
      <div>
        ...
        <LocaleSwitcher />
        <div>
          <LocalisedLink to="/">{content.links.home}</LocalisedLink>
          <LocalisedLink to="/about">{content.links.about}</LocalisedLink>
        </div>
        <div>
