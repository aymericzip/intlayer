...
title: Astro + Svelte i18n - How to translate an Astro + Svelte application in 2026
description: Learn how to add internationalisation (i18n) to your Astro + Svelte site with Intlayer. Follow this guide to make your site multilingual.
keywords:
