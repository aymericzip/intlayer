...
{
  key: "about-page",
  location: "local", // Content stays in your codebase only
  content: {
    title: "About Us"
  }
}
...
export default {
  ...
  content: {
    hero: {
      ...
      subtitle: t({
        "en-GB": "Build amazing applications with ease",
    ...
    features: [
      {
        ...
        description: t({
          "en-GB": "Intuitive interface for all skill levels",
