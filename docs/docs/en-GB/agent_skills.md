...
2.  Ask which platforms you want to install skills for (Cursor, VS Code, OpenCode, Claude Code, etc.).
...
OpenCode is an interactive CLI agent designed for software engineering tasks. Intlayer provides specific skills to help OpenCode assist you with internationalisation tasks.
