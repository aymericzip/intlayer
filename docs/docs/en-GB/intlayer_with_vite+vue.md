...
githubUrl: https://github.com/aymericzip/intlayer/blob/main/docs/docs/en-GB/intlayer_with_vite+vue.md
...
// Configuration object for Intlayer internationalisation
const config = {
  internationalization: {
    locales: [
      Locales.ENGLISH,
