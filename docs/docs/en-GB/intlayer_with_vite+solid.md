...
title: Vite + Solid i18n - Complete guide to translate Solid
description: Best solution for bundle size, SEO, performances & maintainability. Make your Vite and Solid app multilingual in 2026, LLM translation, Agent Skills & MCP.
keywords:
...
> For more details, refer to the [content declaration documentation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/{{locale}}/dictionary/content_file.md).
