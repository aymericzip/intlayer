...
- **ICU MessageFormat:** Intlayer uses the `resolveMessage(..., 'icu')` resolver which fully supports the ICU pluralisation, selection, date/number formatting, and rich text tags natively.
