...
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/vscode_extension.png?raw=true)                    | **VSCode 확장 기능**<br><br>Intlayer는 콘텐츠와 번역 관리를 돕기 위해 VSCode 확장 기능을 제공합니다. 사전 구축, 콘텐츠 번역 등 다양한 기능을 지원합니다. <br><br> - [VSCode 확장 기능](https://intlayer.org/doc/vs-code-extension)                                                                                                                                            |
...
오늘 바로 Intlayer와 함께 여정을 시작하고 더 원활하고 강력한 국제화 방식을 경험해 보세요.  
