...
새로운 선택적 패키지 [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ko/analytics.md)는 방문자에게 실제로 어떤 콘텐츠가 표시되는지 알려주며, **Collections & Variants**의 마지막 퍼즐을 완성하여 콘텐츠 A/B 테스트와 변형별 전환 측정을 가능하게 합니다.
...
현재 React, Next.js, React Native(`react-intlayer` 경유)에서 사용할 수 있습니다. 다른 프레임워크 바인딩(Vue, Svelte, Angular 등)은 `@intlayer/editor`와 동일한 배포 방식으로 계획되어 있습니다. 전체 가이드는 [Analytics 문서](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ko/analytics.md)를 참조하세요.
...
- [Analytics - 콘텐츠 노출 추적 및 A/B 테스트](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ko/analytics.md)
