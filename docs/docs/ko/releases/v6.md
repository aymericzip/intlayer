...
CLI 문서에서 더 많은 옵션을 확인하세요: [CLI 참조](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ko/cli/index.md) → "누락된 번역 테스트". 또한 [테스팅](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ko/testing.md) 가이드를 참고하세요.
...
이러한 제한은 Turbopack이 콘텐츠 파일의 변경 사항을 모니터링하기 위해 웹팩 플러그인을 병렬로 실행할 수 없기 때문입니다.

이를 해결하기 위해 개발 서버와 Intlayer 빌드 감시기를 동시에 실행하기 위해 `--with` 옵션을 사용하여 `intlayer watch` 명령을 제공합니다.
...
자세한 내용은 [v6에서 v7로의 마이그레이션 노트](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ko/releases/v7.md)를 확인하세요.

---

## 유용한 링크

- [CLI 참조](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ko/cli/index.md)
