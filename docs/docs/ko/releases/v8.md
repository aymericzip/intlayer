...
자세한 내용은 [YAML 콘텐츠 파일 문서](https://intlayer.org/doc/concept/content#yaml-content-file) 및 [Markdown 콘텐츠 파일 문서](https://intlayer.org/doc/concept/content/markdown)를 참조하세요.
...
자세한 내용은 [복수형 문서](https://intlayer.org/doc/concept/content/plural)를 참조하세요.
...
자세한 내용은 [LSP 문서](https://intlayer.org/doc/lsp)를 참조하세요.
...
구성에 대한 자세한 내용은 [Angular 환경 문서](https://intlayer.org/doc/environment/angular)를 참조하세요.
