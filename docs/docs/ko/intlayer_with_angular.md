...
title: Angular i18n - Angular 앱 번역 방법 – 가이드 2026
...
> 콘텐츠 선언은 애플리케이션 내 어디서든 `contentDir` 디렉토리(기본값: `./src`)에 포함되기만 하면 정의할 수 있습니다. 또한 콘텐츠 선언 파일 확장자(기본값: `.content.{json,ts,tsx,js,jsx,mjs,cjs}`)와 일치해야 합니다.
