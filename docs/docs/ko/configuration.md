...
| `description`               | `string`                                                                                        | 편집기 및 CMS에서 딕셔너리의 목적을 이해하는 데 도움이 됩니다. AI 번역 생성의 컨텍스트로도 사용됩니다. 기본값: `undefined`                                              | `'User profile section'` |                                                                                                                                                                                                                                                                                                                    |
| `locale`                    | `LocalesValues`                                                                                 | 딕셔너리를 로케일별 형식으로 변환합니다. 선언된 각 필드가 번역 노드가 됩니다. 없으면 딕셔너리는 다국어로 처리됩니다. 기본값: `undefined`                                | `'en'`                   | 딕셔너리가 여러 로케일의 번역을 포함하는 것이 아닌 단일 로케일에 특화된 경우 사용합니다.                                                                                                                                                                                                                           |
| `contentAutoTransformation` | `boolean &#124; { markdown?: boolean; html?: boolean; insertion?: boolean }`                    | 콘텐츠 문자열을 타입 지정 노드(markdown, HTML 또는 삽입)로 자동 변환합니다. 기본값: `false`                                                                             | `true`                   | Markdown: `### Title` → `md('### Title')`. HTML: `<div>Title</div>` → `html('<div>Title</div>')`. Insertion: `Hello {{name}}` → `insert('Hello {{name}}')`.                                                                                                                                                        |
| `location`                  | `'local' &#124; 'remote' &#124; 'hybrid' &#124; 'plugin' &#124; string`                         | 딕셔너리 파일이 저장되는 위치와 CMS 동기화 모드를 나타냅니다. 기본값: `'local'`                                                                                         | `'hybrid'`               | `'local'`: 로컬에서만 관리. `'remote'`: 원격에서만 관리(CMS). `'hybrid'`: 로컬과 원격 모두 관리. `'plugin'` 또는 사용자 정의 문자열: 플러그인 또는 사용자 정의 소스로 관리.                                                                                                                                        |
...
| `priority`                  | `number`                                                                                        | 딕셔너리의 우선순위. 딕셔너리 간 충돌을 해결할 때 값이 높을수록 우선합니다. 기본값: `undefined`                                                                         | `1`                      |                                                                                                                                                                                                                                                                                                                    |
| `live`                      | `boolean`                                                                                       | 더 이상 사용 안 함 — 대신 `importMode: 'fetch'`를 사용하세요. 딕셔너리 콘텐츠가 라이브 동기화 API를 통해 동적으로 가져와졌는지 여부를 나타냈습니다. 기본값: `undefined` |                          | v8.0.0에서 `importMode: 'fetch'`로 이름이 변경되었습니다.                                                                                                                                                                                                                                                          |
| `schema`                    | `'https://intlayer.org/schema.json'`                                                            | JSON 스키마 유효성 검사를 위해 Intlayer가 자동으로 생성합니다. 기본값: 자동 생성                                                                                        |                          | 수동으로 수정하지 마세요.                                                                                                                                                                                                                                                                                          |
| `title`                     | `string`                                                                                        | 편집기 및 CMS에서 딕셔너리를 식별하는 데 도움이 됩니다. 기본값: `undefined`                                                                                             | `'User Profile'`         |                                                                                                                                                                                                                                                                                                                    |
| `tags`                      | `string[]`                                                                                      | 딕셔너리를 분류하고 편집기 및 AI에 컨텍스트나 지침을 제공합니다. 기본값: `undefined`                                                                                    | `['user', 'profile']`    |                                                                                                                                                                                                                                                                                                                    |
| `version`                   | `string`                                                                                        | 원격 딕셔너리의 버전. 현재 사용 중인 버전을 추적하는 데 도움이 됩니다. 기본값: `undefined`                                                                              | `'1.0.0'`                | CMS에서 관리할 수 있습니다. 로컬에서는 수정하지 마세요.                                                                                                                                                                                                                                                            |
