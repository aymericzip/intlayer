...
You should also add SEO metadata like hreflang and canonical links to each page. The Lit custom element is then imported via a client-side `<script>` and placed in the body.
...
// Content of the 'lit-demo' dictionary for that locale
...
<Step number={6} title="Create the Lit custom element">
