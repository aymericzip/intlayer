...
const config: IntlayerConfig = {
  ...
  routing: {
     ...
     * development, preview and production SSR. On Next.js, the `intlayerProxy`
     * middleware becomes a pass-through when disabled.
     * Default: true
     */
    enableProxy: true,
...
| `enableProxy` | Enables the Intlayer locale-routing proxy (middleware).                                                                                                                      | `boolean`                                                                                                                                                                                                    | `true`                 | `false`                                                                                                                                                                                     | When enabled, the build-tool integration (e.g. the `intlayer()` Vite plugin) automatically wires the locale detection / redirect / rewrite middleware in development, preview and production SSR. On Next.js, the `intlayerProxy` middleware becomes a pass-through when disabled. Set to `false` to handle locale routing yourself. |
