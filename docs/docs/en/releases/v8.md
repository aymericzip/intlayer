...
This behavior is enabled by default. If you want to disable it, you can set `contentAutoTransformation` to `false` in your dictionary or global configuration.
...
This enhancement provides more flexibility when building dynamic content with rich formatting or interactive elements.
