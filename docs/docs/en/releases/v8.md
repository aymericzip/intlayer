...
For more details, see the [YAML Content Files Documentation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/content_file.md#yaml-content-file) and [Markdown Content Files Documentation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/markdown.md).
...
For more information, see the [Pluralization Documentation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/plurial.md).
...
The `IntlayerNode` type has been updated to allow calling primitive JavaScript methods directly on content nodes. This makes it possible to interact with your localized content directly as if it were a standard string, number, boolean, or array primitive.
...
For more details, see the [LSP Documentation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/lsp.md).
...
Intlayer v8.7.0 introduces new experimental build features in your `intlayer.config.ts` designed to optimize your production bundle:
...
For details on configuration, see the [Angular Environment Documentation](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_angular_21.md).

## Sitemap Generation (v8.6.0)

Intlayer now generates sitemaps automatically based on your locales and routing mode. This is particularly useful for SEO optimization in router architectures like TanStack Router:
