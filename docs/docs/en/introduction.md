...
<TechGrid>
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/content_file" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/translation" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/enumeration" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/condition" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/insertion" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/function_fetching" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/markdown" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/file" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/nesting" />
</TechGrid>
...
<TechGrid>
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nextjs_16" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nextjs_15" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nextjs_14" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nextjs_page_router" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_tanstack" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_tanstack+solid" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_vite+react" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_react_router_v7" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_remix_3" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_create_react_app" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_react_native+expo" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_lynx+react" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_astro" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_astro_react" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_astro_vue" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_astro_svelte" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_astro_solid" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_astro_preact" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_astro_lit" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_vite+vue" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nuxt" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_vite+svelte" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_svelte_kit" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_vite+solid" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_solid_start" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_vite+preact" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_angular_21" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_angular_19" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_analog" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_vite+lit" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_vite+vanilla" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_vanilla" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_htmx" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_express" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nestjs" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_fastify" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_hono" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_adonisjs" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_elysia" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_storybook" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_next-intl" />
  <TechLink href="https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_next-i18next" />
</TechGrid>
