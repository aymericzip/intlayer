...
description: Learn how to deploy a Next.js 16 application integrated with Intlayer to Cloudflare Workers using the OpenNext adapter.
keywords:
  - Intlayer
  - Next.js 16
  - Cloudflare
...
This guide provides instructions on how to deploy a Next.js 16 application integrated with Intlayer to Cloudflare Workers using the [OpenNext](https://open-next.js.org/cloudflare) adapter.
