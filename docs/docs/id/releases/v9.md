...
Paket opsional baru, [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/id/analytics.md), memberi tahu Anda konten apa yang benar-benar ditampilkan kepada pengunjung Anda — dan melengkapi **Collections & Variants** dengan memungkinkan Anda melakukan pengujian A/B pada konten serta mengukur konversi per varian.
...
Sudah tersedia hari ini untuk React, Next.js, dan React Native (melalui `react-intlayer`); binding framework lain (Vue, Svelte, Angular, …) direncanakan, mengikuti pola rilis yang sama seperti `@intlayer/editor`. Lihat [dokumentasi Analytics](https://github.com/aymericzip/intlayer/blob/main/docs/docs/id/analytics.md) untuk panduan lengkap.
...
- [Analytics - Pelacakan eksposur konten & pengujian A/B](https://github.com/aymericzip/intlayer/blob/main/docs/docs/id/analytics.md)
