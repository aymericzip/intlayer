...
- **API Konten Kaya Terpadu**: Metode `.use()` yang baru sekarang digunakan untuk penggantian Markdown dan HTML, menyediakan API yang konsisten di semua jenis konten kaya.
