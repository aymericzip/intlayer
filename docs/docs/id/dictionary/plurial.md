...
| ------------------------------------------------------------------------- | -------- |
| Bentuk jamak tata bahasa yang peka terhadap locale (satu apel / dua apel) | `plural` |
| Rentang angka kustom (`<5`, `>=10`) atau kategori non-CLDR                | `enu`    |

Jika Anda hanya menargetkan bahasa Inggris (yang hanya memiliki `one` / `other`), keduanya berfungsi. Untuk bahasa apa pun dengan perbedaan `few` / `many` / `two`, lebih disukai `plural`.
...
Untuk menggunakan konten plural di Next.js Client Components, ambil melalui hook `useIntlayer` dan panggil dengan count. Berikut adalah contohnya:
...
Untuk menggunakan konten plural di komponen Vue, ambil konten tersebut melalui hook `useIntlayer` dan panggilnya dengan count. Berikut ini adalah contohnya:
...
Untuk menggunakan konten plural dalam komponen Svelte, ambil melalui hook `useIntlayer` dan panggilnya dengan jumlah. Store diakses dengan `$`. Berikut adalah contohnya:
...
Untuk menggunakan konten plural dalam komponen Preact, ambil melalui hook `useIntlayer` dan panggilnya dengan hitungan. Berikut contohnya:
...
Untuk menggunakan konten plural dalam komponen SolidJS, ambil melalui hook `useIntlayer` dan panggilnya dengan jumlah. Berikut adalah contohnya:
...
Untuk menggunakan konten plural dalam komponen Angular, ambil konten tersebut melalui hook `useIntlayer` dan panggilnya dengan hitungan. Berikut adalah contohnya:
