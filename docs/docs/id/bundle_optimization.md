...
| **`minify`**          | `boolean`                        | `false`                         | Apakah akan mengecilkan kamus untuk mengurangi ukuran bundle.                                                                                                                                                      |
| **`purge`**           | `boolean`                        | `false`                         | Apakah akan membersihkan kunci yang tidak digunakan dalam kamus.                                                                                                                                                   |
