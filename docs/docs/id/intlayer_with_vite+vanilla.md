...
Dalam arsitektur ini, `vanilla-intlayer` atau inti `intlayer` menyediakan API JavaScript untuk mengelola terjemahan dan memperbarui konten DOM secara dinamis. Deklarasi konten berada di `src/`.
