...
history:
  - version: 8.9.0
    date: 2026-05-04
    changes: "Perbarui penggunaan API Solid useIntlayer untuk akses properti langsung"
  - version: 8.0.0
    date: 2026-01-26
...
- **intlayer**
  ...
  Paket inti yang menyediakan alat internasionalisasi untuk manajemen konfigurasi, terjemahan, [deklarasi konten](https://github.com/aymericzip/intlayer/blob/main/docs/docs/id/dictionary/content_file.md), kompilasi silang, dan [perintah CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/id/cli/index.md).

- **angular-intlayer**
  Paket yang mengintegrasikan Intlayer dengan aplikasi Angular. Ini menyediakan context providers dan hooks untuk internasionalisasi Angular.

- **@angular-builders/custom-esbuild**
  Diperlukan untuk menyesuaikan konfigurasi esbuild dari Angular CLI.
...
Dalam arsitektur ini, `angular-intlayer` menyediakan `provideIntlayer()`, yang didaftarkan di `src/app/app.config.ts` sehingga setiap komponen dapat membaca kontennya melalui sinyal `useIntlayer`. Angular CLI dialihkan ke custom builder esbuild, dan `esbuild.plugins.ts` mendaftarkan plugin Intlayer ke dalam build untuk memantau dan membangun kembali deklarasi konten Anda. Deklarasi konten ditempatkan bersama komponen di `src/app/`.
...
> Untuk detail lebih lanjut, rujuk ke [dokumentasi deklarasi konten](https://github.com/aymericzip/intlayer/blob/main/docs/docs/id/dictionary/content_file.md).

</Step>
<Step number={5} title="Manfaatkan Intlayer dalam Kode Anda">
...
Untuk detail lebih lanjut tentang cara menggunakan ekstensi ini, rujuk ke [dokumentasi Ekstensi VS Code Intlayer](https://github.com/aymericzip/intlayer/blob/main/docs/docs/id/vs_code_extension.md).
...
<Question title="Apa saja solusi berbeda yang tersedia untuk menginternasionalkan aplikasi Angular?">

- **Bawaan `@angular/localize`**: kompilasi terpisah per bahasa.
- **`ngx-translate`** dan **`Transloco`**: katalog runtime.
- **`Intlayer`**: Standalone components, Signal inputs, dan pipeline build baru berbasis Vite.
