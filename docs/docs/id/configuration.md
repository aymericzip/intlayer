...
const config: IntlayerConfig = {
  ...
  routing: {
    ...
    /**
     * Mengaktifkan proxy perutean locale Intlayer (middleware).
     * Menangani deteksi locale, pengalihan, dan penulisan ulang di dev, preview, dan SSR.
     * - tidak diatur (auto): server dev dan preview menjaga perutean tetap digerakkan URL
     *   dengan mengabaikan locale yang tersimpan di cookie dan header. Prefiks tetap
     *   diselesaikan, locale tetap disimpan, dan deteksi Accept-Language tetap berlaku.
     *   Di produksi berperilaku seperti `true`.
     * - true: perilaku penuh di setiap lingkungan.
     * - false: tanpa perutean locale.
  ...
  ai: {
     ...
     * Opsi: 'openai', 'anthropic', 'mistral', 'deepseek', 'gemini', 'ollama', 'openrouter', 'alibaba', 'fireworks', 'groq', 'huggingface', 'bedrock', 'googlevertex', 'togetherai', 'lmstudio', 'moonshotai'
     * Default: 'openai'
     */
    provider: "openai",
...
| `enableProxy` | Mengaktifkan proxy perutean locale Intlayer (middleware).                                                                                                                                                            | `boolean` &#124; <br/> `undefined`                                                                                                                                                                           | `undefined` (auto)     | `true`                                                                                                                                                                                            | • Tidak diatur (auto): server dev dan preview mengabaikan locale yang tersimpan di cookie/header sebagai sumber pengalihan; prefiks, penyimpanan, dan deteksi `Accept-Language` tetap berlaku. Di produksi berperilaku seperti `true`.<br/>• `true`: perilaku penuh di mana pun.<br/>• `false`: tanpa perutean locale. Di Next.js, middleware `intlayerProxy` menjadi pass-through. |
...
Konfigurasi kamus ini melayani dua tujuan utama:

1. **Nilai Default**: Tentukan nilai default saat membuat file deklarasi konten
2. **Perilaku Fallback**: Berikan nilai fallback ketika field tertentu tidak didefinisikan, memungkinkan Anda menentukan perilaku operasi kamus secara global
...
| Bidang               | Deskripsi                                                                                                                                       | Tipe                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Default     | Contoh                                                        | Catatan                                                                                                                                                                               |
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `provider`           | Penyedia yang akan digunakan untuk fitur AI Intlayer.                                                                                           | `'openai'` &#124; <br/> `'anthropic'` &#124; <br/> `'mistral'` &#124; <br/> `'deepseek'` &#124; <br/> `'gemini'` &#124; <br/> `'ollama'` &#124; <br/> `'openrouter'` &#124; <br/> `'alibaba'` &#124; <br/> `'fireworks'` &#124; <br/> `'groq'` &#124; <br/> `'huggingface'` &#124; <br/> `'bedrock'` &#124; <br/> `'googleaistudio'` &#124; <br/> `'googlevertex'` &#124; <br/> `'togetherai'` &#124; <br/> `'lmstudio'` &#124; <br/> `'moonshotai'` | `undefined` | `'anthropic'`                                                 | Penyedia yang berbeda memerlukan kunci API yang berbeda dan memiliki struktur harga yang berbeda pula.                                                                                |
