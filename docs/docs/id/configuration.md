...
| `contentDir`     | Path direktori tempat file definisi konten berada (`.content.*`).                                              | `string[]` | `['.']`                                                                                                                                                                   | `['src', '../../ui-library', require.resolve("@my-package/content")]`                                                                                                                 | Digunakan untuk melacak file konten dan menghasilkan kembali kamus.                                                                                     |
