...
`Tolgee` menyediakan platform lokalisasi lengkap dengan pengeditan in-context dan integrasi resmi Svelte melalui `@tolgee/svelte`.

Paket ini relatif berat (~13.0kb, sekitar 3.6× `svelte-intlayer`).
