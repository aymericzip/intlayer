...
Dalam arsitektur ini, `solid-intlayer` menyediakan `IntlayerProvider` yang dipasang di `index.tsx` untuk membungkus hierarki Solid. Deklarasi konten berada di `src/` di samping komponen.
