...
title: "Storybook i18n - Повний посібник з перекладу застосунку Storybook"
description: "Більше ніякого i18next. Посібник 2026 зі створення багатомовного (i18n) застосунку Storybook. Перекладайте за допомогою ШІ-агентів та оптимізуйте розмір бандлу, SEO та продуктивність."
keywords:
  - Інтернаціоналізація
  - Документація
  - Intlayer
...
<Step number={2} title="Створення конфігурації Intlayer">
...
<Step number={4} title="Додавання декоратора `IntlayerProvider` та панелі інструментів локалей">
...
<Step number={3} title="Налаштування Webpack для Storybook">
