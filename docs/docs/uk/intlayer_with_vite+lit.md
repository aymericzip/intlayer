...
У цій архітектурі `lit-intlayer` надає інтеграції користувацьких елементів та реактивні контролери для керування перекладами всередині Web Components. Оголошення контенту розміщуються в `src/` поруч із елементами.
...
Докладніше про використання розширення дивіться в [документації до розширення Intlayer для VS Code](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/vs_code_extension.md).
...
Vite не має особливих вимог щодо i18n, тому варіанти відповідають екосистемі Lit:
