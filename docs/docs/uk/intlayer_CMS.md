...
- Налаштування [`editor`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/configuration.md#editor-configuration) правильно встановлені у вашому конфігураційному файлі Intlayer.
  - Обов'язкові поля:
