...
Для отримання додаткової інформації див. [Документацію про файли контенту YAML](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/dictionary/content_file.md#yaml-content-file) та [Документацію про файли контенту Markdown](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/dictionary/markdown.md).
...
Для отримання додаткової інформації див. [Документацію про плюралізацію](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/dictionary/plurial.md).
...
Для отримання додаткової інформації див. [Документацію LSP](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/lsp.md).
...
Детальніше про конфігурацію див. у [Документації середовища Angular](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/intlayer_with_angular_21.md).
