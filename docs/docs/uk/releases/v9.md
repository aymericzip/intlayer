...
- **Compiler**: Активується автоматично, коли встановлено `compiler.enabled` та налаштована шлях `compiler.output`. Вам більше не потрібно реєструвати `intlayerCompiler()` окремо.
