...
Новий необов'язковий пакет [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/analytics.md) показує, який контент насправді бачать ваші відвідувачі — і замикає цикл із **Collections & Variants**, дозволяючи проводити A/B-тестування контенту та вимірювати конверсії по кожному варіанту.
...
- [Analytics - Відстеження показів контенту та A/B-тестування](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/analytics.md)
