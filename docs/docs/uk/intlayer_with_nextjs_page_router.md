...
Pages Router все ще підтримує вбудоване поле `i18n` у `next.config.js`, але воно керує лише маршрутизацією та виявленням локалі, а не самими перекладами, тому ви все одно обираєте рівень контенту:
