...
title: Astro + Preact i18n - Як перекласти додаток Astro + Preact у 2026 році
description: Дізнайтеся, як додати інтернаціоналізацію (i18n) на свій сайт Astro + Preact за допомогою Intlayer. Дотримуйтесь цього посібника, щоб зробити свій сайт багатомовним.
keywords:
  - інтернаціоналізація
  - документація
  - Intlayer
...
- **Використовувати розширені можливості**: Такі як динамічне визначення мови 및 перемикання мов.
...
### Крок 6: Створення компонента Preact Island
