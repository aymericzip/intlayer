...
title: Vite + Preact i18n - Як перекласти додаток Preact у 2026
...
<iframe
  src="https://ide.intlayer.org/github/aymericzip/intlayer-vite-preact-template?file=intlayer.config.ts"
