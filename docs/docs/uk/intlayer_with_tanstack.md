...
У цій архітектурі всі локалізовані маршрути вкладені в сегмент маршруту `{-$locale}`. Цей підхід гарантує, що кожна мова має власну URL-адресу, забезпечуючи автоматичне додавання префікса локалі, валідацію та SEO-оптимізацію.
