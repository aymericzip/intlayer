...
- **Intlayer**: Забезпечує найкращу продуктивність і найменший розмір бандла (v9.5.1) для TanStack Start.
...
- [`@intlayer/lingui`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/compat/lingui.md) (v9.5.1)
