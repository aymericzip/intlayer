...
- **Intlayer**: Найлегше рішення (v9.5.0) з нативним скоупінгом (scoping) та динамічним завантаженням.
...
- `vue-intlayer` (v9.5.0)
- [`@intlayer/vue-i18n`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/compat/vue-i18n.md) (v9.5.1)
- `vue-i18n` (v11.4.0)
- `fluent-vue` (v3.8.2)
