...
description: Порівняйте бібліотеки інтернаціоналізації (i18n) для Vue, такі як vue-i18n, fluent-vue, Tolgee та Intlayer. Детальний звіт про продуктивність щодо розміру бандла, витоків та реактивності.
keywords:
  - benchmark
  - i18n
  - intl
...
history:
  ...
  - version: 9.5.7
    date: 2026-09-23
    changes: "Оновлення результатів бенчмарку та додавання Tolgee"
  - version: 9.5.1
    date: 2026-09-11
    changes: "Оновлення результатів бенчмарку"
  - version: 8.9.8
...
- **Intlayer**: Найлегше рішення (v9.5.10) з нативним скоупінгом (scoping) та динамічним завантаженням.
- **Tolgee**: Ефективне динамічне завантаження з нульовим витоком у динамічному режимі, але важче рішення (~3.0× Intlayer) без вбудованої типізації під час компіляції.
...
- [`vue-intlayer`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/packages/vue-intlayer/exports.md) (v9.5.10)
- [`@intlayer/vue-i18n`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/compat/vue-i18n.md) (v9.5.10)
...
`Tolgee` вирішує багато зі згаданих проблем, пропонуючи динамічне завантаження, яке успішно усуває витоки мовних версій та сторінок (зменшуючи JS сторінки приблизно до 58.8 КБ). Проте він не забезпечує вбудованої типізації для ключів під час компіляції, що ускладнює виявлення відсутніх ключів. Крім того, розмір бібліотеки є відносно важким (~13.8 КБ, що приблизно в 3.7 рази більше за `vue-intlayer`).
