...
- Розбиває великі JSON файли на частини, щоб залишатися в межах контекстного вікна AI моделі.
- Повторює переклад, якщо формат результату невірний.
- Incorporates application and file-specific context for improved translation accuracy.
- Зберігає існуючі переклади, не перезаписуючи їх.
- Обробляє файли, частини та локалі паралельно, використовуючи систему черг для прискорення.
