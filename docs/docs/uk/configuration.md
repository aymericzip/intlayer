...
| `description`               | `string`                                                                                        | Допомагає зрозуміти призначення словника в редакторі та CMS. Також використовується як контекст для генерації перекладів через AI. За замовчуванням: `undefined`             | `'User profile section'` |                                                                                                                                                                                                                                                                                                                                                                    |
| `locale`                    | `LocalesValues`                                                                                 | Перетворює словник у формат для окремої мови. Кожне оголошене поле стає вузлом перекладу. Якщо відсутнє, словник обробляється як багатомовний. За замовчуванням: `undefined` | `'en'`                   | Використовуйте це, коли словник є специфічним для однієї мови, а не містить переклади для кількох мов.                                                                                                                                                                                                                                                             |
| `contentAutoTransformation` | `boolean &#124; { markdown?: boolean; html?: boolean; insertion?: boolean }`                    | Автоматично перетворює рядки контенту на типізовані вузли (markdown, HTML або вставка). За замовчуванням: `false`                                                            | `true`                   | Markdown: `### Title` → `md('### Title')`. HTML: `<div>Title</div>` → `html('<div>Title</div>')`. Вставка: `Hello {{name}}` → `insert('Hello {{name}}')`.                                                                                                                                                                                                          |
| `location`                  | `'local' &#124; 'remote' &#124; 'hybrid' &#124; 'plugin' &#124; string`                         | Вказує, де зберігаються файли словника та їх режим синхронізації з CMS. За замовчуванням: `'local'`                                                                          | `'hybrid'`               | `'local'`: керується лише локально. `'remote'`: керується лише віддалено (CMS). `'hybrid'`: керується як локально, так і віддалено. `'plugin'` або власний рядок: керується плагіном або власним джерелом.                                                                                                                                                         |
...
| `priority`                  | `number`                                                                                        | Пріоритет словника. Вищі значення мають перевагу над нижчими при вирішенні конфліктів між словниками. За замовчуванням: `undefined`                                          | `1`                      |                                                                                                                                                                                                                                                                                                                                                                    |
| `live`                      | `boolean`                                                                                       | Застаріло — використовуйте натомість `importMode: 'fetch'`. Вказувало, чи контент словника отримувався динамічно через API live sync. За замовчуванням: `undefined`          |                          | Перейменовано на `importMode: 'fetch'` у v8.0.0.                                                                                                                                                                                                                                                                                                                   |
| `schema`                    | `'https://intlayer.org/schema.json'`                                                            | Автоматично генерується Intlayer для валідації JSON-схеми. За замовчуванням: автоматично генерується                                                                         |                          | Не змінювати вручну.                                                                                                                                                                                                                                                                                                                                               |
| `title`                     | `string`                                                                                        | Допомагає ідентифікувати словник у редакторі та CMS. За замовчуванням: `undefined`                                                                                           | `'User Profile'`         |                                                                                                                                                                                                                                                                                                                                                                    |
| `tags`                      | `string[]`                                                                                      | Категоризує словники та надає контекст або інструкції для редактора та AI. За замовчуванням: `undefined`                                                                     | `['user', 'profile']`    |                                                                                                                                                                                                                                                                                                                                                                    |
| `version`                   | `string`                                                                                        | Версія віддаленого словника; допомагає відстежувати, яка версія використовується. За замовчуванням: `undefined`                                                              | `'1.0.0'`                | Керується в CMS. Не змінювати локально.                                                                                                                                                                                                                                                                                                                            |
