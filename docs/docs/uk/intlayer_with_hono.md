...
- **Базові об'єкти зіставлення**: без типобезпеки та гнучкості.
- **`Intlayer`**: бездоганна робота на Cloudflare Workers, Fastly, Deno, Bun та Node.js, компіляція під час збирання, нульові затримки.
