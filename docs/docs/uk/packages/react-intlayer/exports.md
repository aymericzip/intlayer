...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| `useHTMLRenderer`      | Хук для отримання попередньо налаштованої функції рендерингу HTML.                                                                   | -                                                                                                                       |
| `useMarkdownRenderer`  | Хук для отримання попередньо налаштованої функції рендерингу Markdown.                                                               | -                                                                                                                       |
...
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `renderHTML`         | Автономна утиліта для рендерингу HTML поза компонентами.                                                                                     | -                                                                                                   |
| `renderMarkdown`     | Автономна утиліта для рендерингу Markdown поза компонентами.                                                                                 | -                                                                                                   |
...
| Компонент          | Опис                                                                                                                                          | Пов'язаний документ                                                                                                           |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `HTMLRenderer`     | Рендерить вміст HTML з користувацькими компонентами.                                                                                          | -                                                                                                                             |
