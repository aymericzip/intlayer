...
history:
  - version: 9.5.9
    date: 2026-09-25
    changes: "Застаріння getConfiguration на користь прямих імпортів з intlayer"
  - version: 5.5.10
    date: 2025-06-29
...
> [!TIP]
> **Рекомендований спосіб**: Замість вилучення локалей з `getConfiguration()`, імпортуйте їх безпосередньо з `'intlayer'`:
>
> ```typescript
