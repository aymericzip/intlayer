...
1. **Підвищити швидкість розробки**
   - `.content.{ts|js|mjs|cjs|json|tsx|jsx|md|mdx|yaml|yml}` файли можна створити за допомогою розширення VSCode
...
| Функція                                                                                                                   | Опис                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/frameworks.webp?raw=true)                         | **Підтримка кількох фреймворків**<br><br>Intlayer сумісний з усіма основними фреймворками та бібліотеками, включаючи Next.js, React, Vite, Vue.js, Nuxt, Preact, Express та інші.                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/javascript_content_management.jpg?raw=true)       | **Управління контентом на основі JavaScript**<br><br>Використовуйте гнучкість JavaScript для ефективного визначення та управління вашим контентом. <br><br> - [Декларація контенту](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/dictionary/content_file.md)                                                                                                                                                                                                                                                                                                                                             |
| <img src="https://github.com/aymericzip/intlayer/blob/main/docs/assets/compiler.webp?raw=true" alt="Feature" width="700"> | **Компілятор**<br><br>Компілятор Intlayer автоматично витягує контент з компонентів та генерує файли словника.<br><br> - [Компілятор](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/compiler.md)                                                                                                                                                                                                                                                                                                                                                                                                          |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/per_locale_content_declaration_file.png?raw=true) | **Файл декларації контенту для кожної локалізації**<br><br>Прискорте розробку, оголошуючи ваш контент один раз, перед автоматичною генерацією.<br><br> - [Файл декларації контенту для кожної локалізації](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/per_locale_file.md)                                                                                                                                                                                                                                                                                                                              |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/autocompletion.png?raw=true)                      | **Середовище з безпекою типів**<br><br>Використовуйте TypeScript для забезпечення безпеки від помилок у визначеннях контенту та коду, а також отримуйте автодоповнення IDE.<br><br> - [Конфігурація TypeScript](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/intlayer_with_vite+react.md#configure-typescript)                                                                                                                                                                                                                                                                                           |
...
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/vscode_extension.webp?raw=true)                   | **Розширення VSCode**<br><br>Intlayer надає розширення VSCode для допомоги в управлінні контентом та перекладами, побудові ваших словників, перекладі контенту та багато іншого. <br><br> - [Розширення VSCode](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/vs_code_extension.md)                                                                                                                                                                                                                                                                                                                       |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/interoperability.png?raw=true)                    | **Взаємосумісність**<br><br>Дозволяє взаємосумісність з react-i18next, next-i18next, next-intl та react-intl. <br><br> - [Intlayer та react-intl](https://github.com/aymericzip/intlayer/blob/main/docs/blog/uk/intlayer_with_react-intl.md) <br> - [Intlayer та next-intl](https://github.com/aymericzip/intlayer/blob/main/docs/blog/uk/intlayer_with_next-intl.md) <br> - [Intlayer та next-i18next](https://github.com/aymericzip/intlayer/blob/main/docs/blog/uk/intlayer_with_next-i18next.md) <br> - [Адаптери сумісності Intlayer](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/compat/index.md) |
...
Співіснують три покоління:

- **Бібліотеки каталогів часу виконання (runtime)**: `i18next`, `react-i18next`, `next-i18next`, `vue-i18n`, `ngx-translate`.
- **Бібліотеки повідомлень часу компіляції**: `Lingui`, `Paraglide`, `react-intl` та `next-intl`.
- **Бібліотеки з шаром контенту (Content layer)**: `Intlayer`. Оголошення поруч із компонентом, tree-shaking, типи TypeScript, переклад за допомогою AI та візуальний редактор.
...
`next-intl` - це шар повідомлень для Next.js, заснований на JSON файлах під кожну мову. Intlayer оголошує вміст безпосередньо біля компонента, видаляє невикористані ключі під час збирання, створює суворі типи TypeScript для кожного словника і надає вбудований переклад AI та візуальний редактор.

</Question>
<Question title="Чим Intlayer відрізняється від i18next та react-i18next?">

`i18next` вирішує рядкові ключі під час виконання, що у разі помилки в назві ключа призводить до порожнього тексту на екрані. Intlayer перевіряє ключі статично під час компіляції, виключає непотрібні мови з бандла та автоматизує процес перекладу.

</Question>
<Question title="Чи є Intlayer швидшим або легшим за альтернативи?">

Щодо розміру бандла та сторінки - так: відмова від завантаження непотрібних сторінці каталогів скорочує обсяг бандла до 50%. Щодо швидкодії - попередня компіляція усуває витрати на парсинг у runtime. Див. [бенчмарк](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/benchmark/index.md).

</Question>
<Question title="Чи варто мігрувати наявний додаток?">

Це залежить від поточних проблем. Якщо вам заважає великий розмір бандла, пропущені переклади чи труднощі нетехнічних спеціалістів із редагуванням текстів, Intlayer вирішує ці задачі, а адаптери сумісності дозволяють мігрувати поступово без переписування коду.

</Question>
<Question title="Що пропонує Intlayer, чого немає в інших бібліотеках i18n?">

Підтримку [Markdown вмісту](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/dictionary/markdown.md), завантаження контенту з CMS, інтегрований візуальний редактор, автоматичний переклад через AI з прапорцем `--git-diff` та автодоповнення TypeScript на основі структури компонентів.

</Question>
<Question title="Чи можу я використовувати Intlayer лише як менеджер перекладів і зберегти поточну бібліотеку?">

Так. Intlayer може генерувати простори імен у форматі та шляху, очікуваному вашою поточною бібліотекою (наприклад `/messages/{locale}/{namespace}.json`), що дозволяє використовувати CLI та редактор Intlayer без зміни коду додатку.

</Question>
<Question title="Чи є Intlayer безкоштовним та відкритим кодом?">

Так, під ліцензією Apache 2.0, включно з комерційним використанням. Хмарна CMS - це додаткова послуга, яку також можна [розгорнути на власному сервері](https://github.com/aymericzip/intlayer/blob/main/docs/docs/uk/self_hosting.md).
