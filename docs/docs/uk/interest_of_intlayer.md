...
| <img src="https://github.com/aymericzip/intlayer/blob/main/docs/assets/compiler.webp?raw=true" alt="Feature" width="700"> | **Компілятор**<br><br>Компілятор Intlayer автоматично витягує контент з компонентів та генерує файли словника.<br><br> - [Компілятор](https://intlayer.org/doc/compiler)                                                                                                                                                                                                                                                                                             |
...
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/static_rendering.webp?raw=true)                   | **Статичне рендерування**<br><br>Не блокує статичне рендерування. <br><br> - [Інтеграція Next.js](https://intlayer.org/doc/environment/nextjs)                                                                                                                                                                                                                                                                                                                       |
