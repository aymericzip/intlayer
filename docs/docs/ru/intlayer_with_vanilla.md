...
В этой архитектуре ядро `intlayer` предоставляет API JavaScript для объявления и использования словарей в стандартных средах JavaScript или TypeScript без интерфейсного фреймворка.
