...
history:
  - version: 9.5.9
    date: 2026-09-25
    changes: "Устаревание getConfiguration в пользу прямого импорта из intlayer"
  - version: 5.5.10
    date: 2025-06-29
...
> [!TIP]
> **Рекомендуемый способ**: Вместо извлечения локалей из `getConfiguration()`, импортируйте их напрямую из `'intlayer'`:
>
> ```typescript
