...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| `useHTMLRenderer`      | Хук для получения предварительно настроенной функции рендеринга HTML.                                                                                  | -                                                                                                                       |
| `useMarkdownRenderer`  | Хук для получения предварительно настроенной функции рендеринга Markdown.                                                                              | -                                                                                                                       |
...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------- |
| `renderHTML`         | Автономная утилита для рендеринга HTML вне компонентов.                                                                                                      | -                                                                                                  |
| `renderMarkdown`     | Автономная утилита для рендеринга Markdown вне компонентов.                                                                                                  | -                                                                                                  |
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- |
| `HTMLRenderer`     | Рендерит HTML-контент с использованием пользовательских компонентов.                                                                                         | -                                                                                                                             |
