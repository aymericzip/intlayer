...
title: Astro + Solid i18n - Полное руководство по переводу Astro + Solid
description: Лучшее решение для размера бандла, SEO, производительности & поддерживаемости. Сделайте Astro and Solid сайт многоязычным в 2026, перевод LLM, Agent Skills & MCP.
keywords:
  - Интернационализация
  - Документация
  - Intlayer
...
### Шаг 6: Создание компонента Острова Solid
