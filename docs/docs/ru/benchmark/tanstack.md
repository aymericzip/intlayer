...
- **Intlayer**: Обеспечивает лучшую производительность и наименьший размер бандла (v9.5.1) для TanStack Start.
...
- [`@intlayer/lingui`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ru/compat/lingui.md) (v9.5.1)
