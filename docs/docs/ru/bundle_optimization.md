...
| **`minify`**          | `boolean`                        | `true`                          | Указывает, нужно ли минифицировать словари для уменьшения размера бандла.                                                                                                                              |
| **`purge`**           | `boolean`                        | `true`                          | Указывает, нужно ли удалять неиспользуемые ключи в словарях.                                                                                                                                           |
