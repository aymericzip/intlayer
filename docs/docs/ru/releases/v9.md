...
Новый необязательный пакет [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ru/analytics.md) показывает, какой контент реально видят ваши посетители — и замыкает цикл с **Collections и Variants**, позволяя проводить A/B-тесты контента и измерять конверсии по каждому варианту.
...
Уже доступно для React, Next.js и React Native (через `react-intlayer`); привязки для других фреймворков (Vue, Svelte, Angular, …) планируются по той же схеме внедрения, что и `@intlayer/editor`. Полное руководство см. в [документации Analytics](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ru/analytics.md).
...
- [Аналитика - отслеживание показов контента и A/B-тестирование](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ru/analytics.md)
