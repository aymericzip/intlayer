...
Для получения более подробной информации см. [Документацию по файлам контента YAML](https://intlayer.org/doc/concept/content#yaml-content-file) и [Документацию по файлам контента Markdown](https://intlayer.org/doc/concept/content/markdown).
...
Для получения дополнительной информации см. [Документацию по плюрализации](https://intlayer.org/doc/concept/content/plural).
...
Для получения более подробной информации см. [Документацию по LSP](https://intlayer.org/doc/lsp).
...
Подробности о конфигурации см. в [Документации по окружению Angular](https://intlayer.org/doc/environment/angular).
