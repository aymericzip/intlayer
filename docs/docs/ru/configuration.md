...
githubUrl: https://github.com/aymericzip/intlayer/blob/main/docs/docs/ru/configuration.md
...
const config = {
  ...
  ai: {
    apiKey: process.env.OPENAI_API_KEY,
    applicationContext: "Это тестовое приложение", // комментарий переведён
  },
  build: {
    activateDynamicImport: true,
  },
