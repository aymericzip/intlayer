...
| `description`               | `string`                                                                                        | Помогает понять назначение словаря в редакторе и CMS. Также используется в качестве контекста для генерации AI-переводов. По умолчанию: `undefined`                                         | `'User profile section'` |                                                                                                                                                                                                                                                                                                                                                                                           |
| `locale`                    | `LocalesValues`                                                                                 | Преобразует словарь в формат для конкретной локали. Каждое объявленное поле становится узлом перевода. Если отсутствует, словарь обрабатывается как многоязычный. По умолчанию: `undefined` | `'en'`                   | Используйте это, когда словарь предназначен для одной локали, а не содержит переводы для нескольких локалей.                                                                                                                                                                                                                                                                              |
| `contentAutoTransformation` | `boolean &#124; { markdown?: boolean; html?: boolean; insertion?: boolean }`                    | Автоматически преобразует строки контента в типизированные узлы (markdown, HTML или вставка). По умолчанию: `false`                                                                         | `true`                   | Markdown: `### Title` → `md('### Title')`. HTML: `<div>Title</div>` → `html('<div>Title</div>')`. Вставка: `Hello {{name}}` → `insert('Hello {{name}}')`.                                                                                                                                                                                                                                 |
| `location`                  | `'local' &#124; 'remote' &#124; 'hybrid' &#124; 'plugin' &#124; string`                         | Указывает, где хранятся файлы словарей и их режим синхронизации с CMS. По умолчанию: `'local'`                                                                                              | `'hybrid'`               | `'local'`: управляется только локально. `'remote'`: управляется только удалённо (CMS). `'hybrid'`: управляется как локально, так и удалённо. `'plugin'` или пользовательская строка: управляется плагином или пользовательским источником.                                                                                                                                                |
...
| `priority`                  | `number`                                                                                        | Приоритет словаря. Более высокие значения имеют приоритет над более низкими при разрешении конфликтов между словарями. По умолчанию: `undefined`                                            | `1`                      |                                                                                                                                                                                                                                                                                                                                                                                           |
| `live`                      | `boolean`                                                                                       | Устарело — используйте вместо этого `importMode: 'fetch'`. Указывало, извлекался ли контент словаря динамически через API live sync. По умолчанию: `undefined`                              |                          | Переименовано в `importMode: 'fetch'` в v8.0.0.                                                                                                                                                                                                                                                                                                                                           |
| `schema`                    | `'https://intlayer.org/schema.json'`                                                            | Автоматически генерируется Intlayer для валидации JSON-схемы. По умолчанию: генерируется автоматически                                                                                      |                          | Не изменять вручную.                                                                                                                                                                                                                                                                                                                                                                      |
| `title`                     | `string`                                                                                        | Помогает идентифицировать словарь в редакторе и CMS. По умолчанию: `undefined`                                                                                                              | `'User Profile'`         |                                                                                                                                                                                                                                                                                                                                                                                           |
| `tags`                      | `string[]`                                                                                      | Категоризирует словари и предоставляет контекст или инструкции для редактора и AI. По умолчанию: `undefined`                                                                                | `['user', 'profile']`    |                                                                                                                                                                                                                                                                                                                                                                                           |
| `version`                   | `string`                                                                                        | Версия удалённого словаря; помогает отслеживать используемую версию. По умолчанию: `undefined`                                                                                              | `'1.0.0'`                | Управляется в CMS. Не изменять локально.                                                                                                                                                                                                                                                                                                                                                  |
