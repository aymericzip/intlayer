...
| `minify`          | Минимизировать словари для уменьшения размера бандла.                      | `boolean`                        | `true`                                                                                                                                                                            |                                                                               | • Указывает, должен ли бандл быть минифицирован.<br/>• По умолчанию: `true` в продакшене.<br/>• Эта опция будет проигнорирована, если `optimize` отключена.<br/>• Эта опция будет проигнорирована, если `editor.enabled` имеет значение true.                                                            |
| `purge`           | Удалить неиспользуемые ключи в словарях.                                   | `boolean`                        | `true`                                                                                                                                                                            |                                                                               | • Указывает, должен ли бандл быть очищен.<br/>• По умолчанию: `true` в продакшене.<br/>• Эта опция будет проигнорирована, если `optimize` отключена.                                                                                                                                                     |
