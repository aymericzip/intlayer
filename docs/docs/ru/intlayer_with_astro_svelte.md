...
title: Astro + Svelte i18n - Полное руководство по переводу Astro + Svelte
description: Лучшее решение для размера бандла, SEO, производительности & поддерживаемости. Сделайте Astro and Svelte сайт многоязычным в 2026, перевод LLM, Agent Skills & MCP.
keywords:
  - Интернационализация
  - Документация
  - Intlayer
...
### Шаг 6: Создание компонента Острова Svelte
