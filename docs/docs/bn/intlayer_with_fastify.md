...
> আপনার কন্টেন্ট ডিক্লারেশনগুলো অ্যাপ্লিকেশনের যেকোনো জায়গায় ডিফাইন করা যেতে পারে যদি সেগুলো `contentDir` ডিরেক্টরিতে (ডিফল্টভাবে `./src`) অন্তর্ভুক্ত থাকে। এবং অবশ্যই কন্টেন্ট ডিক্লারেশন ফাইল এক্সটেনশনের সাথে মিল থাকতে হবে (ডিফল্টভাবে `.content.{json,ts,tsx,js,jsx,mjs,cjs,md,mdx,yaml,yml}`).
