...
> আপনার কন্টেন্ট ডিক্লারেশন আপনার অ্যাপ্লিকেশনের যেকোনো জায়গায় ডিফাইন করা যেতে পারে যতক্ষণ না সেগুলো `contentDir` ডিরেক্টরিতে (ডিফল্টভাবে, `./src`) অন্তর্ভুক্ত থাকে এবং কন্টেন্ট ডিক্লারেশন ফাইল এক্সটেনশনের (ডিফল্টভাবে, `.content.{json,ts,tsx,js,jsx,mjs,cjs,md,mdx,yaml,yml}`) সাথে মিল থাকে।
