...
description: কীভাবে আপনার Angular ওয়েবসাইটটি বহুভাষিক করবেন তা আবিষ্কার করুন। আন্তর্জাতিকীকরণ (i18n) এবং অনুবাদ করতে ডকুমেন্টেশন অনুসরণ করুন।
keywords:
  - আন্তর্জাতিকীকরণ
  - ডকুমেন্টেশন
  - Intlayer
...
GitHub এ [অ্যাপ্লিকেশন টেমপ্লেট](https://github.com/aymericzip/intlayer-angular-template) দেখুন।
...
> আপনার কন্টেন্ট ডিক্লেরেশনগুলো আপনার অ্যাপ্লিকেশনের যেকোনো স্থানে সংজ্ঞায়িত করা যেতে পারে যতক্ষণ না সেগুলো `contentDir` ডিরেক্টরিতে (ডিফল্টভাবে `./src`) অন্তর্ভুক্ত থাকে। এবং কন্টেন্ট ডিক্লেরেশনের ফাইল এক্সটেনশনের সাথে মেলে (ডিফল্টভাবে `.content.{json,ts,tsx,js,jsx,mjs,cjs}`)।
