...
1. **ডেভেলপমেন্টের গতি বাড়ান**
   - একটি VSCode এক্সটেন্সন ব্যবহার করে `.content.{ts|js|mjs|cjs|json|tsx|jsx|md|mdx|yaml|yml}` ফাইল তৈরি করা যেতে পারে
...
| বৈশিষ্ট্য                                                                                                                   | বর্ণনা                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![বৈশিষ্ট্য](https://github.com/aymericzip/intlayer/blob/main/docs/assets/frameworks.webp?raw=true)                         | **ক্রস-ফ্রেমওয়ার্ক সাপোর্ট**<br><br>Intlayer সব প্রধান ফ্রেমওয়ার্ক এবং লাইব্রেরির সাথে সামঞ্জস্যপূর্ণ, যার মধ্যে রয়েছে Next.js, React, Vite, Vue.js, Nuxt, Preact, Express এবং আরও অনেক কিছু।                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/javascript_content_management.jpg?raw=true)         | **জাভাস্ক্রিপ্ট-চালিত বিষয়বস্তু ব্যবস্থাপনা**<br><br>আপনার বিষয়বস্তু দক্ষতার সাথে সংজ্ঞায়িত এবং পরিচালনা করতে জাভাস্ক্রিপ্টের নমনীয়তাকে কাজে লাগান। <br><br> - [বিষয়বস্তু ঘোষণা](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/content_file.md)                                                                                                                                                                                                                                                                                                                                                     |
| <img src="https://github.com/aymericzip/intlayer/blob/main/docs/assets/compiler.webp?raw=true" alt="বৈশিষ্ট্য" width="700"> | **কম্পাইলার**<br><br>Intlayer কম্পাইলার স্বয়ংক্রিয়ভাবে উপাদানগুলি থেকে বিষয়বস্তু বের করে এবং ডিকশনারি ফাইল তৈরি করে।<br><br> - [কম্পাইলার](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/compiler.md)                                                                                                                                                                                                                                                                                                                                                                                                            |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/per_locale_content_declaration_file.png?raw=true)   | **প্রতি-লোকাল বিষয়বস্তু ঘোষণা ফাইল**<br><br>স্বয়ংক্রিয় জেনারেশনের আগে আপনার বিষয়বস্তু একবার ঘোষণা করে আপনার ডেভেলপমেন্টের গতি বাড়ান।<br><br> - [প্রতি-লোকাল বিষয়বস্তু ঘোষণা ফাইল](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/per_locale_file.md)                                                                                                                                                                                                                                                                                                                                                           |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/autocompletion.png?raw=true)                        | **টাইপ-সেফ এনভায়রনমেন্ট**<br><br>আপনার বিষয়বস্তুর সংজ্ঞা এবং কোড যাতে ত্রুটিমুক্ত হয় তা নিশ্চিত করতে টাইপস্ক্রিপ্টের সুবিধা নিন এবং IDE অটো-কমপ্লিট থেকেও উপকৃত হন।<br><br> - [টাইপস্ক্রিপ্ট কনফিগারেশন](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_vite+react.md#configure-typescript)                                                                                                                                                                                                                                                                                                         |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/config_file.png?raw=true)                           | **সরলীকৃত সেটআপ**<br><br>ন্যূনতম কনফিগারেশনের মাধ্যমে দ্রুত শুরু করুন। আন্তর্জাতিকীকরণ, রাউটিং, এআই, বিল্ড এবং বিষয়বস্তু হ্যান্ডলিংয়ের সেটিংস সহজেই সামঞ্জস্য করুন। <br><br> - [Next.js ইন্টিগ্রেশন অন্বেষণ করুন](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nextjs_16.md)                                                                                                                                                                                                                                                                                                                       |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/content_retrieval.png?raw=true)                     | **সরলীকৃত বিষয়বস্তু পুনরুদ্ধার**<br><br>প্রতিটি বিষয়বস্তুর জন্য আপনার `t` ফাংশন কল করার প্রয়োজন নেই। একটি একক হুক ব্যবহার করে সরাসরি আপনার সমস্ত বিষয়বস্তু পুনরুদ্ধার করুন।<br><br> - [React ইন্টিগ্রেশন](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_create_react_app.md)                                                                                                                                                                                                                                                                                                                      |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/server_component.png?raw=true)                      | **সামঞ্জস্যপূর্ণ সার্ভার কম্পোনেন্ট বাস্তবায়ন**<br><br>Next.js সার্ভার কম্পোনেন্টগুলোর জন্য অত্যন্ত উপযোগী, ক্লায়েন্ট এবং সার্ভার উভয় কম্পোনেন্টের জন্য একই বাস্তবায়ন ব্যবহার করুন, প্রতিটি সার্ভার কম্পোনেন্টের মাধ্যমে আপনার `t` ফাংশন পাস করার প্রয়োজন নেই। <br><br> - [সার্ভার কম্পোনেন্ট](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nextjs_16.md#step-7-utilize-content-in-your-code)                                                                                                                                                                                                   |
...
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/url_routing.png?raw=true)                           | **উন্নত রাউটিং**<br><br>Next.js, React, Vite, Vue.js ইত্যাদির জন্য জটিল অ্যাপ্লিকেশন কাঠামোর সাথে নির্বিঘ্নে মানিয়ে নিয়ে অ্যাপ রাউটিং এর পূর্ণ সাপোর্ট।<br><br> - [Next.js ইন্টিগ্রেশন অন্বেষণ করুন](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nextjs_16.md)                                                                                                                                                                                                                                                                                                                                    |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/markdown.png?raw=true)                              | **মাকডাউন সাপোর্ট**<br><br>গোপনীয়তা নীতি, ডকুমেন্টেশন ইত্যাদির মতো বহুভাষিক বিষয়বস্তুর জন্য লোকাল ফাইল এবং রিমোট মাকডাউন ইম্পোর্ট এবং ব্যাখ্যা করুন। মাকডাউন মেটাডেটা ব্যাখ্যা করুন এবং আপনার কোডে অ্যাক্সেসযোগ্য করুন।<br><br> - [বিষয়বস্তু ফাইল](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/dictionary/file.md)                                                                                                                                                                                                                                                                                             |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/visual_editor.webp?raw=true)                        | **ফ্রি ভিজ্যুয়াল এডিটর এবং CMS**<br><br>বিষয়বস্তু লেখকদের জন্য একটি ফ্রি ভিজ্যুয়াল এডিটর এবং CMS উপলব্ধ, যা লোকালাইজেশন প্ল্যাটফর্মের প্রয়োজনীয়তা দূর করে। Git ব্যবহার করে আপনার বিষয়বস্তু সিঙ্ক রাখুন, অথবা CMS-এর মাধ্যমে এটি সম্পূর্ণ বা আংশিকভাবে এক্সটার্নালাইজ করুন।<br><br> - [Intlayer এডিটর](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_visual_editor.md) <br> - [Intlayer CMS](https://github.com/aymericzip/intlayer/blob/main/docs/docs/bn/intlayer_CMS.md)                                                                                                                           |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/bundle.webp?raw=true)                               | **Tree-shakable বিষয়বস্তু**<br><br>Tree-shakable বিষয়বস্তু, যা চূড়ান্ত বান্ডিল সাইজ কমায়। প্রতি কম্পোনেন্ট অনুযায়ী বিষয়বস্তু লোড করে, আপনার বান্ডিল থেকে যেকোনো অব্যবহৃত বিষয়বস্তু বাদ দেয়। অ্যাপ লোডিং দক্ষতা বাড়াতে লেজি লোডিং সাপোর্ট করে। <br><br> - [অ্যাপ বিল্ড অপ্টিমাইজেশন](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/how_works_intlayer.md#app-build-optimization)                                                                                                                                                                                                                            |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/static_rendering.webp?raw=true)                     | **স্ট্যাটিক রেন্ডারিং**<br><br>স্ট্যাটিক রেন্ডারিং ব্লক করে না। <br><br> - [Next.js ইন্টিগ্রেশন](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/intlayer_with_nextjs_16.md)                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/AI_translation.png?raw=true)                        | **এআই-চালিত অনুবাদ**<br><br>আপনার নিজস্ব এআই সরবরাহকারী/এপিআই কী ব্যবহার করে Intlayer-এর উন্নত এআই-চালিত অনুবাদ সরঞ্জামগুলির মাধ্যমে মাত্র একটি ক্লিকের মাধ্যমে আপনার ওয়েবসাইটকে ২৩১টি ভাষায় রূপান্তর করুন। <br><br> - [CI/CD ইন্টিগ্রেশন](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/CI_CD.md) <br> - [Intlayer CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/bn/cli/index.md) <br> - [অটো ফিল](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/autoFill.md)                                                                                                                  |
...
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/vscode_extension.webp?raw=true)                     | **VSCode এক্সটেন্সন**<br><br>Intlayer আপনার বিষয়বস্তু এবং অনুবাদ পরিচালনা করতে, আপনার ডিকশনারি তৈরি করতে, আপনার বিষয়বস্তু অনুবাদ করতে এবং আরও অনেক কিছু করতে সাহায্য করার জন্য একটি VSCode এক্সটেন্সন প্রদান করে। <br><br> - [VSCode এক্সটেন্সন](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/vs_code_extension.md)                                                                                                                                                                                                                                                                                              |
| ![Feature](https://github.com/aymericzip/intlayer/blob/main/docs/assets/interoperability.png?raw=true)                      | **ইন্টারঅপারেবিলিটি**<br><br>react-i18next, next-i18next, next-intl, এবং react-intl এর সাথে ইন্টারঅপারেবিলিটি সক্ষম করে। <br><br> - [Intlayer এবং react-intl](https://github.com/aymericzip/intlayer/blob/main/docs/blog/en/intlayer_with_react-intl.md) <br> - [Intlayer এবং next-intl](https://github.com/aymericzip/intlayer/blob/main/docs/blog/en/intlayer_with_next-intl.md) <br> - [Intlayer এবং next-i18next](https://github.com/aymericzip/intlayer/blob/main/docs/blog/en/intlayer_with_next-i18next.md) <br> - [Intlayer compat adapters](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/compat/index.md) |
