...
title: Astro + Vue i18n - Guia completo para traduzir Astro + Vue
description: A melhor solução para tamanho de bundle, SEO, desempenho & manutenibilidade. Torne seu Astro and Vue site multilíngue em 2026, tradução LLM, Agent Skills & MCP.
keywords:
  - internacionalização
  - documentação
  - Intlayer
...
### Passo 6: Criar um componente Island de Vue
