...
githubUrl: https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/intlayer_with_angular.md
...
# Começando com Internacionalização (i18n) em Angular usando Intlayer
