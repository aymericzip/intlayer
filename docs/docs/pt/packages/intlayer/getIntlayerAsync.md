...
### Em um `head` de rota do TanStack Start

Porque o chunk de locale é carregado sob demanda, `head` se torna `async`:
...
### Em um Next.js `generateMetadata`
