...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| `useHTMLRenderer`      | Hook para obter uma função de renderização HTML pré-configurada.                                                                              | -                                                                                                                       |
| `useMarkdownRenderer`  | Hook para obter uma função de renderização Markdown pré-configurada.                                                                          | -                                                                                                                       |
...
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `renderHTML`         | Utilitário autônomo para renderizar HTML fora dos componentes.                                                                                              | -                                                                                                   |
| `renderMarkdown`     | Utilitário autônomo para renderizar Markdown fora dos componentes.                                                                                          | -                                                                                                   |
