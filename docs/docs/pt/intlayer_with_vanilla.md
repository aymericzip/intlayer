...
Nesta arquitetura, o núcleo `intlayer` fornece APIs JavaScript para declarar e consumir dicionários em ambientes padrão de JavaScript ou TypeScript sem um framework frontend.
