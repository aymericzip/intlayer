...
Nesta arquitetura, o `svelte-intlayer` fornece stores reativos e utilitários para gerenciar traduções dentro de componentes Svelte. As declarações de conteúdo ficam em `src/` ao lado dos componentes.
