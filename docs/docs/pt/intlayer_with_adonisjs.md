...
title: AdonisJS i18n - Como traduzir uma aplicação AdonisJS em 2026
...
<iframe
  src="https://ide.intlayer.org/github/aymericzip/intlayer-adonis-template?file=intlayer.config.ts"
