...
- **Intlayer**: Oferece o melhor desempenho e o menor tamanho de bundle (v9.5.6) para TanStack Start.
...
- [`react-intlayer`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/packages/react-intlayer/exports.md) (v9.5.6)
- [`@intlayer/use-intl`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/compat/next-intl.md) (v9.5.6)
- [`@intlayer/lingui`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/compat/lingui.md) (v9.5.6)
- [`@intlayer/react-i18next`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/compat/react-i18next.md) (v9.5.6)
...
O package também é pesado (~15.3kb, o que é cerca de 3× `react-intlayer`).
