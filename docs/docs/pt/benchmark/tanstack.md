...
- **Intlayer**: Oferece o melhor desempenho e o menor tamanho de bundle (v9.5.1) para TanStack Start.
...
- [`@intlayer/lingui`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/compat/lingui.md) (v9.5.1)
