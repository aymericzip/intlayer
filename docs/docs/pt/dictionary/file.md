...
- `file("./path/to/file.txt")` - Caminho relativo ao arquivo atual
- `file("path/to/file.txt")` - Caminho relativo ao diretório raiz do projeto
- `file("/users/username/path/to/file.txt")` - Caminho absoluto
