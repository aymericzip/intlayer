...
title: Astro + Preact i18n - Guia completo para traduzir Astro + Preact
description: A melhor solução para tamanho de bundle, SEO, desempenho & manutenibilidade. Torne seu Astro and Preact site multilíngue em 2026, tradução LLM, Agent Skills & MCP.
keywords:
  - internacionalização
  - documentação
  - Intlayer
