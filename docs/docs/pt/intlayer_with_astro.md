...
title: Tradução do Astro i18n - Guia completo para traduzir Astro
description: A melhor solução para tamanho de bundle, SEO, desempenho & manutenibilidade. Torne seu Astro site multilíngue em 2026, tradução LLM, Agent Skills & MCP.
keywords:
  - internacionalização
  - documentação
  - Intlayer
