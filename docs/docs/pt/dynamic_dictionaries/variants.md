...
title: Variantes
description: Use o campo de metadados variant nos arquivos de conteúdo do Intlayer para declarar alternativas de conteúdo nomeadas (testes A/B, banners sazonais, textos baseados em sinalizadores de recursos) e alternar entre elas em tempo de execução sem alterações de código.
keywords:
  - Variantes
  - Testes A/B
