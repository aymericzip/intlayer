...
| `description`               | `string`                                                                                        | Ajuda a entender o propósito do dicionário no editor e no CMS. Também usado como contexto para a geração de traduções por IA. Padrão: `undefined`                               | `'User profile section'` |                                                                                                                                                                                                                                                                                                                                                                                                |
| `locale`                    | `LocalesValues`                                                                                 | Transforma o dicionário em um formato por localidade. Cada campo declarado torna-se um nó de tradução. Se ausente, o dicionário é tratado como multilíngue. Padrão: `undefined` | `'en'`                   | Use isso quando o dicionário for específico de uma única localidade, em vez de conter traduções para múltiplas localidades.                                                                                                                                                                                                                                                                    |
| `contentAutoTransformation` | `boolean &#124; { markdown?: boolean; html?: boolean; insertion?: boolean }`                    | Transforma automaticamente strings de conteúdo em nós tipados (markdown, HTML ou inserção). Padrão: `false`                                                                     | `true`                   | Markdown: `### Title` → `md('### Title')`. HTML: `<div>Title</div>` → `html('<div>Title</div>')`. Inserção: `Hello {{name}}` → `insert('Hello {{name}}')`.                                                                                                                                                                                                                                     |
| `location`                  | `'local' &#124; 'remote' &#124; 'hybrid' &#124; 'plugin' &#124; string`                         | Indica onde os arquivos de dicionário são armazenados e seu modo de sincronização com o CMS. Padrão: `'local'`                                                                  | `'hybrid'`               | `'local'`: gerenciado apenas localmente. `'remote'`: gerenciado apenas remotamente (CMS). `'hybrid'`: gerenciado tanto localmente quanto remotamente. `'plugin'` ou string personalizada: gerenciado por um plugin ou fonte personalizada.                                                                                                                                                     |
...
| `priority`                  | `number`                                                                                        | Prioridade do dicionário. Valores mais altos têm precedência sobre valores mais baixos ao resolver conflitos entre dicionários. Padrão: `undefined`                             | `1`                      |                                                                                                                                                                                                                                                                                                                                                                                                |
| `live`                      | `boolean`                                                                                       | Descontinuado — use `importMode: 'fetch'` em vez disso. Indicava se o conteúdo do dicionário era obtido dinamicamente via API de live sync. Padrão: `undefined`                 |                          | Renomeado para `importMode: 'fetch'` na v8.0.0.                                                                                                                                                                                                                                                                                                                                                |
| `schema`                    | `'https://intlayer.org/schema.json'`                                                            | Gerado automaticamente pelo Intlayer para validação de esquema JSON. Padrão: gerado automaticamente                                                                             |                          | Não modifique manualmente.                                                                                                                                                                                                                                                                                                                                                                     |
| `title`                     | `string`                                                                                        | Ajuda a identificar o dicionário no editor e no CMS. Padrão: `undefined`                                                                                                        | `'User Profile'`         |                                                                                                                                                                                                                                                                                                                                                                                                |
| `tags`                      | `string[]`                                                                                      | Categoriza dicionários e fornece contexto ou instruções para o editor e para a IA. Padrão: `undefined`                                                                          | `['user', 'profile']`    |                                                                                                                                                                                                                                                                                                                                                                                                |
| `version`                   | `string`                                                                                        | Versão do dicionário remoto; ajuda a rastrear qual versão está em uso. Padrão: `undefined`                                                                                      | `'1.0.0'`                | Gerenciável no CMS. Não modifique localmente.                                                                                                                                                                                                                                                                                                                                                  |
