...
Nesta arquitetura, o `react-native-intlayer` fornece o `IntlayerProvider` raiz e hooks do React Native para gerenciar traduções em telas e componentes. As declarações de conteúdo ficam ao lado de seus componentes.
