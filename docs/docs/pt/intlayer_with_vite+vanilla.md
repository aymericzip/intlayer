...
Nesta arquitetura, o `vanilla-intlayer` ou o núcleo `intlayer` fornece APIs JavaScript para gerenciar traduções e atualizar dinamicamente o conteúdo do DOM. As declarações de conteúdo ficam em `src/`.
