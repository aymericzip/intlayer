...
- A configuração [`editor`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/configuration.md#editor-configuration) está corretamente definida no seu arquivo de configuração do Intlayer.
  - Campos obrigatórios:
