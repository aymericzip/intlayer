...
Para mais detalhes, consulte a [Documentação de Ficheiros de Conteúdo YAML](https://intlayer.org/doc/concept/content#yaml-content-file) e a [Documentação de Ficheiros de Conteúdo Markdown](https://intlayer.org/doc/concept/content/markdown).
...
Para mais informações, consulte a [Documentação de Pluralização](https://intlayer.org/doc/concept/content/plural).
...
Para mais detalhes, consulte a [Documentação do LSP](https://intlayer.org/doc/lsp).
...
Para detalhes sobre a configuração, consulte a [Documentação do Ambiente Angular](https://intlayer.org/doc/environment/angular).
