...
Um novo pacote opcional, [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/analytics.md), mostra qual conteúdo é realmente exibido aos seus visitantes — e fecha o ciclo com **Collections & Variants**, permitindo testar conteúdo em A/B e medir conversões por variante.
...
Já disponível para React, Next.js e React Native (via `react-intlayer`); outras integrações de frameworks (Vue, Svelte, Angular, …) estão planejadas, seguindo o mesmo padrão de lançamento do `@intlayer/editor`. Consulte a [documentação do Analytics](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/analytics.md) para o guia completo.
...
- [Analytics - Rastreamento de exposição de conteúdo e testes A/B](https://github.com/aymericzip/intlayer/blob/main/docs/docs/pt/analytics.md)
