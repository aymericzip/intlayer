...
## Pourquoi migrer de vue-i18n à Intlayer ?
...
Les étapes suivantes sont le minimum requis pour faire fonctionner votre application `vue-i18n` existante sur Intlayer avec zéro changement de code dans vos composants.
...
Si vous utilisez `@nuxtjs/i18n` (intégration Nuxt), installez `nuxt-intlayer` et ajoutez-le à votre `nuxt.config.ts` :
...
export default defineNuxtConfig({
  ...
  // Vous pouvez supprimer en toute sécurité @nuxtjs/i18n de vos modules
});
```

> **Vous n'avez plus besoin de `createI18n()` ou du bootstrap manuel du provider.** Intlayer compile tous les dictionnaires **au moment de la construction**, il n'y a donc pas d'étape de chargement à l'exécution. Le provider aliasé gère l'initialisation pour vous.
...
| ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| appels `createI18n()`                          | Le provider d'Intlayer initialise tout automatiquement ; il n'y a pas d'étape de chargement à l'exécution.                                                                              |
