...
title: Variantes
description: Utilisez le champ de métadonnées de variante dans les fichiers de contenu Intlayer pour déclarer des alternatives de contenu nommées (tests A/B, bannières saisonnières, texte avec feature flags) et basculez entre elles au moment de l'exécution sans modification de code.
keywords:
  - Variantes
  - Tests A/B
  - Feature Flags
...
history:
  - version: 9.0.0
    date: 2026-06-12
    changes: "Lancement de la fonctionnalité des variantes de dictionnaires"
author: aymericzip
---
