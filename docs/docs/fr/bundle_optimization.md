...
| **`importMode`**      | **Deprecated**: Use `dictionary.importMode` instead. | `'static' , 'dynamic' , 'fetch'` | `'static'`                                                                                                                                                                                                                         | Détermine comment les dictionnaires sont chargés (voir détails ci-dessous). |
