...
Dans cette architecture, le core `intlayer` fournit des API JavaScript pour déclarer et consommer des dictionnaires dans des environnements JavaScript ou TypeScript standard sans framework frontend.
