...
title: "Vite + Vue i18n - Guide complet pour traduire une application Vite + Vue"
description: "Plus d'i18next. Le guide 2026 pour créer une application Vite + Vue multilingue (i18n). Traduisez avec des agents IA et optimisez la taille du bundle, le SEO et les performances."
keywords:
...
<Step number={11} title="Rendre du Markdown" isOptional={true}>
