...
- **[Scanner le site web](https://github.com/aymericzip/intlayer/blob/main/docs/docs/fr/cli/scan.md)** - Mesurez la taille de la page et auditez la santé i18n/SEO de n'importe quelle URL publique
