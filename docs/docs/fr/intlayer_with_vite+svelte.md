...
Dans cette architecture, `svelte-intlayer` fournit des stores réactifs et des utilitaires pour gérer les traductions au sein des composants Svelte. Les déclarations de contenu résident dans `src/` aux côtés des composants.
