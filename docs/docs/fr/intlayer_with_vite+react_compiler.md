...
title: Vite et React i18n - Transformer une application existante en une application multilingue (guide i18n 2026)
...
> Doc Compiler : https://github.com/aymericzip/intlayer/blob/main/docs/docs/fr/compiler.md
