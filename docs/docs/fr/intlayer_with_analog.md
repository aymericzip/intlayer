...
title: Analog i18n - Comment traduire une application Analog en 2026
...
<iframe
  src="https://ide.intlayer.org/github/aymericzip/intlayer-analog-template?file=intlayer.config.ts"
