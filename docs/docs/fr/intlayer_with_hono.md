...
title: i18n Hono - Comment traduire une application Hono en 2026
...
<iframe
  src="https://ide.intlayer.org/github/aymericzip/intlayer-hono-template?file=intlayer.config.ts"
