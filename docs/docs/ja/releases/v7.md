...
v7では、辞書関連の設定をより良く組織化し、コンテンツ管理を改善する新しい専用の`dictionary`設定セクションが導入されています。
...
コンテンツ宣言ファイルおよび設定値がどのように適用されるかについての詳細は、[コンテンツファイルドキュメンテーション](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ja/dictionary/content_file.md)を参照してください。
