...
| `description`               | `string`                                                                                        | エディターと CMS での辞書の目的を理解するのに役立ちます。AI 翻訳生成のコンテキストとしても使用されます。デフォルト: `undefined`                                  | `'User profile section'` |                                                                                                                                                                                                                                                                                                                                                                                  |
| `locale`                    | `LocalesValues`                                                                                 | 辞書をロケールごとの形式に変換します。宣言された各フィールドが翻訳ノードになります。存在しない場合、辞書は多言語として扱われます。デフォルト: `undefined`        | `'en'`                   | 辞書が複数のロケールの翻訳を含むのではなく、単一のロケールに特化している場合に使用します。                                                                                                                                                                                                                                                                                       |
| `contentAutoTransformation` | `boolean &#124; { markdown?: boolean; html?: boolean; insertion?: boolean }`                    | コンテンツ文字列を型付きノード（markdown、HTML、または挿入）に自動変換します。デフォルト: `false`                                                                | `true`                   | Markdown: `### Title` → `md('### Title')`。HTML: `<div>Title</div>` → `html('<div>Title</div>')`。Insertion: `Hello {{name}}` → `insert('Hello {{name}}')`。                                                                                                                                                                                                                     |
| `location`                  | `'local' &#124; 'remote' &#124; 'hybrid' &#124; 'plugin' &#124; string`                         | 辞書ファイルの保存場所と CMS 同期モードを示します。デフォルト: `'local'`                                                                                         | `'hybrid'`               | `'local'`: ローカルのみで管理。 `'remote'`: リモートのみで管理（CMS）。 `'hybrid'`: ローカルとリモートの両方で管理。 `'plugin'` またはカスタム文字列: プラグインまたはカスタムソースで管理。                                                                                                                                                                                     |
...
| `priority`                  | `number`                                                                                        | 辞書の優先度。辞書間の競合を解決する際、値が大きいほど優先されます。デフォルト: `undefined`                                                                      | `1`                      |                                                                                                                                                                                                                                                                                                                                                                                  |
| `live`                      | `boolean`                                                                                       | 非推奨 — 代わりに `importMode: 'fetch'` を使用してください。辞書コンテンツがライブ同期 API を介して動的に取得されるかどうかを示しました。デフォルト: `undefined` |                          | v8.0.0 で `importMode: 'fetch'` に名称変更されました。                                                                                                                                                                                                                                                                                                                           |
| `schema`                    | `'https://intlayer.org/schema.json'`                                                            | JSON スキーマ検証のために Intlayer によって自動生成されます。デフォルト: 自動生成                                                                                |                          | 手動で変更しないでください。                                                                                                                                                                                                                                                                                                                                                     |
| `title`                     | `string`                                                                                        | エディターと CMS での辞書の識別に役立ちます。デフォルト: `undefined`                                                                                             | `'User Profile'`         |                                                                                                                                                                                                                                                                                                                                                                                  |
| `tags`                      | `string[]`                                                                                      | 辞書を分類し、エディターと AI にコンテキストや指示を提供します。デフォルト: `undefined`                                                                          | `['user', 'profile']`    |                                                                                                                                                                                                                                                                                                                                                                                  |
| `version`                   | `string`                                                                                        | リモート辞書のバージョン。現在使用中のバージョンを追跡するのに役立ちます。デフォルト: `undefined`                                                                | `'1.0.0'`                | CMS で管理可能です。ローカルでは変更しないでください。                                                                                                                                                                                                                                                                                                                           |
