...
title: ترجمة Astro + Lit i18n - الدليل الكامل لترجمة Astro + Lit
description: أفضل حل لحجم البندل وتحسين محركات البحث والأداء والصيانة. اجعل Astro and Lit موقع ويب متعدد اللغات في 2026، ترجمة LLM، Agent Skills & MCP.
keywords:
  - التدويل
  - توثيق
  - Intlayer
