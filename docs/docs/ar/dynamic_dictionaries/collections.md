...
title: المجموعات
description: استخدم حقل البيانات التعريفية item في ملفات محتوى Intlayer لإنشاء مجموعات مرتبة من العناصر المترجمة القابلة للتحديد حسب الفهرس في وقت التشغيل.
keywords:
  - المجموعات
  - قائمة المحتوى
  - المحتوى الديناميكي
...
history:
  - version: 8.13.0
    date: 2026-06-12
    changes: "إصدار ميزة قواميس المجموعات"
author: aymericzip
---
