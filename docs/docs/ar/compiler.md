...
- **التشغيل الآلي**: يلغي الحاجة إلى نسخ ولصق المحتوى يدويًا في القواميس.

- **السرعة**: استخراج المحتوى المحسّن الذي يضمن بقاء عملية البناء لديك سريعة.

- **تجربة المطور**: احتفظ بإعلانات المحتوى في مكان استخدامها، مما يحسن سهولة الصيانة.
...
- **استخراج ثابت فقط**: يعتمد الاستخراج القائم على المترجم على التحليل الثابت. لا يمكن اكتشاف أو ترجمة السلاسل النصية التي توجد فقط في وقت التشغيل (رموز خطأ API، حقول CMS، إلخ) بواسطة المترجم وحده، لذا تحتاج إلى استراتيجية i18n تشغيلية إضافية.
