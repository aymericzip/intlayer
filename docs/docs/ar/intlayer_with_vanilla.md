...
title: Vanilla JS i18n - الدليل الكامل لترجمة Vanilla JS
description: أفضل حل لحجم البندل وتحسين محركات البحث والأداء والصيانة. اجعل Vanilla JS موقع ويب متعدد اللغات في 2026، ترجمة LLM، Agent Skills & MCP.
keywords:
  - تدويل
  - وثائق
  - Intlayer
