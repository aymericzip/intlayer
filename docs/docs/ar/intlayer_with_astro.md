...
title: ترجمة Astro i18n - الدليل الكامل لترجمة Astro
description: أفضل حل لحجم البندل وتحسين محركات البحث والأداء والصيانة. اجعل Astro موقع ويب متعدد اللغات في 2026، ترجمة LLM، Agent Skills & MCP.
keywords:
  - التدويل
  - توثيق
  - Intlayer
