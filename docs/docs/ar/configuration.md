...
| --------------- | ----------------------------------------------------------------------------- | --------- | --------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| `enabled`       | يُفعّل جمع بيانات التحليلات (مشاهدات الصفحات، حالات ظهور المحتوى، أحداث A/B). | `boolean` | `true`    | `false` | يتطلب تثبيت `@intlayer/analytics` وضبط `editor.clientId` من أجل الإسناد؛ وإلا تبقى التحليلات معطّلة حتى لو كانت `enabled` تساوي `true`. |
