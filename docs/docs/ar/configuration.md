...
| `description`               | `string`                                                                                        | يساعد على فهم غرض القاموس في المحرر ونظام إدارة المحتوى. يُستخدم أيضًا كسياق لإنشاء الترجمة بالذكاء الاصطناعي. الافتراضي: `undefined`                                | `'User profile section'` |                                                                                                                                                                                                                                                                                                          |
| `locale`                    | `LocalesValues`                                                                                 | يحوّل القاموس إلى تنسيق حسب اللغة. يصبح كل حقل مُعلَن عنه عقدة ترجمة. إذا غاب، يُعامَل القاموس كمتعدد اللغات. الافتراضي: `undefined`                                 | `'en'`                   | استخدمه عندما يكون القاموس خاصًا بلغة واحدة بدلاً من احتوائه على ترجمات لعدة لغات.                                                                                                                                                                                                                       |
| `contentAutoTransformation` | `boolean &#124; { markdown?: boolean; html?: boolean; insertion?: boolean }`                    | يحوّل تلقائيًا سلاسل المحتوى إلى عقد مكتوبة (markdown أو HTML أو insertion). الافتراضي: `false`                                                                      | `true`                   | Markdown: `### Title` → `md('### Title')`. HTML: `<div>Title</div>` → `html('<div>Title</div>')`. Insertion: `Hello {{name}}` → `insert('Hello {{name}}')`.                                                                                                                                              |
| `location`                  | `'local' &#124; 'remote' &#124; 'hybrid' &#124; 'plugin' &#124; string`                         | يشير إلى مكان تخزين ملفات القاموس ووضع مزامنة نظام إدارة المحتوى. الافتراضي: `'local'`                                                                               | `'hybrid'`               | `'local'`: يُدار محليًا فقط. `'remote'`: يُدار عن بُعد فقط (CMS). `'hybrid'`: يُدار محليًا وعن بُعد. `'plugin'` أو سلسلة مخصصة: يُدار بواسطة مكوّن إضافي أو مصدر مخصص.                                                                                                                                   |
...
| `priority`                  | `number`                                                                                        | أولوية القاموس. تأخذ القيم الأعلى الأسبقية على القيم الأدنى عند حل التعارضات بين القواميس. الافتراضي: `undefined`                                                    | `1`                      |                                                                                                                                                                                                                                                                                                          |
| `live`                      | `boolean`                                                                                       | مهمل — استخدم `importMode: 'fetch'` بدلاً منه. كان يشير إلى ما إذا كان محتوى القاموس يُجلب ديناميكيًا عبر واجهة برمجة تطبيقات المزامنة الحية. الافتراضي: `undefined` |                          | تمت إعادة تسميته إلى `importMode: 'fetch'` في الإصدار v8.0.0.                                                                                                                                                                                                                                            |
| `schema`                    | `'https://intlayer.org/schema.json'`                                                            | يتم إنشاؤه تلقائيًا بواسطة Intlayer للتحقق من صحة مخطط JSON. الافتراضي: يتم إنشاؤه تلقائيًا                                                                          |                          | لا تعدّله يدويًا.                                                                                                                                                                                                                                                                                        |
| `title`                     | `string`                                                                                        | يساعد على تعريف القاموس في المحرر ونظام إدارة المحتوى. الافتراضي: `undefined`                                                                                        | `'User Profile'`         |                                                                                                                                                                                                                                                                                                          |
| `tags`                      | `string[]`                                                                                      | يصنّف القواميس ويوفر سياقًا أو تعليمات للمحرر والذكاء الاصطناعي. الافتراضي: `undefined`                                                                              | `['user', 'profile']`    |                                                                                                                                                                                                                                                                                                          |
| `version`                   | `string`                                                                                        | إصدار القاموس البعيد؛ يساعد على تتبع الإصدار المستخدم حاليًا. الافتراضي: `undefined`                                                                                 | `'1.0.0'`                | قابل للإدارة على نظام إدارة المحتوى. لا تعدّله محليًا.                                                                                                                                                                                                                                                   |
