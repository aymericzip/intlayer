...
| `minify`          | يحدد ما إذا كان ينبغي ضغط القواميس لتقليل حجم الحزمة.                       | `boolean`                        | `true`                                                                                                                                                                            |                                                                               | • يحدد ما إذا كانت الحزمة يجب أن تكون مضغوطة.<br/>• الافتراضي: `true` في الإنتاج.<br/>• سيتم تجاهل هذا الخيار إذا تم تعطيل `optimize`.<br/>• سيتم تجاهل هذا الخيار إذا كان `editor.enabled` صحيحاً.                                                                              |
