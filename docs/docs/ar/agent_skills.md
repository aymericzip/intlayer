...
3.  سيُنشئ ملفات التكوين المطلوبة (مثل `.cursor/skills/intlayer_next_js/SKILL.md` و `.windsurf/skills/intlayer_next_js/SKILL.md` و `.opencode/skills/next_js/SKILL.md` و `.vscode/mcp.json` إلخ).
