...
title: Express i18n - الدليل الكامل لترجمة Express
description: أفضل حل لحجم البندل وتحسين محركات البحث والأداء والصيانة. اجعل Express خلفية متعدد اللغات في 2026، ترجمة LLM، Agent Skills & MCP.
keywords:
  - دولية
  - توثيق
  - Intlayer
...
> يمكن تعريف إعلانات المحتوى الخاصة بك في أي مكان داخل تطبيقك طالما تم تضمينها في دليل `contentDir` (افتراضيًا، `./src`). ويجب أن تطابق امتداد ملف إعلان المحتوى (افتراضيًا، `.content.{json,ts,tsx,js,jsx,mjs,cjs}`).
