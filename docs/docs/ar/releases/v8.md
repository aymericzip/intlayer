...
لمزيد من التفاصيل، راجع [توثيق ملفات محتوى YAML](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/dictionary/content_file.md#yaml-content-file) و [توثيق ملفات محتوى Markdown](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/dictionary/markdown.md).
...
لمزيد من المعلومات، راجع [توثيق الجمع](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/dictionary/plurial.md).
...
لمزيد من التفاصيل، راجع [توثيق LSP](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/lsp.md).
...
للحصول على تفاصيل حول التكوين، راجع [توثيق بيئة Angular](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/intlayer_with_angular_21.md).
