...
لمزيد من التفاصيل، راجع [توثيق ملفات محتوى YAML](https://intlayer.org/doc/concept/content#yaml-content-file) و [توثيق ملفات محتوى Markdown](https://intlayer.org/doc/concept/content/markdown).
...
لمزيد من المعلومات، راجع [توثيق الجمع](https://intlayer.org/doc/concept/content/plural).
...
لمزيد من التفاصيل، راجع [توثيق LSP](https://intlayer.org/doc/lsp).
...
للحصول على تفاصيل حول التكوين، راجع [توثيق بيئة Angular](https://intlayer.org/doc/environment/angular).
