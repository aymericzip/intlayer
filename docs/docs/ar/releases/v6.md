...
راجع المزيد من الخيارات في وثائق CLI: [مرجع CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/cli/index.md) → "اختبار الترجمات المفقودة". وكذلك دليل [الاختبار](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/testing.md).
...
قم بملء ترجماتك المفقودة باستخدام أمر `npx intlayer fill`.
...
تم تحديث خادم MCP لدعم الميزات الجديدة.
...
> خادم MCP يساعد في أتمتة المشاريع التي تستخدم Intlayer. اختبار الترجمات المفقودة للكود المُنشأ تلقائياً. يساعدك في فهم إعدادك، وتضمين توثيق Intlayer في محرر الأكواد الخاص بك.
...
## عملية متوازية لمراقبة الملفات على turbopack

عند استخدام Turbopack على Next.js 14 وما فوق كخادم التطوير الخاص بك مع أمر `next dev --turbopack`، لن يتم اكتشاف تغييرات القاموس تلقائياً بشكل افتراضي.

يحدث هذا التحديد لأن Turbopack لا يمكنه تشغيل مكونات webpack بالتوازي لمراقبة التغييرات في ملفات المحتوى الخاصة بك.

للعمل حول هذا، أسقطنا أمر `intlayer watch`، باستخدام خيار `--with` لتشغيل كل من خادم التطوير ومراقب بناء Intlayer في نفس الوقت.
...
## ملاحظات الترحيل من v6 إلى v7

تحقق من [ملاحظات الترحيل من v6 إلى v7](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/releases/v7.md) للمزيد من المعلومات.

---

## روابط مفيدة

- [مرجع CLI](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/cli/index.md)
