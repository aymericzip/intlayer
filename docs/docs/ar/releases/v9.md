...
حزمة اختيارية جديدة، [`@intlayer/analytics`](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/analytics.md)، تخبرك بالمحتوى الذي يشاهده زوارك فعلياً — وتُكمل حلقة **Collections & Variants** من خلال تمكينك من اختبار المحتوى بطريقة A/B وقياس التحويلات لكل نسخة.
...
متوفرة اليوم لـ React وNext.js وReact Native (عبر `react-intlayer`)؛ ويُخطَّط لدعم أطر عمل أخرى (Vue، Svelte، Angular، …) باتباع نفس نمط الطرح المُستخدم في `@intlayer/editor`. راجع [توثيق Analytics](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/analytics.md) للحصول على الدليل الكامل.
...
- [Analytics - تتبع عرض المحتوى واختبار A/B](https://github.com/aymericzip/intlayer/blob/main/docs/docs/ar/analytics.md)
