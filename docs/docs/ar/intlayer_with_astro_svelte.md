...
title: ترجمة Astro + Svelte i18n - كيفية ترجمة تطبيق Astro + Svelte في عام 2026
description: تعرف على كيفية إضافة التدويل (i18n) إلى موقع Astro + Svelte الخاص بك باستخدام Intlayer. اتبع هذا الدليل لجعل موقعك متعدد اللغات.
keywords:
  - التدويل
  - توثيق
  - Intlayer
...
### الخطوة 6: إنشاء مكون جزيرة Svelte
