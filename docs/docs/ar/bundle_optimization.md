...
| **`minify`**          | `boolean`                        | `true`                          | ما إذا كان سيتم تصغير القواميس لتقليل حجم الحزمة.                                                                                                                                                                  |
| **`purge`**           | `boolean`                        | `true`                          | ما إذا كان سيتم تطهير المفاتيح غير المستخدمة في القواميس.                                                                                                                                                          |
| **`importMode`**      | `'static' , 'dynamic' , 'fetch'` | `'static'`                      | **Deprecated**: Use `dictionary.importMode` instead. يحدد كيفية تحميل القواميس (انظر التفاصيل أدناه).                                                                                                              |
...
## تصغير وتطهير القواميس (Minification & Purging)

توفر Intlayer خيارات لتحسين الحزمة الخاصة بك بشكل أكبر من خلال تصغير القواميس وتطهير المفاتيح غير المستخدمة (purge).
