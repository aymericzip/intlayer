...
title: ترجمة Astro + Vanilla JS i18n - الدليل الكامل لترجمة Astro + Vanilla JS
description: أفضل حل لحجم البندل وتحسين محركات البحث والأداء والصيانة. اجعل Astro and Vanilla JS موقع ويب متعدد اللغات في 2026، ترجمة LLM، Agent Skills & MCP.
keywords:
  - التدويل
  - توثيق
  - Intlayer
