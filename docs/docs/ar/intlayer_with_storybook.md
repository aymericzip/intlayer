...
title: "تدويل Storybook - الدليل الكامل لترجمة تطبيق Storybook"
description: "لا مزيد من i18next. دليل 2026 لبناء تطبيق Storybook متعدد اللغات (i18n). ترجم باستخدام وكلاء الذكاء الاصطناعي وحسّن حجم الحزمة وتحسين محركات البحث والأداء."
keywords:
  - تدويل
  - توثيق
  - Intlayer
