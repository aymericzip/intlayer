...
- تقسيم ملفات JSON الكبيرة إلى أجزاء للبقاء ضمن حدود نافذة السياق لنموذج الذكاء الاصطناعي.
- إعادة محاولة الترجمة إذا كان تنسيق الإخراج غير صحيح.
- دمج السياق الخاص بالتطبيق والملف لتحسين دقة الترجمة.
- الحفاظ على الترجمات الموجودة بعدم الكتابة فوقها.
- معالجة الملفات والأجزاء والإعدادات المحلية بالتوازي باستخدام نظام طابور لزيادة السرعة.
