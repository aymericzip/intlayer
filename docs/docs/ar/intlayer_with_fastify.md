...
title: Fastify i18n - الدليل الكامل لترجمة Fastify
description: أفضل حل لحجم البندل وتحسين محركات البحث والأداء والصيانة. اجعل Fastify خلفية متعدد اللغات في 2026، ترجمة LLM، Agent Skills & MCP.
keywords:
  - التدويل
  - الوثائق
  - Intlayer
