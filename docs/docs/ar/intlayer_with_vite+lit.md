...
<AccordionGroup>
<Accordion header="تغطية كاملة مضاءة">
...
في هذه البنية، يوفر `lit-intlayer` تكاملات العناصر المخصصة ووحدات التحكم التفاعلية لإدارة الترجمات داخل Web Components. توجد إعلانات المحتوى في `src/` بجانب العناصر.
...
<Question title="ما هي الحلول المختلفة المتاحة لتدويل تطبيقات Vite و Lit؟">

لا يفرض Vite أي رأي بشأن تدويل التطبيقات (i18n)، لذا يعود الخيار لمنظومة Lit:

- **`@lit/localize`**: الحل الرسمي لـ Lit استنادًا إلى قوالب XLIFF.
- **`Intlayer`**: إعلان المحتوى بجانب المكون، ترجمة وقت البناء عبر مكون Vite الإضافي، أنواع TypeScript كاملة، ترجمة بالذكاء الاصطناعي، محرر مرئي، ونظام CMS.
...
<Question title="كيف أستخدم المحتوى المترجم داخل مكون Lit؟">

اقرأ المحتوى من خلال روابط Intlayer داخل طريقة `render` لـ `LitElement`، كما هو موضح في الخطوة 6. يؤدي تغيير اللغة إلى تحديث المكون دون إعادة تحميل الصفحة.
