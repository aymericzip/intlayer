...
title: i18n Vite + Lit - الدليل الكامل لترجمة Lit
description: أفضل حل لحجم البندل وتحسين محركات البحث والأداء والصيانة. اجعل Vite and Lit تطبيق متعدد اللغات في 2026، ترجمة LLM، Agent Skills & MCP.
keywords:
  - تدويل
  - توثيق
  - Intlayer
