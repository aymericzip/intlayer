...
## Intlayer i18n Scanner (إضافة Chrome)

تفحص إضافة Chrome **Intlayer i18n Scanner** إعدادات التدويل للصفحة المفتوحة في علامة التبويب الحالية.

- **التحليل المحلي:** عند فتح النافذة المنبثقة للإضافة، تقرأ الصفحة الحالية (سمات اللغة، روابط hreflang، علامات meta، المتغيرات العامة لإطار العمل) مباشرة في متصفحك. لا يتم إرسال محتوى هذه الصفحة إلى خوادمنا.
- **فحص التدقيق:** فقط عند النقر على زر الفحص، يتم إرسال عنوان URL للصفحة الحالية إلى واجهة Intlayer البرمجية (`back.intlayer.org`) لإجراء التدقيق. نحتفظ فقط بـ **اسم النطاق** للصفحة المفحوصة و**النتيجة** التي تم الحصول عليها و**تاريخ** الفحص، لحساب إحصاءات مجمّعة. لا يرتبط هذا السجل بهويتك أو بحساب Intlayer.
- **لا جمع لبيانات أخرى:** لا تجمع الإضافة أي معلومات شخصية أو بيانات مصادقة أو نشاط للمستخدم، ولا تتتبع الصفحات التي تزورها، ولا تستخدم ملفات تعريف الارتباط أو أدوات التحليل، ولا تشغّل أي كود عن بُعد.
