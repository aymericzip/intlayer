...
```typescript fileName="src/app/[locale]/metadata.content.ts" codeFormat="typescript"
...
```javascript fileName="src/app/[locale]/metadata.content.mjs" codeFormat="esm"
import { t } from "intlayer";
...
```javascript fileName="src/app/[locale]/metadata.content.cjs" codeFormat="commonjs"
const { t } = require("intlayer");
