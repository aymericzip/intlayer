...
```typescript fileName="src/pages/[locale]/metadata.content.ts" codeFormat="typescript"
...
```javascript fileName="src/pages/[locale]/metadata.content.mjs" codeFormat="esm"
import { t } from "intlayer";
