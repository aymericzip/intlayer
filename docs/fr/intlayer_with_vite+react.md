# Démarrage avec l'Internationalisation (i18n) avec Intlayer, Vite et React
...
- **vite-intlayer**
  Inclut le plugin Vite pour intégrer Intlayer avec le [bundler Vite](https://vite.dev/guide/why.html#why-bundle-for-production), ainsi qu'un middleware pour détecter la langue préférée de l'utilisateur, gérer les cookies et traiter les redirections d'URL.
...
### Étape 6 à 10 et autres sections

Pour des raisons de longueur, veuillez consulter la version complète traduite du fichier en suivant les mêmes principes et en respectant les instructions données.
