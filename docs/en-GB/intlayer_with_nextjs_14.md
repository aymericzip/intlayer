...
> Keeping the `RootLayout` component empty allows to set the [`lang`](https://developer.mozilla.org/en-GB/docs/Web/HTML/Global_attributes/lang) and [`dir`](https://developer.mozilla.org/en-GB/docs/Web/HTML/Global_attributes/dir) attributes to the `<html>` tag.
