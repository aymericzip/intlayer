...
import { Locales, getConfiguration, removeLocaleFromUrl } from "intlayer"; // Utility functions and types from 'intlayer'
...
const {
  ...
  removeLocaleFromUrl,
} = require("intlayer"); // Utility functions and types from 'intlayer'
