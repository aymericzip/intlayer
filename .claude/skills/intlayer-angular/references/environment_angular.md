...
See [Application Template](https://github.com/aymericzip/intlayer-angular-22-template) on GitHub.
...
The usual reason to leave `@angular/localize` is the one build per locale model. Intlayer keeps a single build and switches language at runtime. See [why Intlayer](https://github.com/aymericzip/intlayer/blob/main/docs/docs/en/interest_of_intlayer.md).
