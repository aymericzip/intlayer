...
- [Sync JSON](references/plugin_sync-json.md)
- [Sync PO](references/plugin_sync-po.md)

### Migration Guides

- [Compat Adapters Overview](references/compatibility.md)
- [i18next](references/compatibility_i18next.md)
- [react-i18next](references/compatibility_react-i18next.md)
- [next-i18next](references/compatibility_next-i18next.md)
- [next-intl](references/compatibility_next-intl.md)
- [React Intl](references/compatibility_react-intl.md)
- [Vue I18n](references/compatibility_vue-i18n.md)
