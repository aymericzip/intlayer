...
const noApplicationURLViewContent = {
  ...
  content: {
    title: t({
      ...
      uk: 'Конфігурація вашого проєкту не містить URL-адреси застосунку',
    }),
    description: t({
      ...
      uk: 'Щоб користуватися CMS, потрібно додати URL-адресу застосунку до конфігураційного файлу.',
    }),
    documentationLink: {
      label: t({
