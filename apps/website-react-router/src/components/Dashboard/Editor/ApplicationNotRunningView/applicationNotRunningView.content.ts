...
const applicationNotRunningViewContent = {
  ...
  content: {
    ...
    title: t({
      ...
      pt: 'Sua aplicação não está accessible',
    ...
    urlLinkLabel: t({
      en: 'Go to the application URL',
      'en-GB': 'Go to the application URL',
      fr: "Aller à l'URL de l'application",
      es: 'Ir a la URL de la aplicación',
      de: 'Gehen Sie zur Anwendungs-URL',
      ja: 'アプリケーションのURLに移動します',
      ko: '앱 URL로 이동',
      zh: '跳转到应用程序 URL',
      pt: 'Ir para a URL da aplicação',
      ru: 'Перейти по URL приложения',
      ar: 'انتقل إلى عنوان الموقع الخاص بالتطبيق',
      hi: 'एप्लिकेशन यूआरएल पर जाएं',
      it: "Vai all'URL dell'applicazione",
      tr: 'Uygulama URL’sine git',
      pl: 'Przejdź do adresu URL aplikacji',
      id: 'Buka URL aplikasi',
      vi: 'Đi đến URL ứng dụng',
      uk: 'Перейти за URL-адресою додатка',
    }),
    tipsTitle: t({
      en: 'Tips:',
      'en-GB': 'Tips:',
