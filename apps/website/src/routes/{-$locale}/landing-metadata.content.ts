...
const metadataContent = {
  ...
  content: {
    title: t({
      en: 'Colocated i18n for React, Next.js, Vue, Svelte | Intlayer',
      'en-GB': 'Colocated i18n for React, Next.js, Vue, Svelte | Intlayer',
      ar: 'تعريب مشترك موضعياً في React وNext.js وVue وSvelte | Intlayer',
      de: 'Kolokalisierte i18n für React, Next.js, Vue, Svelte | Intlayer',
      es: 'i18n colocalizada para React, Next.js, Vue y Svelte | Intlayer',
      fr: 'i18n colocalisée pour React, Next.js, Vue, Svelte | Intlayer',
      hi: 'React, Next.js, Vue, Svelte के लिए सह-स्थित i18n | Intlayer',
      it: 'i18n colocalizzata per React, Next.js, Vue, Svelte | Intlayer',
      ja: 'React、Next.js、Vue、Svelte用のコロケーションi18n | Intlayer',
      ko: 'React, Next.js, Vue, Svelte용 콜로케이션 i18n | Intlayer',
      pt: 'i18n colocalizada para React, Next.js, Vue e Svelte | Intlayer',
      ru: 'Колоцированный i18n для React, Next.js, Vue, Svelte | Intlayer',
      tr: 'React, Next.js, Vue, Svelte için birlikte konumlandırılmış i18n | Intlayer',
      zh: 'React、Next.js、Vue、Svelte 的代码共置 i18n | Intlayer',
      pl: 'i18n kolokowane dla React, Next.js, Vue, Svelte | Intlayer',
      id: 'i18n terkolokasi untuk React, Next.js, Vue, Svelte | Intlayer',
      vi: 'i18n colocate cho React, Next.js, Vue, Svelte | Intlayer',
      uk: 'Колокована інтернаціоналізація (i18n) для React, Next.js, Vue, Svelte | Intlayer',
    }),
