...
const metadataContent = {
  ...
  content: {
    title: t({
      ...
      es: 'i18n por componente para React, Next.js, Vue y Svelte | Intlayer',
      ...
      pt: 'i18n por componente para React, Next.js, Vue e Svelte | Intlayer',
      ...
      uk: 'Інтернаціоналізація (i18n) на рівні компонентів для React, Next.js, Vue, Svelte | Intlayer',
    }),
    ...
    description: t({
      ...
      ja: 'Intlayerでアプリの拡張性を強化：AI搭載의 국제화（i18n）및 콘텐츠 관리 솔루션。React、Next.js、Vue、Svelteなどに対応。',
      ...
      uk: 'Підвищте масштабованість вашого застосунку з Intlayer — рішенням для інтернаціоналізації (i18n) та управління контентом на базі штучного інтелекту. Розроблено для React, Next.js, Vue, Svelte та інших.',
    }),
  ...
  description:
    'Metadata related to the landing page, including SEO fields such as title, description, and keywords. It highlights the internationalization and CMS capabilities of Intlayer.',
  tags: ['page metadata', 'landing page', 'i18n', 'cms', 'seo'],
