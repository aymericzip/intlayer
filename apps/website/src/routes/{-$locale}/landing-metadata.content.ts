...
const metadataContent = {
  ...
  content: {
    title: t({
      en: 'Advanced i18n for React, Next.js, Vue, Svelte | Intlayer',
      'en-GB': 'Advanced i18n for React, Next.js, Vue, Svelte | Intlayer',
      ar: 'تعريب متقدم في React وNext.js وVue وSvelte | Intlayer',
      de: 'Erweiterte i18n für React, Next.js, Vue, Svelte | Intlayer',
      es: 'i18n avanzada para React, Next.js, Vue y Svelte | Intlayer',
      fr: 'i18n avancée pour React, Next.js, Vue, Svelte | Intlayer',
      hi: 'React, Next.js, Vue, Svelte के लिए उन्नत i18n | Intlayer',
      it: 'i18n avanzata per React, Next.js, Vue, Svelte | Intlayer',
      ja: 'React、Next.js、Vue、Svelte用の高度なi18n | Intlayer',
      ko: 'React, Next.js, Vue, Svelte용 고급 i18n | Intlayer',
      pt: 'i18n avançada para React, Next.js, Vue e Svelte | Intlayer',
      ru: 'Продвинутый i18n для React, Next.js, Vue, Svelte | Intlayer',
      tr: 'React, Next.js, Vue, Svelte için gelişmiş i18n | Intlayer',
      zh: 'React、Next.js、Vue、Svelte 的高级 i18n | Intlayer',
      pl: 'Zaawansowane i18n dla React, Next.js, Vue, Svelte | Intlayer',
      id: 'i18n tingkat lanjut untuk React, Next.js, Vue, Svelte | Intlayer',
      vi: 'i18n nâng cao cho React, Next.js, Vue, Svelte | Intlayer',
      uk: 'Розширена інтернаціоналізація (i18n) для React, Next.js, Vue, Svelte | Intlayer',
    }),
