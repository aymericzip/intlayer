...
const metadataContent = {
  ...
  content: {
    title: t({
      en: 'i18n Solution for React, Next.js, Vue, Svelte | Intlayer',
      'en-GB': 'i18n Solution for React, Next.js, Vue, Svelte | Intlayer',
      ar: 'حل i18n مدعوم بالذكاء الاصطناعي لـ React و Next.js و Vue و Svelte | Intlayer',
      de: 'i18n-Lösung für React, Next.js, Vue, Svelte | Intlayer',
      es: 'Solución i18n para React, Next.js, Vue, Svelte | Intlayer',
      fr: 'Solution i18n pour React, Next.js, Vue, Svelte | Intlayer',
      hi: 'React, Next.js, Vue, Svelte के लिए i18n समाधान | Intlayer',
      it: 'Soluzione i18n per React, Next.js, Vue, Svelte | Intlayer',
      ja: 'React、Next.js、Vue、Svelte向け i18n ソリューション | Intlayer',
      ko: 'React, Next.js, Vue, Svelte용 i18n 솔루션 | Intlayer',
      pt: 'Solução i18n para React, Next.js, Vue, Svelte | Intlayer',
      ru: 'Решение i18n для React, Next.js, Vue, Svelte | Intlayer',
      tr: 'React, Next.js, Vue, Svelte için i18n Çözümü | Intlayer',
      zh: 'React、Next.js、Vue、Svelte 的 i18n解决方案 | Intlayer',
      pl: 'Rozwiązanie i18n dla React, Next.js, Vue, Svelte | Intlayer',
      id: 'Solusi i18n untuk React, Next.js, Vue, Svelte | Intlayer',
      vi: 'Giải pháp i18n cho React, Next.js, Vue, Svelte | Intlayer',
    }),
