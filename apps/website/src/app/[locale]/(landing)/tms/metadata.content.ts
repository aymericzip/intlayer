...
const metadataContent = {
  ...
  content: {
    title: t({
      en: 'AI Translation Management System & Open Source Alternative',
      'en-GB': 'AI Translation Management System & Open Source Alternative',
      fr: 'Système de Gestion de Traduction IA & Alternative Open Source',
      es: 'Sistema de Gestión de Traducción IA y Alternativa Open Source',
      de: 'KI-Übersetzungsmanagementsystem & Open-Source-Alternative',
      it: 'Sistema di Gestione Traduzioni IA & Alternativa Open Source',
      pt: 'Sistema de Gestão de Tradução IA e Alternativa Open Source',
      ru: 'AI Система управления переводами и Open Source альтернатива',
      zh: 'AI 翻译管理系统 & 开源替代方案',
      ja: 'AI翻訳管理システム & オープンソースの代替案',
      ar: 'نظام إدارة الترجمة بالذكاء الاصطناعي وبديل مفتوح المصدر',
      hi: 'AI अनुवाद प्रबंधन प्रणाली  और ओपन सोर्स विकल्प',
      ko: 'AI 번역 관리 시스템 & 오픈 소스 대안',
      tr: 'Yapay Zeka Çeviri Yönetim Sistemi ve Açık Kaynak Alternatifi',
      id: 'Sistem Manajemen Terjemahan AI & Alternatif Open Source',
      pl: 'System zarządzania tłumaczeniami AI i alternatywa Open Source',
      vi: 'Hệ thống Quản lý Dịch thuật AI & Giải pháp Thay thế Mã nguồn mở',
    }),
    description: t({
