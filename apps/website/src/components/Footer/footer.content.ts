        ...
        links: [
          ...
          },
          {
            ...
            label: t({
              ...
              'en-GB': 'See Intlayer with react (CRA) documentation',
              fr: 'Voir la documentation de Intlayer avec react (CRA)',
              es: 'Ver documentación de Intlayer con react (CRA)',
              de: 'Siehe Dokumentation zu Intlayer mit React (CRA)',
              ja: 'IntlayerとReact (CRA)のドキュメントを見る',
              ko: 'Intlayer와 React (CRA) 문서 보기',
              zh: '查看Intlayer与React (CRA)文档',
              it: 'Vedi la documentazione di Intlayer con React (CRA)',
              pt: 'Veja a documentação do Intlayer com React (CRA)',
              hi: 'Intlayer के साथ React (CRA) दस्तावेज़ देखें',
              ar: 'قم بمشاهدة توثيق Intlayer مع React (CRA)',
              ru: 'См. документацию Intlayer с React (CRA)',
            }),
          },
          {
            ...
            text: t({
              ...
              'en-GB': 'Intlayer with react and vite',
