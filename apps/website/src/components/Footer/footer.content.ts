...
import { type ContentValue, t, type DeclarationContent } from 'intlayer';
import { PagesRoutes } from '../../Routes';

const content: LinkGroup[] = [
  {
    title: t({
      en: 'Services',
      es: 'Servicios',
...
export const footerContent: DeclarationContent = {
  id: 'footer',
  content: content as unknown as ContentValue,
};
