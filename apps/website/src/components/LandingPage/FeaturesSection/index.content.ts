  ...
  content: [
    ...
    },
    {
      ...
      description: t({
        ...
        fr: "Utilisez l'outil en ligne de commande Intlayer pour tester et compléter votre contenu à l’aide de l’IA et garantir des traductions complètes et précises.",
        es: 'Utiliza la CLI de Intlayer para probar y rellenar tu contenido con IA, asegurando que todas las traducciones estén completas y sean precisas.',
        de: 'Nutzen Sie das Intlayer CLI, um Ihre Inhalte mit KI zu testen und auszufüllen, damit alle Übersetzungen vollständig und korrekt sind.',
        it: 'Usa la CLI di Intlayer per testare e riempire i tuoi contenuti con l’AI, assicurandoti che tutte le traduzioni siano complete e accurate.',
        pt: 'Use a CLI da Intlayer para testar e preencher seu conteúdo com IA, garantindo que todas as traduções estejam completas e precisas.',
        ru: 'Используйте Intlayer CLI для тестирования и автоматического заполнения вашего контента с помощью ИИ, чтобы все переводы были полными и точными.',
        zh: '使用 Intlayer CLI 配合 AI 测试并补全您的内容，确保所有译文都完整准确。',
        ja: 'Intlayer CLI を使って、AI でコンテンツをテストし自動補完し、すべての翻訳が完全かつ正確であることを保証します。',
        ar: 'استخدم أداة Intlayer CLI لاختبار واستكمال المحتوى الخاص بك باستخدام الذكاء الاصطناعي لضمان اكتمال ودقة جميع الترجمات.',
        hi: 'Intlayer CLI का उपयोग करके अपने कंटेंट को AI के माध्यम से परीक्षण और पूर्ण करें, ताकि सभी अनुवाद पूरे और सटीक हों।',
        ko: 'Intlayer CLI와 AI를 사용하여 콘텐츠를 테스트하고 자동으로 채워 모든 번역이 완전하고 정확한지 확인하세요.',
        tr: 'İçeriğinizi test etmek ve doldurmak için Intlayer CLI’yi ve yapay zekâyı kullanarak tüm çevirilerin eksiksiz ve doğru olduğundan emin olun.',
