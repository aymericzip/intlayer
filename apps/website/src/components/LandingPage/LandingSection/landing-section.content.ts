...
const landingSectionContent = {
  ...
  content: {
    ...
    keyPoints: [
      ...
      t({
        en: 'Free AI powered Visual Editor / CMS',
        'en-GB': 'Free AI powered Visual Editor / CMS',
        fr: 'Éditeur visuel / CMS gratuit propulsé par l’IA',
        es: 'Editor visual / CMS gratuito impulsado por IA',
        de: 'Kostenloser KI-gestützter visueller Editor / CMS',
        ja: '無料のAI搭載ビジュアルエディタ / CMS',
        ko: '무료 AI 기반 비주얼 에디터 / CMS',
        zh: '免费AI驱动的可视化编辑器 / CMS',
        it: 'Editor visivo / CMS gratuito basato su IA',
        pt: 'Editor visual / CMS gratuito com IA',
