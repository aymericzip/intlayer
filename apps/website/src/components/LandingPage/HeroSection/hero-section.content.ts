...
const heroSectionContent = {
  ...
  content: {
    ...
    title: t({
      en: 'Intelligent i18n',
      'en-GB': 'Intelligent i18n',
      fr: "L'i18n intelligemment",
      es: 'i18n inteligente',
      de: 'Intelligentes i18n',
      it: 'i18n intelligente',
      pt: 'i18n inteligente',
      ru: 'Интеллектуальная i18n',
      tr: 'Akıllı i18n',
      ja: 'インテリジェントi18n',
      ko: '지능형 i18n',
      zh: '智能 i18n',
      hi: 'स्मार्ट i18n',
      pl: 'Inteligentne i18n',
      id: 'i18n Cerdas',
      vi: 'i18n Thông minh',
      ar: 'i18n ذكي',
      uk: 'Інтелектуальна i18n',
    }),
    subheading: t({
