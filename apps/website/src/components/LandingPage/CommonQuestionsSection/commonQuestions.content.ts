  ...
  content: {
    ...
    content: [
      ...
      },
      {
        ...
        answer: t({
          en: 'Intlayer offers internationalization support, a visual editor, flexible configuration options, CLI tools for project management, and compatibility with other libraries.',
          fr: 'Intlayer offre un support d’internationalisation, un éditeur visuel, des options de configuration flexibles, des outils CLI pour la gestion de projets et une compatibilité avec d’autres bibliothèques.',
          es: 'Intlayer ofrece soporte de internacionalización, un editor visual, opciones de configuración flexibles, herramientas CLI para la gestión de proyectos y compatibilidad con otras bibliotecas.',
        }),
      },
      {
        question: t({
