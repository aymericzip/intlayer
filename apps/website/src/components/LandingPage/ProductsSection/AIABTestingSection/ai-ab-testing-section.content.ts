...
const aiAbTestingSectionContent = {
  ...
  content: {
    betaTag: t({
      ar: 'القسم التجريبي AB قريباً',
      de: 'AB-Testing bald in Beta',
      en: 'AB testing soon in Beta',
      'en-GB': 'AB testing soon in Beta',
      es: 'AB testing próximamente en Beta',
      fr: 'AB testing bientôt en Bêta',
      hi: 'AB testing जल्द ही बीटा में',
      it: 'AB testing presto in Beta',
      ja: 'ABテストがすぐにベータ版',
      ko: 'AB 테스트가 곧 베타 출시',
      pt: 'AB testing em breve em Beta',
      ru: 'AB тестирование вскоре в бета-версии',
      tr: "AB testing yakında Beta'da",
      zh: 'AB测试即将公测',
      pl: 'AB testing wkrótce w wersji beta',
      id: 'AB testing segera dalam Beta',
      vi: 'Kiểm thử AB sắp có bản Beta',
    }),
    title: t({
