...
const availableTechnoContent = {
  ...
  content: {
    ...
    icons: {
      ...
      htmx: {
        label: t({
          en: 'Go to htmx official website',
          'en-GB': 'Go to htmx official website',
          fr: 'Aller sur le site officiel de htmx',
          es: 'Ir al sitio web oficial de htmx',
          de: 'Zur offiziellen htmx-Website gehen',
          ja: 'htmx公式ウェブサイトに行く',
          ko: 'htmx 공식 웹사이트로 이동',
          zh: '前往 htmx 官方网站',
          it: 'Vai al sito ufficiale di htmx',
          pt: 'Ir para o site oficial do htmx',
          hi: 'htmx की आधिकारिक वेबसाइट पर जाएं',
          ar: 'اذهب إلى الموقع الرسمي لـ htmx',
          ru: 'Перейти на официальный сайт htmx',
          tr: 'htmx resmi web sitesine git',
          pl: 'Przejdź do oficjalnej strony htmx',
          id: 'Buka situs resmi htmx',
          vi: 'Truy cập trang web chính thức của htmx',
          uk: 'Перейти на офіційний вебсайт htmx',
        }),
      },
    },
  },
