  ...
  content: {
    ...
    showEarlierMessagesButton: {
      text: t({
        ...
        'en-GB': 'Show earlier messages',
        fr: 'Afficher les messages précédents',
        es: 'Mostrar mensajes anteriores',
        de: 'Frühere Nachrichten anzeigen',
        ja: '以前のメッセージを表示',
        ko: '이전 메시지 보기',
        zh: '显示更早的消息',
        it: 'Mostra i messaggi precedenti',
        pt: 'Mostrar mensagens anteriores',
        hi: 'पिछले संदेश दिखाएं',
        ar: 'عرض الرسائل السابقة',
        ru: 'Показать предыдущие сообщения',
        tr: 'Önceki mesajları göster',
        pl: 'Pokaż wcześniejsze wiadomości',
        id: 'Tampilkan pesan sebelumnya',
        vi: 'Hiển thị tin nhắn trước đó',
        uk: 'Показати попередні повідомлення',
      }),
      label: t({
        en: 'Show the earlier messages of this discussion',
        'en-GB': 'Show the earlier messages of this discussion',
        fr: 'Afficher les messages précédents de cette discussion',
        es: 'Mostrar los mensajes anteriores de esta conversación',
        de: 'Die früheren Nachrichten dieser Unterhaltung anzeigen',
        ja: 'この会話の以前のメッセージを表示する',
        ko: '이 대화의 이전 메시지 보기',
        zh: '显示此对话中更早的消息',
        it: 'Mostra i messaggi precedenti di questa conversazione',
        pt: 'Mostrar as mensagens anteriores desta conversa',
        hi: 'इस चर्चा के पिछले संदेश दिखाएं',
        ar: 'عرض الرسائل السابقة في هذه المحادثة',
        ru: 'Показать предыдущие сообщения этого обсуждения',
        tr: 'Bu sohbetin önceki mesajlarını göster',
        pl: 'Pokaż wcześniejsze wiadomości tej rozmowy',
        id: 'Tampilkan pesan sebelumnya dari percakapan ini',
        vi: 'Hiển thị các tin nhắn trước đó của cuộc trò chuyện này',
        uk: 'Показати попередні повідомлення цього обговорення',
      }),
    },
    disclaimerNote: t({
