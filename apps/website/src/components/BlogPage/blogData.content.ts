...
const blogDataContent: Dictionary = {
  ...
  content: {
    concepts: {
      ...
      subSections: {
        ...
        'per-component-vs-centralized-i18n': {
          title: t({
            en: 'Colocated vs centralized i18n',
            'en-GB': 'Colocated vs centralised i18n',
            fr: 'i18n colocalisée vs centralisée',
            es: 'i18n colocalizada vs centralizada',
            de: 'Kolokalisierte vs. zentralisierte i18n',
            ja: 'コロケーション vs 集中管理の i18n',
            ko: '콜로케이션 vs 중앙집중식 i18n',
            zh: '代码共置 vs 集中式 i18n',
            it: 'i18n colocalizzata vs centralizzata',
            pt: 'i18n colocalizada vs centralizada',
            hi: 'सह-स्थित बनाम केंद्रीकृत i18n',
            ar: 'i18n المشتركة موضعياً مقابل المركزية',
            ru: 'Колоцированная i18n против централизованной',
            tr: 'Birlikte konumlandırılmış vs merkezi i18n',
            pl: 'i18n kolokowana vs scentralizowana',
            id: 'i18n terkolokasi vs terpusat',
            vi: 'i18n colocate vs tập trung',
            uk: 'Колокована i18n проти централізованої',
          }),
          default: getBlogMetadata(
    ...
    'choosing-i18n-library': {
      title: t({
        en: 'Choosing an i18n library',
        'en-GB': 'Choosing an i18n library',
        fr: 'Choisir une bibliothèque i18n',
        es: 'Elegir una biblioteca i18n',
        de: 'Eine i18n-Bibliothek auswählen',
        ja: 'i18n ライブラリの選び方',
        ko: 'i18n 라이브러리 선택하기',
        zh: '选择 i18n 库',
        it: 'Scegliere una libreria i18n',
        pt: 'Escolher uma biblioteca i18n',
        hi: 'i18n लाइब्रेरी चुनना',
        ar: 'اختيار مكتبة i18n',
        ru: 'Выбор i18n-библиотеки',
        tr: 'Bir i18n kütüphanesi seçmek',
        pl: 'Wybór biblioteki i18n',
        id: 'Memilih library i18n',
        vi: 'Chọn thư viện i18n',
        uk: 'Вибір i18n-бібліотеки',
      }),
      subSections: {
        react: {
          title: t({
            en: 'Choosing React i18n libraries',
            'en-GB': 'Choosing React i18n libraries',
            fr: 'Choisir des bibliothèques i18n pour React',
            es: 'Elegir bibliotecas i18n para React',
            de: 'React i18n-Bibliotheken auswählen',
            ja: 'React の i18n ライブラリを選ぶ',
            ko: 'React i18n 라이브러리 선택',
            zh: '选择 React i18n 库',
            it: 'Scegliere le librerie i18n per React',
            pt: 'Escolher bibliotecas i18n para React',
            hi: 'React i18n लाइब्रेरी चुनना',
            ar: 'اختيار مكتبات i18n لـ React',
            ru: 'Выбор i18n-библиотек для React',
            tr: 'React i18n kütüphanelerini seçme',
            pl: 'Wybór bibliotek i18n dla React',
            id: 'Memilih library i18n React',
            vi: 'Chọn thư viện i18n cho React',
            uk: 'Вибір i18n-бібліотек для React',
          }),
          default: getBlogMetadata(
        ...
        vue: {
          title: t({
            en: 'Choosing Vue i18n libraries',
            'en-GB': 'Choosing Vue i18n libraries',
            fr: 'Choisir des bibliothèques i18n pour Vue',
            es: 'Elegir bibliotecas i18n para Vue',
            de: 'Vue i18n-Bibliotheken auswählen',
            ja: 'Vue の i18n ライブラリを選ぶ',
            ko: 'Vue i18n 라이브러리 선택',
            zh: '选择 Vue i18n 库',
            it: 'Scegliere le librerie i18n per Vue',
            pt: 'Escolher bibliotecas i18n para Vue',
            hi: 'Vue i18n लाइब्रेरी चुनना',
            ar: 'اختيار مكتبات i18n لـ Vue',
            ru: 'Выбор i18n-библиотек для Vue',
            tr: 'Vue i18n kütüphanelerini seçme',
            pl: 'Wybór bibliotek i18n dla Vue',
            id: 'Memilih library i18n Vue',
            vi: 'Chọn thư viện i18n cho Vue',
            uk: 'Вибір i18n-бібліотек для Vue',
          }),
          default: getBlogMetadata('./blog/en/how_to_pick_vue_i18n_library.md'),
          frameworks: ['vue'],
        },
        svelte: {
          title: t({
            en: 'Choosing Svelte i18n libraries',
            'en-GB': 'Choosing Svelte i18n libraries',
            fr: 'Choisir des bibliothèques i18n pour Svelte',
            es: 'Elegir bibliotecas i18n para Svelte',
            de: 'Svelte i18n-Bibliotheken auswählen',
            ja: 'Svelte の i18n ライブラリを選ぶ',
            ko: 'Svelte i18n 라이브러리 선택',
            zh: '选择 Svelte i18n 库',
            it: 'Scegliere le librerie i18n per Svelte',
            pt: 'Escolher bibliotecas i18n para Svelte',
            hi: 'Svelte i18n लाइब्रेरी चुनना',
            ar: 'اختيار مكتبات i18n لـ Svelte',
            ru: 'Выбор i18n-библиотек для Svelte',
            tr: 'Svelte i18n kütüphanelerini seçme',
            pl: 'Wybór bibliotek i18n dla Svelte',
            id: 'Memilih library i18n Svelte',
            vi: 'Chọn thư viện i18n cho Svelte',
            uk: 'Вибір i18n-бібліотек для Svelte',
          }),
          default: getBlogMetadata(
        ...
        solid: {
          title: t({
            en: 'Choosing Solid i18n libraries',
            'en-GB': 'Choosing Solid i18n libraries',
            fr: 'Choisir des bibliothèques i18n pour Solid',
            es: 'Elegir bibliotecas i18n para Solid',
            de: 'Solid i18n-Bibliotheken auswählen',
            ja: 'Solid の i18n ライブラリを選ぶ',
            ko: 'Solid i18n 라이브러리 선택',
            zh: '选择 Solid i18n 库',
            it: 'Scegliere le librerie i18n per Solid',
            pt: 'Escolher bibliotecas i18n para Solid',
            hi: 'Solid i18n लाइब्रेरी चुनना',
            ar: 'اختيار مكتبات i18n لـ Solid',
            ru: 'Выбор i18n-библиотек для Solid',
            tr: 'Solid i18n kütüphanelerini seçme',
            pl: 'Wybór bibliotek i18n dla Solid',
            id: 'Memilih library i18n Solid',
            vi: 'Chọn thư viện i18n cho Solid',
            uk: 'Вибір i18n-бібліотек для Solid',
          }),
          default: getBlogMetadata(
        ...
        'libraries-by-framework': {
          title: t({
            en: 'Libraries by framework',
            'en-GB': 'Libraries by framework',
            fr: 'Bibliothèques par framework',
            es: 'Bibliotecas por framework',
            de: 'Bibliotheken nach Framework',
            ja: 'フレームワーク別ライブラリ',
            ko: '프레임워크별 라이브러리',
            zh: '按框架分类的库',
            it: 'Librerie per framework',
            pt: 'Bibliotecas por framework',
            hi: 'फ्रेमवर्क के अनुसार लाइब्रेरी',
            ar: 'المكتبات حسب الإطار',
            ru: 'Библиотеки по фреймворкам',
            tr: "Framework'e göre kütüphaneler",
            pl: 'Biblioteki według frameworka',
            id: 'Library berdasarkan framework',
            vi: 'Thư viện theo framework',
            uk: 'Бібліотеки за фреймворком',
          }),
          subSections: {
            nextjs: {
              title: 'Next.js',
