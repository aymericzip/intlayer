  ...
  content: {
    ...
    roleLabels: {
      ...
      org_admin: t({
        ...
        'en-GB': 'Organisation Admin',
        de: 'Organisations-Administrator',
        ja: '組織管理者',
        ko: '조직 관리자',
        zh: '组织管理员',
        it: 'Amministratore organizzazione',
        pt: 'Administrador de organização',
        hi: 'संगठन व्यवस्थापक',
        ar: 'مسؤول المنظمة',
        ru: 'Администратор организации',
        tr: 'Organizasyon Yöneticisi',
      }),
      org_user: t({
        en: 'Organization User',
        fr: "Utilisateur d'organisation",
        es: 'Usuario de organización',
        'en-GB': 'Organisation User',
        de: 'Organisations-Benutzer',
        ja: '組織ユーザー',
        ko: '조직 사용자',
        zh: '组织用户',
        it: 'Utente organizzazione',
        pt: 'Usuário de organização',
        hi: 'संगठन उपयोगकर्ता',
        ar: 'مستخدم المنظمة',
        ru: 'Пользователь организации',
        tr: 'Organizasyon Kullanıcısı',
      }),
      project_admin: t({
        en: 'Project Admin',
        fr: 'Administrateur de projet',
        es: 'Administrador de proyecto',
        'en-GB': 'Project Admin',
        de: 'Projekt-Administrator',
        ja: 'プロジェクト管理者',
        ko: '프로젝트 관리자',
        zh: '项目管理员',
        it: 'Amministratore progetto',
        pt: 'Administrador de projeto',
        hi: 'परियोजना व्यवस्थापक',
        ar: 'مسؤول المشروع',
      ...
      project_user: t({
        en: 'Project User',
        fr: 'Utilisateur de projet',
        es: 'Usuario de proyecto',
        'en-GB': 'Project User',
        de: 'Projekt-Benutzer',
        ja: 'プロジェクトユーザー',
        ko: '프로젝트 사용자',
        zh: '项目用户',
        it: 'Utente progetto',
        pt: 'Usuário de projeto',
        hi: 'परियोजना उपयोगकर्ता',
        ar: 'مستخدم المشروع',
        ru: 'Пользователь проекта',
        tr: 'Proje Kullanıcısı',
      }),
      project_reviewer: t({
        en: 'Project Reviewer',
        fr: 'Réviseur de projet',
        es: 'Revisor de proyecto',
        'en-GB': 'Project Reviewer',
        de: 'Projekt-Prüfer',
        ja: 'プロジェクトレビュアー',
        ko: '프로젝트 검토자',
        zh: '项目审查员',
        it: 'Revisore progetto',
        pt: 'Revisor de projeto',
        hi: 'परियोजना समीक्षक',
        ar: 'مراجع المشروع',
        ru: 'Рецензент проекта',
        tr: 'Proje Gözden Geçireni',
      }),
    },
    formValidation: {
      nameRequired: t({
...
export default userDetailPageContent;
