          ...
          >
            {painPoints.map((point) => (
              <motion.div
                key={point.id}
                {...staggerItem}
                className="relative overflow-hidden rounded-3xl border border-neutral-200 bg-background p-8 transition-all hover:shadow-lg dark:border-neutral-800"
              >
          ...
          >
            {features.map((feature) => (
              <motion.div
                key={feature.id}
                {...staggerItem}
                className="group flex flex-col gap-4 rounded-2xl border border-neutral-200 bg-background p-8 transition-all hover:border-neutral-300 hover:shadow-md dark:border-neutral-800 dark:hover:border-neutral-700"
              >
                <div className="flex size-12 items-center justify-center rounded-xl bg-neutral-100 text-neutral-700 transition-colors group-hover:bg-primary/10 group-hover:text-primary dark:bg-neutral-800 dark:text-neutral-300 dark:group-hover:bg-primary/20">
