...
import { AppRoutes, ExternalLinks, PagesRoutes } from '@/Routes';
    ...
    sections: [
      ...
      },
      {
        ...
        label: t({
          ...
          es: 'Ver proyectos de Intlayer',
          'en-GB': 'View Intlayer projects',
          de: 'Intlayer-Projekte ansehen',
          ja: 'Intlayerプロジェクトを表示',
          ko: 'Intlayer 프로젝트 보기',
          zh: '查看 Intlayer 项目',
          it: 'Visualizza i progetti Intlayer',
          pt: 'Ver projetos Intlayer',
          hi: 'Intlayer प्रोजेक्ट्स देखें',
          ar: 'عرض مشاريع Intlayer',
          ru: 'Посмотреть проекты Intlayer',
          tr: 'Intlayer projelerini görüntüle',
          pl: 'Zobacz projekty Intlayer',
          id: 'Lihat proyek Intlayer',
          vi: 'Xem các dự án Intlayer',
          uk: 'Переглянути проекти Intlayer',
        }),
      },
      {
        id: 'dashboard',
