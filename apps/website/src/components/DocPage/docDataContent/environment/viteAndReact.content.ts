...
const docContent = {
  ...
  content: {
    ...
    title: t({
      en: 'Translate your Vite and React website (i18n)',
      fr: 'Traduire votre site web Vite et React (i18n)',
      es: 'Traduce su sitio web Vite y React (i18n)',
      'en-GB': 'Translate your Vite and React website (i18n)',
      de: 'Übersetzen Sie Ihre Vite und React-Website (i18n)',
      ja: 'ViteとReactのウェブサイトを翻訳する (i18n)',
      ko: 'Vite와 React의 웹사이트를 번역하십시오 (i18n)',
      zh: '翻译你的Vite和React网站 (i18n)',
      it: 'Traduci il tuo sito web Vite e React (i18n)',
      pt: 'Traduza o seu site Vite e React (i18n)',
      hi: 'Vite और React के वेबसाइट को अनुवाद करें (i18n)',
      ar: 'ترجم موقعك الإلكتروني Vite و React (i18n)',
      ru: 'Переведите свой сайт Vite и React (i18n)',
    }),
