...
const docContent = {
  ...
  content: {
    title: t({
      en: 'Translate your Angular website',
      fr: 'Traduire votre site web Angular',
      es: 'Traduce su sitio web Angular',
      'en-GB': 'Translate your Angular website',
      de: 'Übersetzen Sie Ihre Angular-Website',
      ja: 'Angularのウェブサイトを翻訳する',
      ko: 'Angular의 웹사이트를 번역하십시오',
      zh: '翻译你的Angular网站',
      it: 'Traduci il tuo sito web Angular',
      pt: 'Traduza o seu site Angular',
      hi: 'Angular के वेबसाइट को अनुवाद करें',
      ar: 'ترجم موقعك الإلكتروني Angular',
      ru: 'Переведите свой сайт Angular',
    }),
