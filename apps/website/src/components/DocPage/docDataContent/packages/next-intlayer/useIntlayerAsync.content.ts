...
const docContent = {
  key: 'doc-useIntlayerAsync-next-intlayer-metadata',
  content: {
    title: t({
      en: 'useIntlayerAsync Hook Documentation | next-intlayer',
      'en-GB': 'useIntlayerAsync Hook Documentation | next-intlayer',
      fr: 'Documentation du hook useIntlayerAsync | next-intlayer',
      es: 'Documentación del hook useIntlayerAsync | next-intlayer',
      de: 'Dokumentation des useIntlayerAsync Hooks | next-intlayer',
      ja: 'useIntlayerAsyncフックのドキュメント | next-intlayer',
      ko: 'useIntlayerAsync 훅 설명서 | next-intlayer',
      zh: 'useIntlayerAsync钩子文档 | next-intlayer',
      it: 'Documentazione del hook useIntlayerAsync | next-intlayer',
      pt: 'Documentação do hook useIntlayerAsync | next-intlayer',
      hi: 'useIntlayerAsync हुक दस्तावेज | next-intlayer',
      ar: 'وثائق خطاف useIntlayerAsync | next-intlayer',
      ru: 'Документация по хуку useIntlayerAsync | next-intlayer',
    }),
