      ...
      subSections: {
        nextjs: {
          ...
          subSections: {
            cloudflare: {
              title: t({
                en: 'Cloudflare (OpenNext)',
                fr: 'Cloudflare (OpenNext)',
                es: 'Cloudflare (OpenNext)',
                'en-GB': 'Cloudflare (OpenNext)',
                de: 'Cloudflare (OpenNext)',
                ja: 'Cloudflare (OpenNext)',
                ko: 'Cloudflare (OpenNext)',
                zh: 'Cloudflare (OpenNext)',
                it: 'Cloudflare (OpenNext)',
                pt: 'Cloudflare (OpenNext)',
                hi: 'Cloudflare (OpenNext)',
                ar: 'Cloudflare (OpenNext)',
                uk: 'Cloudflare (OpenNext)',
                ru: 'Cloudflare (OpenNext)',
                tr: 'Cloudflare (OpenNext)',
                pl: 'Cloudflare (OpenNext)',
                id: 'Cloudflare (OpenNext)',
                vi: 'Cloudflare (OpenNext)',
              }),
              default: getDocMetadata('./docs/en/deployment/cloudflare-opennext.md'),
            },
            15: {
              title: 'Next.js 15',
