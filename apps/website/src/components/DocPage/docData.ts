        ...
        content_declaration: {
          ...
          subSections: {
            ...
            declaration_watching: {
              ...
              default: {
                docName: 'content_declaration__declaration_watching',
                url: PagesRoutes.Doc_ContentDeclaration_DeclarationWatching,
                githubUrl: GithubRoutes.ContentDeclaration_DeclarationWatching,
                title: t({
                  en: 'Declaration file watching',
                  fr: 'Actualisation des changements des fichiers de déclaration',
                  es: 'Actualización de los cambios en los archivos de declaración',
                }),
                description: t({
