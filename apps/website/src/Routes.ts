export enum PagesRoutes {
  ...
  Doc_ContentDeclaration_Markdown = '/doc/concept/content/markdown',
  Doc_ContentDeclaration_Nesting = '/doc/concept/content/nesting',
  Doc_ContentDeclaration_Condition = '/doc/concept/content/condition',
...
export enum GithubRoutes {
  ...
  ContentDeclaration_GetStarted = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/dictionary/get_started.md',
  ContentDeclaration_ContentExtensionCustomization = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/dictionary/content_extention_customization.md',
  ContentDeclaration_Enumeration = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/dictionary/enumeration.md',
  ContentDeclaration_FunctionFetching = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/dictionary/function_fetching.md',
  ContentDeclaration_Translation = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/dictionary/translation.md',
  ContentDeclaration_Markdown = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/dictionary/markdown.md',
  ContentDeclaration_Nesting = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/dictionary/nesting.md',
  ContentDeclaration_Condition = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/dictionary/condition.md',
