...
export enum GithubRoutes {
  ...
  ContentDeclaration_GetStarted = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/content/get_started.md',
  ContentDeclaration_ContentExtensionCustomization = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/content/content_extention_customization.md',
  ContentDeclaration_Enumeration = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/content/enumeration.md',
  ContentDeclaration_FunctionFetching = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/content/function_fetching.md',
  ContentDeclaration_Translation = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/content/translation.md',
