export enum PagesRoutes {
  ...
  Doc_Dictionary_PerLocaleFile = '/doc/concept/content/per-locale-file',
...
export enum GithubRoutes {
  ...
  Dictionary_PerLocaleFile = 'https://github.com/aymericzip/intlayer/blob/main/docs/en/dictionary/per-locale-file.md',
