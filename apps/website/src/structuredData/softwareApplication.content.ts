...
export default {
  ...
  content: {
    ...
    description: t({
      ...
      uk: 'i18n для Next.js і React. Легко створюйте багатомовні сайти за допомогою візуального редактора перекладів на базі ШІ. Інтернаціоналізація для TypeScript.',
    }),
    keywords: t<string[]>({
      en: [
        'translation',
