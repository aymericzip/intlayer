...
export const staticSitemapEntries: Omit<SitemapUrlEntry, 'lastmod'>[] = [
  ...
  { path: Website_ICUFormatter_Path, changefreq: 'monthly', priority: 0.8 },
  { path: Website_I18nextFormatter_Path, changefreq: 'monthly', priority: 0.8 },
  { path: Website_VueI18nFormatter_Path, changefreq: 'monthly', priority: 0.8 },
  { path: Website_POFormatter_Path, changefreq: 'monthly', priority: 0.8 },
  {
