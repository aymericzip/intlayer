...
export type TranslatorApprovedEmailProps = {
  username: string;
  dashboardLink: string;
};

export const TranslatorApprovedEmailEN = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
  const previewText = `Your Intlayer translator profile has been approved!`;
      ...
      <Tailwind>
        <Body className="m-auto px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[465px] rounded-xl border border-[#eaeaea] border-solid bg-white p-[20px]">
            ...
            <Text className="text-[14px] text-black leading-[24px]">
              Great news! Your translator profile on <strong>Intlayer</strong>{' '}
...
export const TranslatorApprovedEmailFR = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailES = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailRU = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailJA = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailKO = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailZH = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailDE = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailAR = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailIT = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailEN_GB = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
  const previewText = `Your Intlayer translator profile has been approved!`;
...
export const TranslatorApprovedEmailPT = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailHI = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailTR = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailPL = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailID = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailVI = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
...
export const TranslatorApprovedEmailUK = ({
  username,
  dashboardLink,
}: TranslatorApprovedEmailProps) => {
