      ...
      <div className="mt-auto px-4 pb-4">
        <div className="flex items-end justify-between gap-2">
          <div className="flex min-w-0 flex-wrap gap-1.5">
            <div className="h-4 w-16 animate-pulse bg-neutral/20" />
            <div className="h-4 w-12 animate-pulse bg-neutral/20" />
          </div>
          <div className="flex shrink-0 items-center gap-1">
            <div className="inline-flex items-center justify-center rounded-xl p-1.5 ring-0">
              <div className="size-3 animate-pulse rounded-full bg-neutral/30" />
            </div>
            <span className="min-w-6 text-center font-medium text-sm text-transparent">
              <div className="mx-auto h-4 w-2 animate-pulse bg-neutral/20" />
            </span>
            <div className="inline-flex items-center justify-center rounded-xl p-1.5 ring-0">
              <div className="size-3 animate-pulse rounded-full bg-neutral/30" />
            </div>
