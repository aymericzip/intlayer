  ...
  content: {
    ...
    metadata: {
      ...
      description: t({
        ...
        hi: 'Intlayer डैशボード में अपनी परियोजना की सेटिंग्स प्रबंधित करें। परियोजना के विवरण अपडेट करें, विन्यास समायोजित करें, और अपनी टीम के साथ सहयोग करें।',
