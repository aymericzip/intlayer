...
const editorDashboardContent = {
  ...
  title: 'Editor dashboard page content',
  description:
    'Metadata for the editor section of the dashboard, used for SEO and page identification within the Intlayer CMS.',
  tags: ['page metadata', 'editor', 'dashboard'],
} satisfies Dictionary;

export default editorDashboardContent;
