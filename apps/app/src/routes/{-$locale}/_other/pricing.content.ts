...
const pricingContent = {
  ...
  content: {
    metadata: {
      ...
      description: t({
        ...
        pt: 'Descubra nossos planos de preços e tenha acesso a recursos premium com o Intlayer. Escolha o plan que melhor se adequa a você.',
  ...
  description:
    'Metadata for the pricing page, including title, description, and keywords to support SEO and multilingual optimization.',
  tags: ['pricing', 'page metadata'],
