...
import { ExternalLinks, LandingRoutes } from '../../Routes';
    ...
    content: [
      {
        ...
        links: [
          ...
          {
            href: LandingRoutes.Doc_Environment_NextJS_15,
            text: t({
          ...
          {
            href: LandingRoutes.Doc_Environment_ViteAndReact,
            text: t({
          ...
          {
            href: LandingRoutes.Doc_Environment_ViteAndVue,
            text: t({
