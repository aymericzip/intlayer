...
const noApplicationURLViewContent = {
  ...
  content: {
    title: t({
      en: 'Your project configuration does not include an application URL',
      'en-GB': 'Your project configuration does not include an application URL',
    ...
    description: t({
      ...
      hi: 'CMS का उपयोग करने के लिए, आपको कॉन्फ़िगरेशन फ़ाइल में ऐप का URL जोड़ना होगा।',
    ...
    documentationLink: {
      label: t({
        ...
        hi: 'क्या आप CMS के दस्तावेज़ पर जाना चाहते हैं?',
      ...
      text: t({
        ...
        hi: 'CMS को कॉन्फ़िगर करने का तरीका देखें',
