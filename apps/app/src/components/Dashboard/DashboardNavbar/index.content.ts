...
const dashboardNavbarContent = {
  ...
  content: {
    ...
    environmentTrigger: {
      label: t({
        en: 'Click to select an environment',
        fr: 'Cliquez pour sélectionner un environnement',
        es: 'Haga clic para seleccionar un entorno',
        'en-GB': 'Click to select an environment',
        de: 'Klicken Sie, um eine Umgebung auszuwählen',
        ja: '環境を選択するにはクリックしてください',
        ko: '환경 선택을 클릭하세요',
        zh: '点击选择环境',
        it: 'Clicca per selezionare un ambiente',
        pt: 'Clique para selecionar um ambiente',
        hi: 'पर्यावरण चुनने के लिए क्लिक करें',
        ar: 'انقر لتحديد البيئة',
        ru: 'Нажмите, чтобы выбрать окружение',
        tr: 'Ortam seçmek için tıklayın',
        pl: 'Kliknij, aby wybrać środowisko',
        id: 'Klik untuk memilih lingkungan',
        vi: 'Nhấp để chọn môi trường',
        uk: 'Натисніть, щоб вибрати оточення',
      }),
    },
    switchEnvironment: t({
      en: 'Switch environment',
      fr: "Changer d'environnement",
      es: 'Cambiar de entorno',
      'en-GB': 'Switch environment',
      de: 'Umgebung wechseln',
      ja: '環境を切り替える',
      ko: '환경 전환',
      zh: '切换环境',
      it: 'Cambia ambiente',
      pt: 'Mudar de ambiente',
      hi: 'पर्यावरण बदलें',
      ar: 'تبديل البيئة',
      ru: 'Переключить окружение',
      tr: 'Ortam değiştir',
      pl: 'Przełącz środowisko',
      id: 'Alihkan lingkungan',
      vi: 'Chuyển đổi môi trường',
      uk: 'Змінити оточення',
    }),
    defaultEnv: t({
      en: 'default',
