...
const accessKeyFormContent = {
  ...
  content: {
    ...
    description: t({
      ...
      hi: 'पहुँच कुंजी आपकी परियोजना को प्रमाणित करने के लिए उपयोग किया जाता है।',
    ...
    tuto: [
      ...
      t({
        ...
        id: '2 - Salin access key ke file konfigurasi intlayer Anda',
    ...
    selectThisKey: t({
      en: 'Select this key',
      ru: 'Выберите этот ключ',
      ja: 'このキーを選択',
      fr: 'Sélectionnez cette clé',
      ko: '이 키를 선택하세요',
      zh: '选择此密钥',
      es: 'Seleccionar esta clave',
      de: 'Diesen Schlüssel auswählen',
      ar: 'اختر هذا المفتاح',
      it: 'Seleziona questa chiave',
      'en-GB': 'Select this key',
      pt: 'Selecione esta chave',
      hi: 'इस कुंजी का चयन करें',
      tr: 'Bu anahtarı seçin',
      pl: 'Wybierz ten klucz',
      id: 'Pilih kunci ini',
      vi: 'Chọn khóa này',
      uk: 'Виберіть цей ключ',
    }),
  ...
  description:
    'Content declaration for managing access keys within a project, including creation, deletion, and permission levels. Provides labels, modals, and security warnings for secure authentication integration with the Intlayer configuration.',
  tags: [
    'authentication',
    'project settings',
    'access control',
