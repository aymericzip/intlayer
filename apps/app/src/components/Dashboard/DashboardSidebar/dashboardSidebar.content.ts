...
const dashboardSidebarContent = {
  ...
  content: {
    ...
    navigation: {
      ...
      adminUsers: {
        label: t({
          en: 'Go to admin users',
          'en-GB': 'Go to admin users',
          fr: 'Aller sur les utilisateurs admin',
          es: 'Ir a los usuarios admin',
          de: 'Gehen Sie zu Admin-Benutzern',
          ja: '管理者ユーザーに行く',
          ko: '관리자 사용자로 이동',
          zh: '转到管理员用户',
          it: 'Vai agli utenti admin',
          pt: 'Ir para os usuários admin',
          hi: 'एडमिन उपयोगकर्ताओं पर जाएं',
          ar: 'اذهب إلى مستخدمي المشرف',
          ru: 'Перейти к пользователям администратора',
          tr: 'Admin kullanıcılarına git',
          pl: 'Przejdź do użytkowników administracyjnych',
          id: 'Buka pengguna admin',
          vi: 'Đi tới người dùng quản trị',
          uk: 'Перейти до користувачів адміністратора',
        }),
        title: t({
          en: 'Users',
          'en-GB': 'Users',
      ...
      adminProjects: {
        label: t({
          en: 'Go to admin projects',
          'en-GB': 'Go to admin projects',
          fr: 'Aller sur les projets admin',
          es: 'Ir a los proyectos admin',
          de: 'Gehen Sie zu Admin-Projekten',
          ja: '管理者プロジェクトに行く',
          ko: '관리자 프로젝트로 이동',
          zh: '转到管理员项目',
          it: 'Vai ai progetti admin',
          pt: 'Ir para os projetos admin',
          hi: 'एडमिन परियोजनाओं पर जाएं',
          ar: 'اذهب إلى مشاريع المشرف',
          ru: 'Перейти к проектам администратора',
          tr: 'Admin projelerine git',
          pl: 'Przejdź do projektów administracyjnych',
          id: 'Buka proyek admin',
          vi: 'Đi tới dự án quản trị',
          uk: 'Перейти до проєктів адміністратора',
        }),
        title: t({
          en: 'Projects',
          'en-GB': 'Projects',
      ...
      adminDiscussions: {
        label: t({
          en: 'Go to admin discussions',
          'en-GB': 'Go to admin discussions',
          fr: 'Aller sur les discussions admin',
          es: 'Ir a las discusiones admin',
          de: 'Gehen Sie zu Admin-Diskussionen',
          ja: '管理者ディスカッションに行く',
          ko: '관리자 토론으로 이동',
          zh: '转到管理员讨论',
          it: 'Vai alle discussioni admin',
          pt: 'Ir para as discussões admin',
          hi: 'एडमिन चर्चाओं पर जाएं',
          ar: 'اذهب إلى مناقشات المشرف',
          ru: 'Перейти к обсуждениям администратора',
          tr: 'Admin tartışmalarına git',
          pl: 'Przejdź do dyskusji administracyjnych',
          id: 'Buka diskusi admin',
          vi: 'Đi tới thảo luận quản trị',
          uk: 'Перейти до обговорень адміністратора',
        }),
        title: t({
          en: 'Discussions',
          'en-GB': 'Discussions',
      ...
      adminOrganizations: {
        label: t({
          en: 'Go to admin organizations',
          'en-GB': 'Go to admin organizations',
          fr: 'Aller sur les organisations admin',
          es: 'Ir a las organizaciones admin',
          de: 'Gehen Sie zu Admin-Organisationen',
          ja: '管理者組織に行く',
          ko: '관리자 조직으로 이동',
          zh: '转到管理员组织',
          it: 'Vai alle organizzazioni admin',
          pt: 'Ir para as organizações admin',
          hi: 'एडमिन संगठनों पर जाएं',
          ar: 'اذهب إلى مؤسسات المشرف',
          ru: 'Перейти к организациям администратора',
          tr: 'Admin organizasyonlarına git',
          pl: 'Przejdź do organizacji administracyjnych',
          id: 'Buka organisasi admin',
          vi: 'Đi tới tổ chức quản trị',
          uk: 'Перейти до організацій адміністратора',
        }),
        title: t({
          en: 'Organizations',
          'en-GB': 'Organizations',
