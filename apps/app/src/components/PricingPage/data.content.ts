...
const pricingContent = {
  ...
  content: {
    ...
    /**
     * Labels displayed on the period switch selector tabs.
     * "yearly" shows "Annually" to clarify the billing cycle,
     * while priceFrequency.yearly stays "Monthly" (prices shown as monthly equivalents).
     */
    periodSwitchLabel: {
      monthly: t({
        en: 'Monthly',
