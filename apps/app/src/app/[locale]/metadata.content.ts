...
const metadataContent = {
  ...
  content: {
    title: t({
      en: 'i18n Solution & CMS for React, Next.js, Vue, Svelte | Intlayer',
      'en-GB': 'i18n Solution & CMS for React, Next.js, Vue, Svelte | Intlayer',
      ar: 'حل i18n و CMS مدعوم بالذكاء الاصطناعي لـ React و Next.js و Vue و Svelte | Intlayer',
      de: 'i18n-Lösung & KI-CMS für React, Next.js, Vue, Svelte | Intlayer',
      es: 'Solución i18n y CMS para React, Next.js, Vue, Svelte | Intlayer',
      fr: 'Solution i18n & CMS pour React, Next.js, Vue, Svelte | Intlayer',
      hi: 'React, Next.js, Vue, Svelte के लिए i18n समाधान और CMS | Intlayer',
      it: 'Soluzione i18n e CMS per React, Next.js, Vue, Svelte | Intlayer',
      ja: 'React、Next.js、Vue、Svelte向け i18n CMS | Intlayer',
      ko: 'React, Next.js, Vue, Svelte용 i18n 솔루션 및 CMS | Intlayer',
      pt: 'Solução i18n e CMS para React, Next.js, Vue, Svelte | Intlayer',
      ru: 'Решение i18n и CMS для React, Next.js, Vue, Svelte | Intlayer',
      tr: 'React, Next.js, Vue, Svelte için i18n Çözümü ve CMS | Intlayer',
      zh: 'React、Next.js、Vue、Svelte 的 i18n解决方案 CMS | Intlayer',
