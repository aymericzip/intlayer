 ...
 * on that prefix at runtime — the RPC base is `/_serverFn/` — and anything the
 * prerender writes under it reaches the public directory after Nitro has baked
 * its asset manifest, which makes this handler the only one able to serve it.
 */
