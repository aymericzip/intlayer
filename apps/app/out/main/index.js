// -- CommonJS Shims --
import __cjs_mod__, { createRequire } from 'node:module';
import os from 'node:os';
import { join, join as join$1 } from 'node:path';
...
var require_stat = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function checkParentPaths(src, srcStat, dest, funcName, cb) {
    ...
    if (
      ...
      destParent === path$21.parse(destParent).root
    )
      return cb();
  ...
  function isSrcSubdir(src, dest) {
    const srcArr = path$21
      .resolve(src)
      .split(path$21.sep)
      .filter((i) => i);
    const destArr = path$21
      .resolve(dest)
      .split(path$21.sep)
      .filter((i) => i);
...
var require_copy$1 = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function getStats(destStat, src, dest, opts, cb) {
    (opts.dereference ? fs.stat : fs.lstat)(src, (err, srcStat) => {
      ...
      if (srcStat.isDirectory())
        ...
        return cb(
          /* @__PURE__ */ new Error(`Cannot copy a socket file: ${src}`)
        );
      else if (srcStat.isFIFO())
        return cb(/* @__PURE__ */ new Error(`Cannot copy a FIFO pipe: ${src}`));
  ...
  function mayCopyFile(srcStat, src, dest, opts, cb) {
    if (opts.overwrite)
      ...
      return cb(/* @__PURE__ */ new Error(`'${dest}' already exists`));
    else return cb();
  }
  ...
  function onLink(destStat, src, dest, opts, cb) {
    fs.readlink(src, (err, resolvedSrc) => {
      if (err) return cb(err);
      if (opts.dereference)
        resolvedSrc = path$20.resolve(process.cwd(), resolvedSrc);
      if (!destStat) return fs.symlink(resolvedSrc, dest, cb);
        ...
        fs.readlink(dest, (err, resolvedDest) => {
          ...
          if (opts.dereference)
            resolvedDest = path$20.resolve(process.cwd(), resolvedDest);
...
var require_copy_sync = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function onLink(destStat, src, dest, opts) {
    ...
    if (opts.dereference)
      resolvedSrc = path$19.resolve(process.cwd(), resolvedSrc);
    if (!destStat) return fs.symlinkSync(resolvedSrc, dest);
      ...
      if (opts.dereference)
        resolvedDest = path$19.resolve(process.cwd(), resolvedDest);
      if (stat.isSrcSubdir(resolvedSrc, resolvedDest))
        throw new Error(
          `Cannot copy '${resolvedSrc}' to a subdirectory of itself, '${resolvedDest}'.`
        );
...
var require_rimraf = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function rmkidsSync(p, options) {
    ...
    options
      .readdirSync(p)
      .forEach((f) => rimrafSync(path$18.join(p, f), options));
    if (isWindows) {
...
var require_empty = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  var emptyDir = u(async function emptyDir(dir) {
    ...
    return Promise.all(
      items.map((item) => remove.remove(path$17.join(dir, item)))
    );
  });
...
function hasFlag(
  flag,
  argv = globalThis.Deno ? globalThis.Deno.args : process$1.argv
) {
...
var require_ProgressCallbackTransform = /* @__PURE__ */ __commonJSMin(
  (exports) => {
    Object.defineProperty(exports, '__esModule', { value: true });
...
var require_httpExecutor = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.HttpExecutor = class HttpExecutor {
    ...
    addErrorAndTimeoutHandlers(request, reject, timeout = 60 * 1e3) {
      ...
      request.on('aborted', () => {
        reject(
          /* @__PURE__ */ new Error('Request has been aborted by the server')
        );
      });
    }
    handleResponse(
      ...
      if (debug.enabled)
        debug(
          `Response: ${response.statusCode} ${response.statusMessage}, request options: ${safeStringifyJson(options)}`
        );
...
`
      ...
      const code =
        (_a = response.statusCode) !== null && _a !== void 0 ? _a : 0;
    ...
    static prepareRedirectUrlOptions(redirectUrl, options) {
      ...
      if (
        ...
        if (
          HttpExecutor.isCrossOriginRedirect(originalUrl, parsedRedirectUrl)
        ) {
          if (debug.enabled)
            debug(
              `Given the cross-origin redirect (from ${originalUrl.host} to ${parsedRedirectUrl.host}), the Authorization header will be stripped out.`
            );
      ...
      for (let attemptNumber = 0; ; attemptNumber++)
        try {
          ...
          if (
            ...
            ((e instanceof HttpError && e.isServerError()) ||
              e.code === 'EPIPE')
          )
            continue;
          throw e;
        ...
        (await Promise.resolve(
          (_a =
            shouldRetry === null || shouldRetry === void 0
              ? void 0
              : shouldRetry(error)) !== null && _a !== void 0
            ? _a
            : true
        )) &&
        retryCount > 0 &&
...
var require_sax = /* @__PURE__ */ __commonJSMin((exports) => {
  ((sax) => {
    ...
    function SAXParser(strict, opt) {
      ...
      if (this.opt.unquotedAttributeValues === void 0)
    ...
    function checkBufferLength(parser) {
      ...
      parser.bufferCheckPosition =
        sax.MAX_BUFFER_LENGTH - maxActual + parser.position;
    }
        ...
        switch (this.state) {
          ...
          case S.COMMENT_ENDING:
            if (c === '-') {
              ...
              if (this.comment) emitNode(this, 'oncomment', this.comment);
              this.comment = '';
            } else {
              this.comment += '-' + c;
              this.state = S.COMMENT;
          ...
          case S.CDATA_ENDING_2:
            if (c === '>') {
              if (this.cdata) emitNode(this, 'oncdata', this.cdata);
          ...
          case S.ATTRIB_VALUE_QUOTED:
            if (c !== this.q) {
              if (c === '&') this.state = S.ATTRIB_VALUE_ENTITY_Q;
  ...
  var XElement = class {
    ...
    elementOrNull(name, ignoreCase = false) {
      ...
      for (const element of this.elements)
        if (isNameEquals(element, name, ignoreCase)) return element;
      return null;
    }
...
var require_float = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  var YAML_FLOAT_PATTERN =
    /* @__PURE__ */ /^(?:[-+]?(?:[0-9][0-9_]*)(?:\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\.(?:inf|Inf|INF)|\.(?:nan|NaN|NAN))$/;
...
var require_timestamp = /* @__PURE__ */ __commonJSMin((exports, module) => {
  var Type = require_type();
  var YAML_DATE_REGEXP =
    /* @__PURE__ */ /^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$/;
  var YAML_TIMESTAMP_REGEXP =
    /* @__PURE__ */ /^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\.([0-9]*))?(?:[ \t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$/;
...
var require_to_comparators = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    var Range = require_range();
...
var require_max_satisfying = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    var SemVer = require_semver$1();
    var Range = require_range();
...
var require_min_satisfying = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    var SemVer = require_semver$1();
    var Range = require_range();
...
var require_lodash_isequal = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    /**
...
var require_DownloadedUpdateHelper = /* @__PURE__ */ __commonJSMin(
  (exports) => {
    Object.defineProperty(exports, '__esModule', { value: true });
    ...
    var DownloadedUpdateHelper = class {
      ...
      async validateDownloadedPath(updateFile, updateInfo, fileInfo, logger) {
        if (
          ...
          if (
            ...
            (await (0, fs_extra_1.pathExists)(updateFile))
          )
            return updateFile;
          else return null;
      ...
      async getValidCachedUpdateFile(fileInfo, logger) {
        ...
        if (!(await (0, fs_extra_1.pathExists)(updateInfoFilePath)))
          return null;
        let cachedInfo;
        try {
...
var require_electronHttpExecutor = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function getNetSession() {
    return __require('electron').session.fromPartition(
      exports.NET_SESSION_NAME,
      { cache: false }
    );
  }
    ...
    addRedirectHandlers(request, options, reject, redirectCount, handler) {
      request.on('redirect', (statusCode, method, redirectUrl) => {
        ...
        if (redirectCount > this.maxRedirects)
          ...
          handler(
            builder_util_runtime_1.HttpExecutor.prepareRedirectUrlOptions(
              redirectUrl,
              options
            )
          );
...
var require_lodash_escaperegexp = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    /**
     * lodash (Custom Build) <https://lodash.com/>
     * Build: `lodash modularize exports="npm" -o ./`
...
var require_Provider = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Provider = class {
    ...
    getBlockMapFiles(
      ...
      const newBlockMapUrl = (0, util_1.newUrlFromBase)(
        `${baseUrl.pathname}.blockmap`,
        baseUrl
      );
      return [
        (0, util_1.newUrlFromBase)(
  ...
  function getFileList(updateInfo) {
    ...
    if (updateInfo.path != null)
      ...
      throw (0, builder_util_runtime_1.newError)(
        `No files provided: ${(0, builder_util_runtime_1.safeStringifyJson)(updateInfo)}`,
        'ERR_UPDATER_NO_FILES_PROVIDED'
      );
  }
  function resolveFiles(updateInfo, baseUrl, pathTransformer = (p) => p) {
    const result = getFileList(updateInfo).map((fileInfo) => {
      if (fileInfo.sha2 == null && fileInfo.sha512 == null)
        throw (0, builder_util_runtime_1.newError)(
          `Update info doesn't contain nor sha256 neither sha512 checksum: ${(0, builder_util_runtime_1.safeStringifyJson)(fileInfo)}`,
...
var require_GenericProvider = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var GenericProvider = class extends Provider_1.Provider {
    ...
    async getLatestVersion() {
      ...
      const channelUrl = (0, util_1.newUrlFromBase)(
        channelFile,
        this.baseUrl,
      ...
      for (let attemptNumber = 0; ; attemptNumber++)
        try {
          return (0, Provider_1.parseUpdateInfo)(
          ...
          if (
            e instanceof builder_util_runtime_1.HttpError &&
            e.statusCode === 404
          )
            throw (0, builder_util_runtime_1.newError)(
...
var require_BitbucketProvider = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var BitbucketProvider = class extends Provider_1.Provider {
    constructor(configuration, updater, runtimeOptions) {
      ...
      this.baseUrl = (0, util_1.newBaseUrl)(
...
var require_GitHubProvider = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var BaseGitHubProvider = class extends Provider_1.Provider {
    constructor(options, defaultHost, runtimeOptions) {
      ...
      this.options = options;
      this.baseUrl = (0, util_1.newBaseUrl)(
        (0, builder_util_runtime_1.githubUrl)(options, defaultHost)
      );
      const apiHost =
        defaultHost === 'github.com' ? 'api.github.com' : defaultHost;
      this.baseApiUrl = (0, util_1.newBaseUrl)(
        (0, builder_util_runtime_1.githubUrl)(options, apiHost)
      );
    }
  ...
  var GitHubProvider = class extends BaseGitHubProvider {
    ...
    async getLatestVersion() {
      ...
      const feedXml = await this.httpRequest(
        (0, util_1.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl),
      ...
      const fetchData = async (channelName) => {
        ...
        channelFileUrl = (0, util_1.newUrlFromBase)(
      ...
      const result = (0, Provider_1.parseUpdateInfo)(
        rawData,
        channelFile,
        channelFileUrl
      );
    ...
    resolveFiles(updateInfo) {
      return (0, Provider_1.resolveFiles)(updateInfo, this.baseUrl, (p) =>
...
var require_GitLabProvider = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var GitLabProvider = class extends Provider_1.Provider {
    ...
    async getLatestVersion() {
      const cancellationToken = new builder_util_runtime_1.CancellationToken();
      const latestReleaseUrl = (0, util_1.newUrlFromBase)(
      ...
      for (const asset of latestRelease.assets.links)
        assetsMap.set(
          this.normalizeFilename(asset.name),
    ...
    async fetchReleaseInfoByVersion(version) {
      ...
      for (const releaseId of possibleReleaseIds) {
        const releaseUrl = (0, util_1.newUrlFromBase)(
    ...
    async findBlockMapUrlsFromAssets(oldVersion, newVersion, baseFilename) {
      ...
      if (oldVersionAssets) {
        ...
        oldBlockMapUrl = this.findBlockMapInAssets(
          oldVersionAssets,
          oldFilename
        );
      }
    ...
    resolveFiles(updateInfo) {
      return (0, Provider_1.getFileList)(updateInfo).map((fileInfo) => {
        const matchingAssetName = [
          fileInfo.url,
          this.normalizeFilename(fileInfo.url),
        ].find((name) => updateInfo.assets.has(name));
...
var require_providerFactory = /* @__PURE__ */ __commonJSMin((exports) => {
  Object.defineProperty(exports, '__esModule', { value: true });
  exports.isUrlProbablySupportMultiRangeRequests =
  ...
  function createClient(data, updater, runtimeOptions) {
    ...
    switch (provider) {
      ...
      case 'gitlab':
        return new GitLabProvider_1.GitLabProvider(
          data,
          updater,
          runtimeOptions
        );
      case 'keygen':
        return new KeygenProvider_1.KeygenProvider(
          data,
          updater,
          runtimeOptions
        );
...
var require_downloadPlanBuilder = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var isValidateOperationRange =
    process.env['DIFFERENTIAL_DOWNLOAD_PLAN_BUILDER_VALIDATE_RANGES'] ===
    'true';
...
var require_multipleRangeDownloader = /* @__PURE__ */ __commonJSMin(
  (exports) => {
    Object.defineProperty(exports, '__esModule', { value: true });
    exports.executeTasksUsingMultipleRangeRequests =
    ...
    function doExecuteTasks(
      ...
      if (partCount <= 1) {
        const w = (index) => {
          ...
          if (task.kind === downloadPlanBuilder_1.OperationKind.COPY)
            ...
            const requestOptions =
              differentialDownloader.createRequestOptions();
      ...
      const request = differentialDownloader.httpExecutor.createRequest(
        ...
        (response) => {
          if (!checkIsRangesSupported(response, reject)) return;
          const contentType = (0, builder_util_runtime_1.safeGetHeader)(
            response,
            'content-type'
          );
          const m =
          ...
          const dicer = new DataSplitter_1.DataSplitter(
            out,
            options,
            partIndexToTaskIndex,
            m[1] || m[2],
          ...
          response.on('end', () => {
            setTimeout(() => {
              ...
              reject(
                /* @__PURE__ */ new Error(
                  'Response ends without calling any handlers'
                )
              );
            }, 1e4);
          });
    ...
    function checkIsRangesSupported(response, reject) {
      ...
      if (response.statusCode !== 206) {
        const acceptRanges = (0, builder_util_runtime_1.safeGetHeader)(
          response,
          'accept-ranges'
        );
...
var require_ProgressDifferentialDownloadCallbackTransform =
  /* @__PURE__ */ __commonJSMin((exports) => {
    ...
    var ProgressDifferentialDownloadCallbackTransform = class extends stream_1.Transform {
      constructor(
        ...
        super();
        this.progressDifferentialDownloadInfo =
          progressDifferentialDownloadInfo;
        this.cancellationToken = cancellationToken;
        this.onProgress = onProgress;
        this.start = Date.now();
...
var require_DifferentialDownloader = /* @__PURE__ */ __commonJSMin(
  (exports) => {
    Object.defineProperty(exports, '__esModule', { value: true });
    ...
    var ProgressDifferentialDownloadCallbackTransform_1 =
      require_ProgressDifferentialDownloadCallbackTransform();
    var DifferentialDownloader = class {
      ...
      createRequestOptions() {
        ...
        (0, builder_util_runtime_1.configureRequestUrl)(
          this.options.newUrl,
          result
        );
          ...
          return Promise.all(
            fdList.map((openedFile) => {
              return (0, fs_extra_1.close)(openedFile.descriptor).catch((e) => {
                this.logger.error(
                  `cannot close file "${openedFile.path}": ${e}`
                );
              });
            })
          );
      ...
      async doDownloadFile(tasks, fdList) {
        ...
        await new Promise((resolve, reject) => {
          ...
          const digestTransform = new builder_util_runtime_1.DigestTransform(
          ...
          w = (index) => {
            ...
            (_b =
              (_a = this.logger) === null || _a === void 0
                ...
                : _a.debug) === null ||
              _b === void 0 ||
              _b.call(_a, `download range: ${range}`);
    ...
    function formatBytes(value, symbol = ' KB') {
      return (
        new Intl.NumberFormat('en').format((value / 1024).toFixed(2)) + symbol
      );
    }
...
var require_GenericDifferentialDownloader = /* @__PURE__ */ __commonJSMin(
  (exports) => {
    Object.defineProperty(exports, '__esModule', { value: true });
...
var require_types = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  Object.defineProperty(exports, 'CancellationToken', {
    enumerable: true,
    get: () => builder_util_runtime_1.CancellationToken,
  });
...
var require_AppUpdater = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.AppUpdater = class AppUpdater extends events_1.EventEmitter {
    ...
    constructor(options, app) {
      ...
      this._isUserWithinRollout = (updateInfo) =>
        this.isStagingMatch(updateInfo);
      this.clientPromise = null;
    ...
    async isStagingMatch(updateInfo) {
      ...
      const percentage =
        builder_util_runtime_1.UUID.parse(stagingUserId).readUInt32BE(12) /
        4294967295;
      this._logger.info(
    ...
    async isUpdateAvailable(updateInfo) {
      ...
      if (!(await Promise.resolve(this.isUpdateSupported(updateInfo))))
        return false;
      if (!(await Promise.resolve(this.isUserWithinRollout(updateInfo))))
        return false;
    ...
    onUpdateAvailable(updateInfo) {
      this._logger.info(
        ...
        builder_util_runtime_1.asArray)(updateInfo.files)
          .map((it) => it.url)
          .join(', ')})`
      );
    ...
    downloadUpdate(
      ...
      this._logger.info(
        `Downloading update from ${(0, builder_util_runtime_1.asArray)(
    ...
    async loadUpdateConfig() {
      ...
      return (0, js_yaml_1.load)(
        await (0, fs_extra_1.readFile)(this._appUpdateConfigPath, 'utf-8')
      );
    }
    ...
    async getOrCreateStagingUserId() {
      ...
      const id = builder_util_runtime_1.UUID.v5(
        (0, crypto_1$1.randomBytes)(4096),
        builder_util_runtime_1.UUID.OID
      );
    ...
    async executeDownload(taskOptions) {
      ...
      try {
        ...
        await (0, builder_util_runtime_1.retry)(
          () => (0, fs_extra_1.rename)(tempUpdateFile, updateFile),
          {
            retries: 60,
            interval: 500,
            shouldRetry: (error) => {
              if (error instanceof Error && /^EBUSY:/.test(error.message))
                return true;
              log.warn(
                `Cannot rename temp file to final file: ${error.message || error.stack}`
              );
              return false;
            },
          }
            ...
            if (await (0, fs_extra_1.pathExists)(blockMapFile))
              return JSON.parse(
                (0, zlib_1$1.gunzipSync)(
                  await (0, fs_extra_1.readFile)(blockMapFile)
                ).toString()
              );
          } catch (e) {
            this._logger.warn(
  ...
  function hasPrereleaseComponents(version) {
    ...
    return (
      versionPrereleaseComponent != null &&
      versionPrereleaseComponent.length > 0
    );
  }
  /** @private */
...
var require_BaseUpdater = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var BaseUpdater = class extends AppUpdater_1.AppUpdater {
    ...
    spawnSyncLog(cmd, args = [], env = {}) {
      ...
      const { error, status, stdout, stderr } = (0,
      child_process_1$3.spawnSync)(cmd, args, {
        env: {
          ...process.env,
          ...env,
        },
...
var require_FileWithEmbeddedBlockMapDifferentialDownloader =
  /* @__PURE__ */ __commonJSMin((exports) => {
    Object.defineProperty(exports, '__esModule', { value: true });
    ...
    var FileWithEmbeddedBlockMapDifferentialDownloader = class extends DifferentialDownloader_1.DifferentialDownloader {
      async download() {
        ...
        this.fileMetadataBuffer = await this.readRemoteBytes(
          offset,
          fileSize - 1
        );
    ...
    exports.FileWithEmbeddedBlockMapDifferentialDownloader =
...
var require_AppImageUpdater = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var FileWithEmbeddedBlockMapDifferentialDownloader_1 =
    require_FileWithEmbeddedBlockMapDifferentialDownloader();
  var Provider_1 = require_Provider();
  var types_1 = require_types();
  var AppImageUpdater = class extends BaseUpdater_1.BaseUpdater {
    ...
    doInstall(options) {
      ...
      if (
        path$4.basename(installerPath) === existingBaseName ||
        !/\d+\.\d+\.\d+/.test(existingBaseName)
      )
        destination = appImageFile;
      else
        destination = path$4.join(
          path$4.dirname(appImageFile),
          path$4.basename(installerPath)
        );
...
var require_LinuxUpdater = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var LinuxUpdater = class extends BaseUpdater_1.BaseUpdater {
    ...
    get installerPath() {
      var _a, _b;
      return (_b =
        (_a = super.installerPath) === null || _a === void 0
          ? void 0
          : _a.replace(/\\/g, '\\\\').replace(/ /g, '\\ ')) !== null &&
        _b !== void 0
        ? _b
        : null;
    }
    ...
    determineSudoCommand() {
      for (const sudo of ['gksudo', 'kdesudo', 'pkexec', 'beesu'])
    ...
    detectPackageManager(pms) {
      ...
      this._logger.warn(
        `No package manager found in the list: ${pms.join(', ')}. Defaulting to the first one: ${pms[0]}`
      );
      return pms[0];
    }
  };
...
var require_PacmanUpdater = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Provider_1 = require_Provider();
  var LinuxUpdater_1 = require_LinuxUpdater();
  exports.PacmanUpdater = class PacmanUpdater extends (
    LinuxUpdater_1.LinuxUpdater
  ) {
    constructor(options, app) {
      super(options, app);
    }
  ...
  var MacUpdater = class extends AppUpdater_1.AppUpdater {
    ...
    async doDownloadUpdate(downloadUpdateOptions) {
      ...
      try {
        ...
        isRosetta = (0, child_process_1$1.execFileSync)(
          'sysctl',
          [sysctlRosettaInfoKey],
          { encoding: 'utf8' }
        ).includes(`${sysctlRosettaInfoKey}: 1`);
        log.info(
      ...
      try {
        ...
        const isArm = (0, child_process_1$1.execFileSync)('uname', ['-a'], {
          encoding: 'utf8',
        }).includes('ARM');
      ...
      const isArm64 = (file) => {
        var _a;
        return (
          file.url.pathname.includes('arm64') ||
          ((_a = file.info.url) === null || _a === void 0
            ? void 0
            : _a.includes('arm64'))
        );
      };
      ...
      const zipFileInfo = (0, Provider_1.findFile)(files, 'zip', [
        'pkg',
        'dmg',
      ]);
      if (zipFileInfo == null)
        throw (0, builder_util_runtime_1.newError)(
          `ZIP file not provided: ${(0, builder_util_runtime_1.safeStringifyJson)(files)}`,
      ...
      return this.executeDownload({
        ...
        task: async (destinationFile, downloadOptions) => {
          const cachedUpdateFilePath = path$3.join(
            this.downloadedUpdateHelper.cacheDir,
          ...
          if (!downloadUpdateOptions.disableDifferentialDownload)
            try {
              ...
              this._logger.warn(
                `Unable to copy file for caching for future differential downloads: ${error.message}`
              );
            }
    ...
    async updateDownloaded(zipFileInfo, event) {
      ...
      const updateFileSize =
        (_a = zipFileInfo.info.size) !== null && _a !== void 0
          ? _a
          : (await (0, fs_extra_1.stat)(downloadedFile)).size;
      const log = this._logger;
      const logContext = `fileToProxy=${zipFileInfo.url.href}`;
      this.closeServerIfExists();
      this.debug(
        `Creating proxy server for native Squirrel.Mac (${logContext})`
      );
      ...
      return await new Promise((resolve, reject) => {
        ...
        this.server.on('request', (request, response) => {
          ...
          readStream.on('error', (error) => {
            ...
            reject(
              /* @__PURE__ */ new Error(
                `Cannot pipe "${downloadedFile}": ${error}`
              )
            );
          });
          response.writeHead(200, {
...
var require_windowsExecutableCodeSignatureVerifier =
  /* @__PURE__ */ __commonJSMin((exports) => {
    Object.defineProperty(exports, '__esModule', { value: true });
            ...
            try {
              ...
              if (data.Status === 0) {
                try {
                  ...
                  const normalizedTempUpdateFile = path$2.normalize(
                  ...
                  logger.warn(
                    `Unable to verify LiteralPath of update asset due to missing data.Path. Skipping this step of validation. Message: ${(_a = error.message) !== null && _a !== void 0 ? _a : error.stack}`
                  );
                }
                const subject = (0, builder_util_runtime_1.parseDn)(
                ...
                for (const name of publisherNames) {
                  ...
                  if (dn.size)
                    match = Array.from(dn.keys()).every((key) => {
...
var require_NsisUpdater = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Provider_1 = require_Provider();
  var fs_extra_1 = require_lib();
  var windowsExecutableCodeSignatureVerifier_1 =
    require_windowsExecutableCodeSignatureVerifier();
  ...
  var NsisUpdater = class extends BaseUpdater_1.BaseUpdater {
    ...
    doInstall(options) {
      ...
      const callUsingElevation = () => {
        this.spawnLog(
          path$1.join(process.resourcesPath, 'elevate.exe'),
...
app.whenReady().then(() => {
  ...
  ipcMain.handle('check-for-updates', () =>
    import_main.autoUpdater.checkForUpdates()
  );
  ipcMain.handle('download-update', () =>
    import_main.autoUpdater.downloadUpdate()
  );
