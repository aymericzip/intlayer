...
import clientComponent from './content/client-component.md?raw';
import clientComponentI18nEn from './content/client-component-i18n-en.md?raw';
import clientComponentI18nEs from './content/client-component-i18n-es.md?raw';
import clientComponentI18nFr from './content/client-component-i18n-fr.md?raw';
import componentAngular from './content/component-angular.md?raw';
import componentLit from './content/component-lit.md?raw';
import componentNextClient from './content/component-next-client.md?raw';
import componentNextServer from './content/component-next-server.md?raw';
import componentPreact from './content/component-preact.md?raw';
import componentReact from './content/component-react.md?raw';
import componentSolid from './content/component-solid.md?raw';
import componentSvelte from './content/component-svelte.md?raw';
import componentVanilla from './content/component-vanilla.md?raw';
import componentVue from './content/component-vue.md?raw';
import configFileCentralized from './content/config-file-centralized.md?raw';
import configFilePerComponent from './content/config-file-per-component.md?raw';
import serverComponent from './content/server-component.md?raw';
