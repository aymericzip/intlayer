...
import CMSScreenshot from './CMS_screenshot.png';
      ...
      >
        ...
        >
          <div className="mx-auto mb-10 w-full max-w-5xl">
            ...
            >
              <Link
                href={Website_Doc_IntlayerCMS_Path}
      ...
      */}
        ...
        >
          ...
          >
            ...
            <img
              src={
                typeof CMSScreenshot === 'string'
                  ? CMSScreenshot
                  : (CMSScreenshot as { src: string }).src
              }
              alt="Intlayer CMS - Visual content management interface"
              className="w-full"
            />
          </MotionContainer>
        </div>
