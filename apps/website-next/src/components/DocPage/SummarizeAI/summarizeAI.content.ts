...
const summarizeAIContent = {
  ...
  content: {
    title: t({
      ...
      ru: 'Поделитесь ссылкой на этот документ с вашим ИИ-ассистентом',
    ...
    description: t({
      ...
      ru: 'Задайте вопрос и получите краткое содержание документа через любого ИИ-провайдера на этой странице',
    ...
    summarizeLabel: insert(
      t({
        ...
        ru: 'Краткое содержание документа от {{provider}}',
    ...
    summarizeMessage: insert(
      t({
        ...
        ru: 'Получите краткое содержание документа по ссылке {{url}}',
