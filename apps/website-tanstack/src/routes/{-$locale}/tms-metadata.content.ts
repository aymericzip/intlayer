...
const metadataContent = {
  ...
  content: {
    ...
    description: t({
      ...
      fr: "Arrêtez de payer au mot. L'alternative open source à Crowdin & Lokalise. Automatisez les traductions avec l'IA, gérez le contenu via éditeur visuel ou Git, et assurez la sécurité des types.",
      ...
      it: "Smetti di pagare per parola. L'alternative open source a Crowdin e Lokalise. Automatizza le traduzioni con l'IA, gestisci i contenuti via editor visivo o Git e garantisci la sicurezza dei tipi.",
      ...
      zh: '停止按字数付费。Crowdin 和 Lokalise 的开源替代方案。利用 AI 自动化翻译，通过可视化编辑器 or Git 管理内容，并确保类型安全。',
