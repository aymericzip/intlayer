      ...
      subSections: {
        ...
        'dynamic-dyctionary': {
          title: t({
            ...
            fr: 'Dictionnaire dynamique',
            es: 'Diccionario dinámico',
            de: 'Dynamisches Wörterbuch',
            it: 'Dizionario dinamico',
            ja: 'ダイナミック辞書',
            ko: '동적 사전',
            zh: '动态字典',
            pt: 'Dicionário dinâmico',
            hi: 'डायनामिक शब्दकोश',
            ar: 'القاموس الديناميكي',
            uk: 'Динамічний словник',
            ru: 'Динамический словарь',
            tr: 'Dinamik Sözlük',
            pl: 'Dynamiczny słownik',
            id: 'Kamus dinamis',
            vi: 'Từ điển động',
          }),
