...
const tmsSectionContent = {
  ...
  content: {
    ...
    heroSubtitle: t({
      en: 'The open-source & self-hosted alternative to Crowdin & Lokalise. Built for modern developer workflows.',
      'en-GB':
        'The open-source & self-hosted alternative to Crowdin & Lokalise. Built for modern developer workflows.',
      fr: "L'alternative open source & auto-hébergée à Crowdin & Lokalise. Conçu pour les workflows de développement modernes.",
      es: 'La alternativa de código abierto y auto-hospedada a Crowdin y Lokalise. Creado para flujos de trabajo modernos.',
      de: 'Die Open-Source- und selbstgehostete Alternative zu Crowdin & Lokalise. Gebaut für moderne Entwickler-Workflows.',
      ru: 'Открытая и self-hosted альтернатива Crowdin и Lokalise. Создана для современных рабочих процессов разработчиков.',
      ja: 'CrowdinとLokaliseのオープンソースかつセルフホスト可能な代替品。モダンな開発者ワークフロー向けに構築。',
      ko: 'Crowdin 및 Lokalise의 오픈소스 및 자체 호스팅 대안. 현대적인 개발자 워크플로우를 위해 구축되었습니다.',
      zh: 'Crowdin和Lokalise的开源及自托管替代方案。专为现代开发者工作流程而构建。',
      ar: 'البديل مفتوح المصدر والقابل للاستضافة الذاتية لـ Crowdin و Lokalise. مبني لسير عمل المطورين الحديث.',
      it: "L'alternativa open-source e self-hosted a Crowdin e Lokalise. Costruita per flussi di lavoro moderni per sviluppatori.",
      pt: 'A alternativa open-source e de auto-hospedagem ao Crowdin e Lokalise. Construído para fluxos de trabalho modernos de desenvolvedores.',
      hi: 'Crowdin और Lokalise का ओपन-सोर्स और सेल्फ-होस्टेड विकल्प। आधुनिक डेवलपर वर्कफ़्लो के लिए निर्मित।',
      tr: "Crowdin ve Lokalise'nin açık kaynak ve self-hosted alternatifi. Modern geliştirici iş akışları için oluşturuldu.",
      pl: 'Alternatywa open-source i self-hosted dla Crowdin i Lokalise. Zbudowana dla nowoczesnych przepływów pracy deweloperów.',
      id: 'Alternatif open-source & self-hosted untuk Crowdin & Lokalise. Dibangun untuk alur kerja pengembang modern.',
      vi: 'Giải pháp mã nguồn mở & tự lưu trữ thay thế cho Crowdin & Lokalise. Được xây dựng cho quy trình làm việc của nhà phát triển hiện đại.',
      uk: 'Альтернатива з відкритим кодом та self-hosted для Crowdin і Lokalise. Створено для сучасних робочих процесів розробників.',
    }),
    heroDescription: t({
