    ...
    features: [
      {
        ...
        description: t({
          ...
          fr: 'Les développeurs définissent la structure. Les responsables marketing et traducteurs peaufinent le texte via le tableau de bord. Tout le monde reste synchronisé.',
          es: 'Los desarrolladores definen la estructura. Los responsables de marketing y traductores pulen el texto vía panel de control. Todos se mantienen sincronizados.',
      ...
      },
      {
        ...
        description: t({
          ...
          pl: 'Intlayer rozumie kontekst Twojego kodu (propsy, komentarze), aby generować dokładne tłumaczenia, nie tylko dosłowne.',
      ...
      },
      {
        ...
        description: t({
          ...
          pl: 'Automatycznie wyzwalaj audyty i tłumaczenia podczas wysyłania (push) kodu.',
