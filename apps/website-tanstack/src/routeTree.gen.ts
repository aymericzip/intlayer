...
import { Route as TestRssRouteImport } from './routes/test-rss';

const TestRssRoute = TestRssRouteImport.update({
  id: '/test-rss',
  path: '/test-rss',
...
export interface RootRouteChildren {
  ...
  TestRssRoute: typeof TestRssRoute;
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    '/test-rss': {
      ...
      path: '/test-rss';
      fullPath: '/test-rss';
      preLoaderRoute: typeof TestRssRouteImport;
