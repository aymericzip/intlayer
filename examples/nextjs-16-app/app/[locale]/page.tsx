...
import { IsomorphicComponentExample } from '../../components/IsomorphicComponentExample';
import { IsomorphicServerExample } from '../../components/IsomorphicServerExample';
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between bg-white px-16 py-32 sm:items-start dark:bg-black">
        <h1 className="text-white" aria-label={content.myTitle2.value}>
          {content.myTitle}
        </h1>
        <Image
          className="dark:invert"
          src="/next.svg"
          alt={content.nextjsLogo.toString()}
          width={100}
          height={20}
          priority
        />
...
const Page: NextPageIntlayer = () => (
  <>
    ...
    <div className="p-10">
      ...
      <IsomorphicComponentExample />
      <IsomorphicServerExample />
    </div>
  </>
);
