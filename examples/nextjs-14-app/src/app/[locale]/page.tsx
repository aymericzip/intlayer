      ...
      <IntlayerServerProvider locale={locale}>
        ...
        <IntlayerClientProvider locale={locale}>
          <main className="flex min-h-screen flex-col items-center justify-between p-24">
            ...
            <div className="sm:after:w-60] relative z-[-1] flex place-items-center before:absolute before:h-75 before:w-full before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-45 after:w-full after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] sm:before:w-120 before:lg:h-90 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 before:dark:bg-linear-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10">
              <Image
